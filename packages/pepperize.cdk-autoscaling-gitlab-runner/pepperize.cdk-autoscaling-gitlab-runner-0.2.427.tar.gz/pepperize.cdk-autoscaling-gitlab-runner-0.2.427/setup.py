    ...
    """
{
    ...
    "package_data": {
        "pepperize_cdk_autoscaling_gitlab_runner._jsii": [
            "cdk-autoscaling-gitlab-runner@0.2.427.jsii.tgz"
        ],
        "pepperize_cdk_autoscaling_gitlab_runner": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "jsii>=1.78.1, <2.0.0",
        "pepperize.cdk-private-bucket>=0.0.287, <0.0.288",
        "pepperize.cdk-security-group>=0.0.346, <0.0.347",
        "pepperize.cdk-vpc>=0.0.474, <0.0.475",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
