...
def show_danger_box():
    cw.TimedBox(root, message='This is a timed box: 5 seconds', time=5, style='danger').show()

def show_warning_box():
    cw.TimedBox(root, message='This is a timed box: 3 seconds', time=3, style='warning').show()
...
def show_generic_box():
    cw.TimedBox(root, message='This is a generic timed box').show()
