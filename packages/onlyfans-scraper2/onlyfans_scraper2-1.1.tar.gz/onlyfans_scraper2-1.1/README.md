...
https://github.com/excludedBittern8/onlyfans-scraper2

It's been rewriting slight to allow for better control over the commandline
...
Windows: 
```
pip install onlyfans-scraper2
```
or 

```
pip install git+https://github.com/excludedBittern8/onlyfans-scraper2
```
...
or
```
pip3 install git+https://github.com/excludedBittern8/onlyfans-scraper2
```
