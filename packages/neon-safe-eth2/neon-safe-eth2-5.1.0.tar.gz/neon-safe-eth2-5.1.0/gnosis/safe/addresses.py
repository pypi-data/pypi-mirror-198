...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.NEON_EVM_DEVNET: [
        ("0xEE7DC065C3eA3843E0B940956eFF221414DAFaE9", 203477034, "1.3.0+L2"),
        ("0x3A559A279A1B526F6E1d291267425dF644D545db", 203477057, "1.3.0"),
    ],
}
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.NEON_EVM_DEVNET: [
        ("0xDC11C380B79443b1674569694218345328d3F76E", 203476914),  # v1.3.0
    ],
}
