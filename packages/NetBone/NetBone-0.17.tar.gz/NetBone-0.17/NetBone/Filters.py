...
def threshold_filter(backbone, value=0.1, narrate=True , secondary_column = 'weight', secondary_column_ascending = False, **kwargs):
    data = backbone.graph
    column = backbone.column
...
def fraction_filter(backbone, value=0.1, narrate=True, secondary_column = 'weight', secondary_column_ascending = False, **kwargs):
    data = backbone.graph
    column = backbone.column
    ascending = backbone.ascending
