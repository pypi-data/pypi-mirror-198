...
class Backbone:
    ...
    def __init__(self, graph, name, column, ascending):
    ...
    def filters(self):
        match self.name:
            case "Disparity Filter" | 'Noise Corrected Filter' | "Enhanced Configuration Model Filter" | "Marginal Likelihood Filter" | 'Locally Adaptive Network Sparsification Filter':
