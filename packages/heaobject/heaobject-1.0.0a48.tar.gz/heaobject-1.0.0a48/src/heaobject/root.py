...
class Version(MemberObject, abc.ABC):
    """
    Represents the version metadata for an object.
    """
    ...
    def id(self) -> Optional[str]:
        """
        The unique version identifier. Required.
        """
        pass
...
class VersionImpl(Version, AbstractMemberObject):
    """
    Represents the version metadata for an object.
    """
    def __init__(self):
