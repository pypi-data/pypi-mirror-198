...
class GanttPlotPopUp(PopUpMixin):
    def __init__(self,
        ...
        # self.dpi_dropdown = DropDownMenu(self.style_settings_frm, 'DPI:', self.dpi_options, '16')
        # self.dpi_dropdown.setChoices(self.dpi_options[0])
        ...
        #self.dpi_dropdown.grid(row=2, sticky=NW)
    ...
    def __create_gantt_plots(self,
        ...
        style_attr = {'width': width,
                      ...
                      'dpi': int(self.dpi_dropdown.getChoices())}
