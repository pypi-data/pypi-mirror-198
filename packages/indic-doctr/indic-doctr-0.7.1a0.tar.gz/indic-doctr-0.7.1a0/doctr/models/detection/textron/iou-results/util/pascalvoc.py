...
def getBoundingBoxes(
    ...
    if len(files) != 0:
        ...
        for nameOfImage, (arrs, classes) in dataset.data:
            for [x, y, x2, y2], idClass in arrs, classes:
                bb = BoundingBox(
...
# def getBoundingBoxesDoctrFormat(
#     directory: Optional[str],
#     isGT: Optional[bool],
#     allclasses: Optional[list[str]],
# ) -> tuple[BoundingBoxes, list[str]]:

#     label_path = os.path.join(directory,'labels.json')
#     dataset = DetectionDataset(
