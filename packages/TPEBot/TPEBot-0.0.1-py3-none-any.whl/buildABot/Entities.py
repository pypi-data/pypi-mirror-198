...
class Entities:
    ...
    def createEntity(df):
        ...
        for index, rows in df.iterrows():
            ...
            Entities.appendJSON("./Chatbot/Data/LoginID.json", entity)
            Entities.commaJSON("./Chatbot/Data/LoginID.json")
            Entities.structureJSON("./Chatbot/Data/LoginID.json", "./Chatbot/entities/LoginID_entries_en.json")
