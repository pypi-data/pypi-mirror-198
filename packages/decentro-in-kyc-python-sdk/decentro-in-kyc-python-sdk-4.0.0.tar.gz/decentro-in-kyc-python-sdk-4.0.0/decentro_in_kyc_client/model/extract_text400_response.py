...
class ExtractText400Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "ocrStatus", "kycStatus", "error", "requestTimestamp", "responseTimestamp", "decentroTxnId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "ocrStatus", "kycStatus", "error", "requestTimestamp", "responseTimestamp", "decentroTxnId", ], str]):
        return super().get_item_oapg(name)
