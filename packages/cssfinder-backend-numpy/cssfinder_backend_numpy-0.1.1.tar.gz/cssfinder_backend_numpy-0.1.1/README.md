...
This will create `dist/` directory with `cssfinder_backend_numpy-0.1.1` or
alike inside.

Wheel file can be installed with

```
pip install ./dist/cssfinder_backend_numpy-0.1.1
```

What you expect is

```
Successfully installed cssfinder_backend_numpy-0.1.1
```
...
But `cssfinder_backend_numpy-0.1.1` should be included in this list.
