...
class Config(Default):
    ...
    password = ''
    port = 6667
    realname = 'Medicine for care laws, Poison for genocide laws'
    sasl = False
    server = 'localhost'
    servermodes = ''
    sleep = 60
