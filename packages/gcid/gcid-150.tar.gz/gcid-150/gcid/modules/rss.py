...
from gcid.objects import Object, otype, tostr, update
from gcid.storage import Storage, find, last, save
from gcid.threads import launch
from gcid.utility import elapsed, fntime, locked, spl
...
class Timer:
    ...
    def __init__(self, sleep, func, *args, thrname=None):
        ...
        self.func = func
        self.sleep = sleep
        self.name = thrname or otype(self.func, True)
        self.state = Object()
        self.timer = None
...
def geturl(url):
    ...
    req.add_header('User-agent', useragent('operbot'))
