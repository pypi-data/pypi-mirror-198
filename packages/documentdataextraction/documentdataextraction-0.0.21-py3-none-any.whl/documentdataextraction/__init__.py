...
class DataExtractor:
    ...
    def get(self):
        ...
        try:
            ...
            print('proc_mtd',proc_mtd)
            print('proc_mtd_value',proc_mtd_value)
            ...
            if input_document_type == 'cheque':
                ...
                try:
                    ...
                    elif proc_mtd_value[1] == 'AI': 
                        openaidataextractor = OpenAIDataExtractor()
                        result = openaidataextractor.OpenAIDataExtract(file_path=file_path,jsonData=jsonData,templates=templates,input_module=input_reader_module)
