...
def main_goose():
    ...
    BG_PATH = "powerhouse-helper\\GameGooseKiller\\image\\background"
    ...
    enemies = []
    bonuses = []
    IMGS_PATH = "powerhouse-helper\\GameGooseKiller\\image\\Goose"
    ...
    def creat_enemy():
        enemy = pygame.image.load("powerhouse-helper\\GameGooseKiller\\image\\enemy.png").convert_alpha()
        e = enemy.get_size()
    ...
    def creat_bonus():
        bonus = pygame.image.load("powerhouse-helper\\GameGooseKiller\\image\\bonus.png").convert_alpha()
        b = bonus.get_size()
    ...
    def display_boom():
        boom = pygame.image.load("powerhouse-helper\\GameGooseKiller\\image\\boom.png").convert_alpha()
        main_surface.blit(boom, goose_rect)
        pygame.time.set_timer(USEREVENT + 4, 10000)


    def game_over():
        game_over = pygame.image.load("powerhouse-helper\\GameGooseKiller\\image\\gameover.png").convert_alpha()
    ...
    while is_working:
        ...
        # print result
        my_font = pygame.font.Font("powerhouse-helper\\GameGooseKiller\\font\\UA Propisi.ttf", 35)
        main_surface.blit(
...
def start_game():
    main_goose()
    return 'Thank you for using the goose killer game'
