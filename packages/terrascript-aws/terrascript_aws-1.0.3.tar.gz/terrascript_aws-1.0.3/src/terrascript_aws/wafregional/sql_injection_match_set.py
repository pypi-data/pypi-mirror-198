...
@core.resource(type="aws_wafregional_sql_injection_match_set", namespace="wafregional")
class SqlInjectionMatchSet(core.Resource):
    ...
    sql_injection_match_tuple: list[SqlInjectionMatchTuple] | core.ArrayOut[
        SqlInjectionMatchTuple
    ] | None = core.attr(SqlInjectionMatchTuple, default=None, kind=core.Kind.array)
    ...
    def __init__(
        ...
        *,
        ...
        sql_injection_match_tuple: list[SqlInjectionMatchTuple]
        | core.ArrayOut[SqlInjectionMatchTuple]
        | None = None,
