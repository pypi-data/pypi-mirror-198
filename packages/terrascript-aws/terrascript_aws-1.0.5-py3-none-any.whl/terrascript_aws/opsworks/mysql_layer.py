...
@core.resource(type="aws_opsworks_mysql_layer", namespace="opsworks")
class MysqlLayer(core.Resource):
    """
    ...
    """
    root_password: str | core.StringOut | None = core.attr(str, default=None)

    """
    (Optional) Whether to set the root user password to all instances in the stack so they can access th
    e instances in this layer.
    """
    root_password_on_all_instances: bool | core.BoolOut | None = core.attr(bool, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        root_password: str | core.StringOut | None = None,
        root_password_on_all_instances: bool | core.BoolOut | None = None,
    ...
    class Args(core.Resource.Args):
        ...
        root_password: str | core.StringOut | None = core.arg(default=None)

        root_password_on_all_instances: bool | core.BoolOut | None = core.arg(default=None)
