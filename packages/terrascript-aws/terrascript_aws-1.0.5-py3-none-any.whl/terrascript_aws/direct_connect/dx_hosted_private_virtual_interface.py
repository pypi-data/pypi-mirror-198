...
@core.resource(type="aws_dx_hosted_private_virtual_interface", namespace="direct_connect")
class DxHostedPrivateVirtualInterface(core.Resource):
    ...
    ket that can be passed over the connection. The MTU of a virtual private interface can be either `15
    00` or `9001` (jumbo frames). Default is `1500`.
    """
