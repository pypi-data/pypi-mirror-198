...
@core.resource(type="aws_service_discovery_http_namespace", namespace="cloud_map")
class ServiceDiscoveryHttpNamespace(core.Resource):
    """
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            name=resource_name,
            args=ServiceDiscoveryHttpNamespace.Args(
                name=name,
