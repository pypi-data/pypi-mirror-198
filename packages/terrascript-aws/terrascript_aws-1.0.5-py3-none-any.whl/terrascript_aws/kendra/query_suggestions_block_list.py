...
@core.resource(type="aws_kendra_query_suggestions_block_list", namespace="kendra")
class QuerySuggestionsBlockList(core.Resource):
    ...
    """
    (Optional) The description for a block list.
    """
    ...
    """
    (Required) The name for the block list.
    """
    ...
    """
    (Required) The IAM (Identity and Access Management) role used to access the block list text file in
    S3.
    """
    role_arn: str | core.StringOut = core.attr(str)

    """
    (Required) The S3 path where your block list text file sits in S3. Detailed below.
    """
