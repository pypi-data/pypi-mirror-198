...
@core.schema
class ScopeDownStatementNotStatementStatementOrStatementStatement(core.Schema):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            args=ScopeDownStatementNotStatementStatementOrStatementStatement.Args(
...
class ScopeDownStatementNotStatementStatementOrStatement(core.Schema):
    ...
    statement: list[ScopeDownStatementNotStatementStatementOrStatementStatement] | core.ArrayOut[
        ScopeDownStatementNotStatementStatementOrStatementStatement
    ] = core.attr(ScopeDownStatementNotStatementStatementOrStatementStatement, kind=core.Kind.array)

    def __init__(
        self,
        *,
        statement: list[ScopeDownStatementNotStatementStatementOrStatementStatement]
        | core.ArrayOut[ScopeDownStatementNotStatementStatementOrStatementStatement],
    ):
        super().__init__(
    ...
    class Args(core.SchemaArgs):
        statement: list[
            ScopeDownStatementNotStatementStatementOrStatementStatement
        ] | core.ArrayOut[ScopeDownStatementNotStatementStatementOrStatementStatement] = core.arg()
...
class ScopeDownStatementNotStatementStatement(core.Schema):
    ...
    and_statement: ScopeDownStatementNotStatementStatementAndStatement | None = core.attr(
    ...
    not_statement: ScopeDownStatementNotStatementStatementNotStatement | None = core.attr(
        ScopeDownStatementNotStatementStatementNotStatement, default=None
    )

    or_statement: ScopeDownStatementNotStatementStatementOrStatement | None = core.attr(
    ...
    def __init__(
        self,
        *,
        and_statement: ScopeDownStatementNotStatementStatementAndStatement | None = None,
        byte_match_statement: ByteMatchStatement | None = None,
        geo_match_statement: GeoMatchStatement | None = None,
        ip_set_reference_statement: IpSetReferenceStatement | None = None,
        label_match_statement: LabelMatchStatement | None = None,
        not_statement: ScopeDownStatementNotStatementStatementNotStatement | None = None,
        or_statement: ScopeDownStatementNotStatementStatementOrStatement | None = None,
        regex_pattern_set_reference_statement: RegexPatternSetReferenceStatement | None = None,
        size_constraint_statement: SizeConstraintStatement | None = None,
        sqli_match_statement: SqliMatchStatement | None = None,
        xss_match_statement: XssMatchStatement | None = None,
    ...
    @core.schema_args
    class Args(core.SchemaArgs):
        and_statement: ScopeDownStatementNotStatementStatementAndStatement | None = core.arg(
            default=None
        )
        ...
        not_statement: ScopeDownStatementNotStatementStatementNotStatement | None = core.arg(
            default=None
        )

        or_statement: ScopeDownStatementNotStatementStatementOrStatement | None = core.arg(
            default=None
        )
...
class ScopeDownStatementNotStatement(core.Schema):
    ...
    statement: list[ScopeDownStatementNotStatementStatement] | core.ArrayOut[
        ScopeDownStatementNotStatementStatement
    ] = core.attr(ScopeDownStatementNotStatementStatement, kind=core.Kind.array)

    def __init__(
        self,
        *,
        statement: list[ScopeDownStatementNotStatementStatement]
