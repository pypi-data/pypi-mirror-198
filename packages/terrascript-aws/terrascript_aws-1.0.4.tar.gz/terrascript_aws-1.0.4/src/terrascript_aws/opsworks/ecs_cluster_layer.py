...
@core.resource(type="aws_opsworks_ecs_cluster_layer", namespace="opsworks")
class EcsClusterLayer(core.Resource):
    """
    ...
    """
    (Required) The ECS Cluster ARN of the layer.
    """
    ecs_cluster_arn: str | core.StringOut = core.attr(str)
    ...
    def __init__(
        ...
        resource_name: str,
        *,
        ecs_cluster_arn: str | core.StringOut,
    ...
    class Args(core.Resource.Args):
        ...
        ecs_cluster_arn: str | core.StringOut = core.arg()
