...
@core.resource(type="aws_opsworks_memcached_layer", namespace="opsworks")
class MemcachedLayer(core.Resource):
    """
    (Optional) Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 51
    2MB.
    """

    allocated_memory: int | core.IntOut | None = core.attr(int, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        allocated_memory: int | core.IntOut | None = None,
    ...
    class Args(core.Resource.Args):
        allocated_memory: int | core.IntOut | None = core.arg(default=None)
