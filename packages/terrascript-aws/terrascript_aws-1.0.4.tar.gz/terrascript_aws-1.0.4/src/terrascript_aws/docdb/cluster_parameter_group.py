...
@core.resource(type="aws_docdb_cluster_parameter_group", namespace="docdb")
class ClusterParameterGroup(core.Resource):
    ...
    """
    (Optional, Forces new resource) The description of the documentDB cluster parameter group. Defaults
    to "Managed by Terraform".
    """
    ...
    """
    (Optional, Forces new resource) The name of the documentDB cluster parameter group. If omitted, Terr
    aform will assign a random, unique name.
    """
    ...
    """
    (Optional) A list of documentDB parameters to apply. Setting parameters to system default values may
    show a difference on imported resources.
    """
