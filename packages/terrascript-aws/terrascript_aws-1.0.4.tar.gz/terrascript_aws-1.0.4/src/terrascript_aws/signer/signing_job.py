...
@core.resource(type="aws_signer_signing_job", namespace="signer")
class SigningJob(core.Resource):
    ...
    """
    (Required) The S3 bucket in which to save your signed object. See [Destination](#destination) below
    for details.
    """
    ...
    """
    (Optional) Set this argument to `true` to ignore signing job failures and retrieve failed status and
