...
@core.schema
class RuleStatementOrStatementStatementAndStatementStatement(core.Schema):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            args=RuleStatementOrStatementStatementAndStatementStatement.Args(
...
class RuleStatementOrStatementStatementAndStatement(core.Schema):
    ...
    statement: list[RuleStatementOrStatementStatementAndStatementStatement] | core.ArrayOut[
        RuleStatementOrStatementStatementAndStatementStatement
    ] = core.attr(RuleStatementOrStatementStatementAndStatementStatement, kind=core.Kind.array)

    def __init__(
        self,
        *,
        statement: list[RuleStatementOrStatementStatementAndStatementStatement]
        | core.ArrayOut[RuleStatementOrStatementStatementAndStatementStatement],
    ):
        super().__init__(
