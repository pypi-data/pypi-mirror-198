...
@core.schema
class ScopeDownStatementNotStatementStatementNotStatementStatement(core.Schema):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            args=ScopeDownStatementNotStatementStatementNotStatementStatement.Args(
...
class ScopeDownStatementNotStatementStatementNotStatement(core.Schema):
    ...
    statement: list[ScopeDownStatementNotStatementStatementNotStatementStatement] | core.ArrayOut[
        ScopeDownStatementNotStatementStatementNotStatementStatement
    ] = core.attr(
        ScopeDownStatementNotStatementStatementNotStatementStatement, kind=core.Kind.array
    )

    def __init__(
        self,
        *,
        statement: list[ScopeDownStatementNotStatementStatementNotStatementStatement]
        | core.ArrayOut[ScopeDownStatementNotStatementStatementNotStatementStatement],
    ):
        super().__init__(
    ...
    class Args(core.SchemaArgs):
        statement: list[
            ScopeDownStatementNotStatementStatementNotStatementStatement
        ] | core.ArrayOut[ScopeDownStatementNotStatementStatementNotStatementStatement] = core.arg()
