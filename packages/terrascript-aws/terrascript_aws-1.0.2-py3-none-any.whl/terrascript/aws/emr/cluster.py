...
@core.schema
class MasterInstanceGroupEbsConfig(core.Schema):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            args=MasterInstanceGroupEbsConfig.Args(
                size=size,
                type=type,
                iops=iops,
...
class MasterInstanceGroup(core.Schema):
    ...
    ebs_config: list[MasterInstanceGroupEbsConfig] | core.ArrayOut[
        MasterInstanceGroupEbsConfig
    ] | None = core.attr(
        MasterInstanceGroupEbsConfig, default=None, computed=True, kind=core.Kind.array
    )
    ...
    def __init__(
        ...
        *,
        ...
        instance_type: str | core.StringOut,
        bid_price: str | core.StringOut | None = None,
        ebs_config: list[MasterInstanceGroupEbsConfig]
        | core.ArrayOut[MasterInstanceGroupEbsConfig]
        | None = None,
