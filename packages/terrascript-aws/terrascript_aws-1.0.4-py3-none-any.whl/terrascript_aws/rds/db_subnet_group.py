...
@core.resource(type="aws_db_subnet_group", namespace="rds")
class DbSubnetGroup(core.Resource):
    """
    ...
    """
    (Optional, Forces new resource) The name of the DB subnet group. If omitted, Terraform will assign a
    random, unique name.
    """
