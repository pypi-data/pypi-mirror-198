...
@core.resource(type="aws_wafregional_web_acl", namespace="wafregional")
class WebAcl(core.Resource):
    ...
    """
    (Required) The action that you want AWS WAF Regional to take when a request doesn't match the criter
    ia in any of the rules that are associated with the web ACL.
    """
