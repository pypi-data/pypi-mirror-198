...
@core.resource(type="aws_ec2_transit_gateway_route_table_association", namespace="transit_gateway")
class Ec2TransitGatewayRouteTableAssociation(core.Resource):
    """
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            name=resource_name,
            args=Ec2TransitGatewayRouteTableAssociation.Args(
