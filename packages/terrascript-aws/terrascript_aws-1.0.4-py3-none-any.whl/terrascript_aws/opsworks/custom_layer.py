...
@core.resource(type="aws_opsworks_custom_layer", namespace="opsworks")
class CustomLayer(core.Resource):
    """
    ...
    """
    (Optional) Will create an EBS volume and connect it to the layer's instances. See [Cloudwatch Config
    uration](#cloudwatch-configuration).
    """
    ...
    """
    (Optional) Will create an EBS volume and connect it to the layer's instances. See [EBS Volume](#ebs-
    volume).
    """
    ...
    """
    (Required) A short, machine-readable name for the layer, which will be used to identify it in the Ch
    ef node JSON.
    """
    short_name: str | core.StringOut = core.attr(str)
    ...
    class Args(core.Resource.Args):
        ...
        short_name: str | core.StringOut = core.arg()
