...
@core.resource(type="aws_docdb_subnet_group", namespace="docdb")
class SubnetGroup(core.Resource):
    ...
    """
    (Optional, Forces new resource) The name of the docDB subnet group. If omitted, Terraform will assig
