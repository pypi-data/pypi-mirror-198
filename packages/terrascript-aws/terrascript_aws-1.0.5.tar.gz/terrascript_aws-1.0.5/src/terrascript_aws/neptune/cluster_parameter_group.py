...
@core.resource(type="aws_neptune_cluster_parameter_group", namespace="neptune")
class ClusterParameterGroup(core.Resource):
    ...
    """
    (Optional, Forces new resource) The name of the neptune cluster parameter group. If omitted, Terrafo
    rm will assign a random, unique name.
    """
