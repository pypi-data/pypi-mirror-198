...
@core.resource(type="aws_opsworks_nodejs_app_layer", namespace="aws_opsworks")
class NodejsAppLayer(core.Resource):
    ...
    nodejs_version: str | core.StringOut | None = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        nodejs_version: str | core.StringOut | None = None,
    ...
    class Args(core.Resource.Args):
        ...
        nodejs_version: str | core.StringOut | None = core.arg(default=None)
