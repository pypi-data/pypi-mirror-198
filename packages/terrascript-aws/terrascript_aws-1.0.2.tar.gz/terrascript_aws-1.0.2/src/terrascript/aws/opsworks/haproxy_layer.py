...
@core.resource(type="aws_opsworks_haproxy_layer", namespace="aws_opsworks")
class HaproxyLayer(core.Resource):
    ...
    healthcheck_method: str | core.StringOut | None = core.attr(str, default=None)

    healthcheck_url: str | core.StringOut | None = core.attr(str, default=None)
    ...
    stats_enabled: bool | core.BoolOut | None = core.attr(bool, default=None)

    stats_password: str | core.StringOut = core.attr(str)

    stats_url: str | core.StringOut | None = core.attr(str, default=None)

    stats_user: str | core.StringOut | None = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        stats_password: str | core.StringOut,
        ...
        healthcheck_method: str | core.StringOut | None = None,
        healthcheck_url: str | core.StringOut | None = None,
        install_updates_on_boot: bool | core.BoolOut | None = None,
        instance_shutdown_timeout: int | core.IntOut | None = None,
        name: str | core.StringOut | None = None,
        stats_enabled: bool | core.BoolOut | None = None,
        stats_url: str | core.StringOut | None = None,
        stats_user: str | core.StringOut | None = None,
    ...
    class Args(core.Resource.Args):
        ...
        healthcheck_method: str | core.StringOut | None = core.arg(default=None)

        healthcheck_url: str | core.StringOut | None = core.arg(default=None)
        ...
        stats_enabled: bool | core.BoolOut | None = core.arg(default=None)

        stats_password: str | core.StringOut = core.arg()

        stats_url: str | core.StringOut | None = core.arg(default=None)

        stats_user: str | core.StringOut | None = core.arg(default=None)
