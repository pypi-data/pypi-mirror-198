...
@core.resource(type="aws_opsworks_rails_app_layer", namespace="aws_opsworks")
class RailsAppLayer(core.Resource):
    ...
    bundler_version: str | core.StringOut | None = core.attr(str, default=None)
    ...
    manage_bundler: bool | core.BoolOut | None = core.attr(bool, default=None)

    name: str | core.StringOut | None = core.attr(str, default=None)

    passenger_version: str | core.StringOut | None = core.attr(str, default=None)

    ruby_version: str | core.StringOut | None = core.attr(str, default=None)

    rubygems_version: str | core.StringOut | None = core.attr(str, default=None)
    ...
    def __init__(
        ...
        *,
        ...
        bundler_version: str | core.StringOut | None = None,
        ...
        manage_bundler: bool | core.BoolOut | None = None,
        name: str | core.StringOut | None = None,
        passenger_version: str | core.StringOut | None = None,
        ruby_version: str | core.StringOut | None = None,
        rubygems_version: str | core.StringOut | None = None,
    ...
    class Args(core.Resource.Args):
        ...
        bundler_version: str | core.StringOut | None = core.arg(default=None)
        ...
        manage_bundler: bool | core.BoolOut | None = core.arg(default=None)

        name: str | core.StringOut | None = core.arg(default=None)

        passenger_version: str | core.StringOut | None = core.arg(default=None)

        ruby_version: str | core.StringOut | None = core.arg(default=None)

        rubygems_version: str | core.StringOut | None = core.arg(default=None)
