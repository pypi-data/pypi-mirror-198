...
def main_goose():
    ...
    os.chdir(os.pardir)
    BG_PATH = "test_version_powerhouse_helper\GameGooseKiller\image"

    BG_images = [
        pygame.image.load(BG_PATH + "/" + file).convert() for file in os.listdir(BG_PATH)
    ]
...
def start_game():
    main_goose()
    return '\033[32mThank you for using the goose killer game\033[0m'
