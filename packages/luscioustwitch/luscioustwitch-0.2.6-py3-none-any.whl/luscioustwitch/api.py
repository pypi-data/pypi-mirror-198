...
class TwitchAPI:
  ...
  def __init__(self, credentials):
    ...
    r = requests.post('https://id.twitch.tv/oauth2/token?client_id={self.CLIENT_ID}&client_secret={self.CLIENT_SECRET}&grant_type=client_credentials', headers = {'Content-Type': 'application/x-www-form-urlencoded'})
