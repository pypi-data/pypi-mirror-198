...
class WorkflowApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.QueueMissionExport = channel.unary_unary(
                ...
                request_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportRequest.SerializeToString,
                response_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportResponse.FromString,
                )
        self.ListQueuedMissionExports = channel.unary_unary(
                '/WorkflowApi/ListQueuedMissionExports',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListQueuedMissionExportsResponse.FromString,
                )
        self.ListMissionExports = channel.unary_unary(
                '/WorkflowApi/ListMissionExports',
                request_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsRequest.SerializeToString,
                response_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsResponse.FromString,
                )
...
def add_WorkflowApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'QueueMissionExport': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportRequest.FromString,
                    response_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportResponse.SerializeToString,
            ),
            'ListQueuedMissionExports': grpc.unary_unary_rpc_method_handler(
                    servicer.ListQueuedMissionExports,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListQueuedMissionExportsResponse.SerializeToString,
            ),
            'ListMissionExports': grpc.unary_unary_rpc_method_handler(
                    servicer.ListMissionExports,
                    request_deserializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsRequest.FromString,
                    response_serializer=fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsResponse.SerializeToString,
            ),
...
class WorkflowApi(object):
    ...
    def QueueMissionExport(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/WorkflowApi/QueueMissionExport',
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportRequest.SerializeToString,
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.QueueMissionExportResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListQueuedMissionExports(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/WorkflowApi/ListQueuedMissionExports',
            ...
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListQueuedMissionExportsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListMissionExports(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/WorkflowApi/ListMissionExports',
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsRequest.SerializeToString,
            fsai__grpc__api_dot_protos_dot_workflow__api__pb2.ListMissionExportsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
