...
setup(
    ...
    keywords=['Instagram info','webscrapping','instagram id name','webscrapper','beautifulsoup','vaibhavpandey module','vaibhav pandey python module','Instagram by pyhton'],
    classifiers=[
