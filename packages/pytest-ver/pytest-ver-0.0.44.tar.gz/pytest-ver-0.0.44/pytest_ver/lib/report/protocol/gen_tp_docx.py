...
class GenTpDocx(GenBaseDocx, GenTpBase):
    ...
    def _gen_protocol_info_row1(self, tbl, protocol):
        ...
        self._gen_protocol_info_item(row_cells[0], row_cells[3], 'Executed by', who)
    ...
    def _gen_steps_info(self, tbl, steps, requirements):
        ...
        self._set_table_title(row_cells[6], 'Date')
    ...
    def _update_protocol_table(self, tbl, need_space):
        ...
        #     total += w
        #     print(f"DBG:    {i} {w / units: >8.2f} docx.shared.Inches")
        # # there are 913780 per inch
        # print(f"DBG: {total / units: >8.2f} docx.shared.Inches, need_space:{need_space}")
