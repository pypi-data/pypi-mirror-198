...
LastEditTime: 2023-02-23 18:19:44
LastEditors: Hexu
...
def __args_to_framework_arg(args, path):
    ...
    assert framework_args.method is not None, 'failed to execute, unknown task: {}'.format(
        args.task)
...
def __dataset(dataset_id=None, dataset_ratio=[0.7, 0.3, 0], local_csv=None, local_corpus=None):
