...
LastEditTime: 2023-03-16 14:45:32
LastEditors: Hexu
Description: 数据集
...
def get_datasource_writer(cfg: str = None) -> AbstractDataSourceWriter:
    ...
    dataset_conf = json.loads(cfg) if isinstance(cfg, str) else cfg

    output_datasource_type = dataset_conf['sourceType']
    if output_datasource_type == DST.EMPTY:
        ...
        return DataSourceWriter(output_config=dataset_conf, writer_type=output_datasource_type)
    else:
