...
def plot_pairplot(self, y_var:list, x_var:list=None, hues=None,split_vars=None,alpha=0.4,size=6,aspect=8/10):
    print("Make sure you encode to category the variables you want to plot as hue")
    """
    ...
    if isinstance(split_vars,int):
        ...
        var_list=df2.drop(columns=hues).columns.tolist()
