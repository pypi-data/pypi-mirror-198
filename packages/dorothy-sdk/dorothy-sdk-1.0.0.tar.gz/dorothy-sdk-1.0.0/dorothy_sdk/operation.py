...
class ModelOperation:
    ...
    def __init__(self, mlflow_module_flavor, device_type,
        ...
        - device_type: se a execução do modelo se dará em 'cpu' ou 'cuda'.
        ...
        assert self.device_type in ['cuda', 'cpu'], 'device_type must be either "cpu" or "cuda"'
    ...
    def get_dataset_images(self, validation_dataset_name):
        ...
        X, metadata = dataset.load_dataset()
        return X, metadata
