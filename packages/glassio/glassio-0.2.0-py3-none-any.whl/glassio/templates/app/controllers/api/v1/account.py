...
from glassio.errors import AuthenticationError, BadRequest, Forbidden
from glassio import ctx
from app.extractors import authenticated_user, current_session, current_permissions
from app.models import User, Session
from .response_types.account import AccountMeResponse, LogoutResponse, AuthenticationRequest

account_ctrl = APIRouter(prefix="/api/v3/account")
...
async def authenticate(
    ...
    if not ctx.cfg.general.enable_passwords:
