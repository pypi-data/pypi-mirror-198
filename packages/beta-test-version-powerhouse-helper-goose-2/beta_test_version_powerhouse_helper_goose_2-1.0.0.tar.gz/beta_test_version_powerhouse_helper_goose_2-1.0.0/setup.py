...
setup(
    name="beta_test_version_powerhouse_helper_goose_2",
    version="1.0.0",
    ...
    data_files=[
        ...
        ('test_version_powerhouse_helper\\GameGooseKiller', ['test_version_powerhouse_helper\\GameGooseKiller\Game_goose.py'])
    ],
    entry_points={
