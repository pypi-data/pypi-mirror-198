...
def main_goose():
    ...
    BG_PATH = os.path.join('test_version_powerhouse_helper', 'GameGooseKiller', 'image', 'background')

    BG_images = [
        pygame.image.load(os.path.join(BG_images, file)).convert() for file in os.listdir(BG_PATH)
    ]
    ...
    IMGS_PATH = os.path.join('GameGooseKiller', 'image', 'Goose')
