...
from mmap_ninja_dataframe.base import _list_of_dicts_to_dict_of_lists, _create_mmap_for_key, _load_dir_as_dict
...
class DataFrameMmap:
    ...
    def __init__(
        ...
        self._subset = subset
        self._data = _load_dir_as_dict(self._out_dir, self._wrapper_fn_dict, self._subset)
