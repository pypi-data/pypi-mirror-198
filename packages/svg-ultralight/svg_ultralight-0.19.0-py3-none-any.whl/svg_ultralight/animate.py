...
# Ignore missing module source for optional dependency pillow. A type: ignore on the
# import line gets flagged an unnecessary when I have pillow installed for testing.
