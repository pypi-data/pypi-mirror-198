...
class Measurement:
    ...
    def get_value(self, unit: Optional[Unit] = None) -> float:
    ...
    def get_tuple(self, unit: Optional[Unit] = None) -> tuple[float, Unit]:
    ...
    def get_str(self, unit: Optional[Unit] = None) -> str:
    ...
    def get_svg(self, unit: Optional[Unit] = None) -> str:
