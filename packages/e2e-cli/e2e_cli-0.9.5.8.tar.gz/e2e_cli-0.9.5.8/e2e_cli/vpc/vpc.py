...
class vpc_Crud:
    ...
    def create_vpc(self):
        ...
        url = "https://api.e2enetworks.com/myaccount/api/v1/vpc/?apikey="+API_key+"&location=Delhi"
        req="POST"
    ...
    def delete_vpc(self):
        ...
        API_key=self.API_key
        Auth_Token=self.Auth_Token
        url = "https://api.e2enetworks.com//myaccount/api/v1/vpc/"+ network_id +"/?apikey="+API_key
        req="DELETE"
        status=Request(url, Auth_Token, my_payload, req).response.json()
    ...
    def list_vpc(self):
        ...
        API_key= self.API_key  
        Auth_Token= self.Auth_Token 
        url = "https://api.e2enetworks.com/myaccount/api/v1/vpc/list/?apikey="+ API_key+"&location=Delhi"
        req="GET"
        status=Request(url, Auth_Token, my_payload, req).response.json()
