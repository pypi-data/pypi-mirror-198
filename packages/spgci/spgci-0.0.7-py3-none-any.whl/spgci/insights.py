...
class Insights:
    ...
    def get_stories(
        ...
        *,
        ...
        --------
        **Free text search**
        >>> Insights().get_stories(q="Suez")

        **Using List**
        >>> from datetime import datetime
        >>> Insights().get_stories(geography=["Middle East", "Asia"], updated_date_gte=datetime(2023,3,1))

        **Using Enum**
        >>> Insights().get_stories(content_type=[Insights.ContentType.News, Insights.ContentType.MarketCommentary])
        """
    ...
    def get_subscriber_notes(
        ...
        *,
        ...
        --------
        **Free text search**
        >>> Insights().get_subscriber_notes(q="steel")

        **Using List**
        >>> from datetime import datetime
        >>> Insights().get_subscriber_notes(geography=["Middle East", "Asia"], updated_date_gte=datetime(2023,3,1))

        **Using Enum**
        >>> Insights().get_subscriber_notes(content_type=[Insights.SubscriberNotesContentType.MethodologyNote, Insights.SubscriberNotesContentType.MarketNotification])
        """
    ...
    def get_content(
        ...
        --------
        **Get By ID**
        >>> Insights().get_content(id="169b5f45-04e4-43f2-b83b-ecc16f96be55")
