#!/usr/bin/env python3
"""Fast (?) and accurate elliptic integral of the first kind.
                                            ...
                                            + (
                                                ...
                                                * (
                                                    ...
                                                    + (
                                                        x
                                                        * (
                                                            0.008315593004226685
                                                            + (
                                                                x
                                                                * (
                                                                    0.007199153304100037
                                                                    + (
                                                                        x
                                                                        * (
                                                                            0.00633745662344154
                                                                            + (
                                                                                ...
                                                                                * (
                                                                                    ...
                                                                                    + (
                                                                                        x
                                                                                        * (
                                                                                            0.005097046040418718
                                                                                            + (
                                                                                                x
                                                                                                * (
                                                                                                    0.004636680381850056
                                                                                                    + (
                                                                                                        x
                                                                                                        * (
                                                                                                            0.004249547423822886
                                                                                                            + (
                                                                                                                x
                                                                                                                * 0.003919665602267974
                                                                                                            )
                                                                                                        )
                                                                                                    )
                                                                                                )
...
def ellipk(m: Tensor) -> Tensor:
    """Computation of complete elliptic integral of the first kind. Modified version of `stdlib.js`'s `ellipk` to utilize `torch.vmap` functionality.
    ...
    x = torch.where(x == 1.0, torch.inf, x)
    ...
    x = torch.where(
        (x >= 0.9) & (x < 1.0),
        -torch.log(poly_p11(1.0 - x)) * poly_p12(0.95 - x) / torch.pi,
        x,
    )
...
def t_ellipk(x: Tensor):
    ...
    return s_ellipk(x.cpu()).to(x.device, x.dtype)
