...
config = {  
		"settings" : {
			...
			"analysis": {
			  ...
			  "analyzer": {
				"postag_ana": {"filter": ["postag_filter", "postag_filter1", "postag_filter2", "unique_filter"], "type": "custom", "tokenizer": "whitespace" }, #"lowercase",
...
def testana(index:str='test'):
  ...
  "analyzer": "postag_ana",
  "text": "booked_book_VERB_VBD_NP5"
}).json()
	for t in arr['tokens']:
		print (t) 

if __name__ == "__main__": 
	fire.Fire({"init":init,"test":testana}) 
