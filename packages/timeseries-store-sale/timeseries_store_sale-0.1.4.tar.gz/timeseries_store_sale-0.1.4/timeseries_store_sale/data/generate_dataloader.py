...
import pandas as pd
from .preprossing import PreprocessData
...
class TimeSeriesDataLoader:
    ...
    def update_param(self, **kwargs):
        self.n_in = kwargs.pop('n_in', self.n_in)
        self.n_out = kwargs.pop('n_out', self.n_out)
        self.subsize = kwargs.pop('subsize', self.subsize)
        ...
        for i in range(len(o.store_arr)):
            for j in range(len(o.family_arr)):
                ds = TimeSeriesDataset(
                    o.time_sequence_data(i+1, j, o.row_data['main']), 
                    o.index_column, 
                    self.n_in, 
                    self.n_out,
                    start_date, 
    ...
    def get_data_loader(self):
        self.data_loader = DataLoader(self.ds, self.batch_size, True)
