# -*- coding: utf-8 -*-
#
# Xœuf documentation build configuration file, created by
# sphinx-quickstart on Wed May  8 15:09:31 2013.
#
...
if year >= 2015:
    year = "" if year == 2015 else "-{year}".format(year=year)
    copyright = "2015{year}, Merchise and Contributors"
elif year > 2012:
    copyright = "2012-{year}, Merchise Autrement [~º/~] and Contributors"
else:
    if year < 2012:
        year = "{year}-2012".format(year=year)
    copyright = "{year}, Medardo Rodríguez"
...
try:
    from xoeuf.release import VERSION
except ImportError:
...
try:
    from xoeuf.release import RELEASE_TAG
...
latex_documents = [
    (
        ...
        "xoeuf.tex",
        "Xœuf Documentation",
        "Merchise Autrement [~º/~] and Contributors",
        "manual",
    )
]
