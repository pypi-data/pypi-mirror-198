...
class WizataDSAPIClient:
    ...
    def __init__(self):
        ...
        self.__client_id = os.environ.get('AUTH_CLIENT_ID')
        self.__tenant_id = os.environ.get('AUTH_TENANT_ID')
        self.__scopes = [os.environ.get('AUTH_SCOPES')]
        self.__authority = os.environ.get('AUTH_AUTHORITY')
    ...
    def __token(self):
        ...
        result = None
        accounts = self.__app.get_accounts(username=self.username)
        if accounts:
