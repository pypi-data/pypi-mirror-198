...
try:
    import tinytag, Crypto, pydantic, requests
except ModuleNotFoundError:
    from .extensions import PyPi
    PyPi().installation(['tinytag', 'pycryptodome', 'pydantic', 'requests'])
...
class RubikaClient(ABC):
    ...
    __base_class__, __version__, logs = 'RubikaClient', Version.__version__, {}
