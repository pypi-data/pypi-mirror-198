...
from ..base import BaseRef, DataRef, Dataset, DataArtifact, ModelArtifact
...
class KerasModelMaterializer(ModelMaterializer):

    SUPPORTED_TYPES = (tensorflow.keras.Model, tensorflow.keras.Sequential, )
    ...
    def load_ref(self, data_type: Type[Any],
                       ...
                       options: Dict[str, Any] = None) -> Union[tensorflow.keras.Model, tensorflow.keras.Sequential, GenomeEstimator]:
