...
class LeggiDiItalia:
    ...
    main_directory_path = '/'.join([str(Path.home()), 'scrapse'])
...
class Judgment:
    ...
    def toJSON(self):
        return json.dumps(self, indent=4, cls=JudgmentEncoder, ensure_ascii=False)
...
class JudgmentCorpus:
    def __init__(self, oggetto=None, fatto=None, decisione=None, fatto_decisione=None, pqm=None) -> None:
        super().__init__()
