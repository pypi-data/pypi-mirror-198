...
from .io import Input, Output, InputSource, OutputDestination
...
class CraftAiSdk:
    ...
    def get_step(self, step_name):
        ...
        Returns:
            ...
            the step information, with the following keys:
                ...
                * ``"updated_at"`` (:obj:`str`): The last updation date in ISO format.
    ...
    def update_step(
        ...
        Warning:
            This feature is experimental. If the update failed, the step is deleted,
            and you're responsible for recreating it.
        ...
        url = f"{self.base_environment_api_url}/steps/{step_name}"
        url = f"{url}?put_all_parameters=true"
    ...
    def create_deployment(
        ...
        Args:
            ...
            inputs_mapping(`list` of instances of :class:`InputSource`):
                ...
                For endpoind rules, if an input of the step in the pipeline is not
                explictly mapped, it will be automatically mapped to an endpoint
    ...
    def create_endpoint(
        ...
        Args:
            ...
            inputs_mapping(`list` of instances of :class:`InputSource`):
                ...
                sources (such as constant values, endpoint inputs, or environment
                variables). See :class:`InputSource` for more details.
                If an input of the step in the pipeline is not explictly mapped, it
    ...
    def trigger_endpoint(
        ...
        Args:
            ...
            inputs (dict, optional): Dictionary of inputs to pass to the endpoint with
