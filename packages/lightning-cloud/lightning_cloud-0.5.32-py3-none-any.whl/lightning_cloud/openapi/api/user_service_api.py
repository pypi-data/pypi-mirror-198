...
class UserServiceApi(object):
    ...
    def user_service_request_verification_code(
            self,
            **kwargs) -> 'V1RequestVerificationCodeResponse':  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.user_service_request_verification_code_with_http_info(
                **kwargs)  # noqa: E501
        else:
            (data
             ) = self.user_service_request_verification_code_with_http_info(
                 **kwargs)  # noqa: E501
            return data

    def user_service_request_verification_code_with_http_info(
            self,
            **kwargs) -> 'V1RequestVerificationCodeResponse':  # noqa: E501
        """user_service_request_verification_code  # noqa: E501
        ...
        all_params = [
            'phone_number', 'rerequest_verification', 'recaptcha_token'
        ]  # noqa: E501
        ...
        if 'phone_number' in params:
            query_params.append(
                ('phoneNumber', params['phone_number']))  # noqa: E501
        if 'rerequest_verification' in params:
            query_params.append(
                ('rerequestVerification',
                 params['rerequest_verification']))  # noqa: E501
        if 'recaptcha_token' in params:
            query_params.append(
                ('recaptchaToken', params['recaptcha_token']))  # noqa: E501
    ...
    def user_service_verify_verification(
            self, **kwargs) -> 'V1VerifyVerificationResponse':  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_service_verify_verification_with_http_info(
                **kwargs)  # noqa: E501
        else:
            (data) = self.user_service_verify_verification_with_http_info(
                **kwargs)  # noqa: E501
            return data

    def user_service_verify_verification_with_http_info(
            self, **kwargs) -> 'V1VerifyVerificationResponse':  # noqa: E501
        """user_service_verify_verification  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'"
                                " to method user_service_verify_verification" %
                                key)
            params[key] = val
        del params['kwargs']
