...
class V1ClusterStatus(object):
    ...
    def __init__(self,
                 dependency_service_health: 'list[V1ServiceHealth]' = None,
                 ...
                 reason: 'str' = None,
                 ssh_gateway_endpoint: 'str' = None):  # noqa: E501
    ...
    def dependency_service_health(
            self, dependency_service_health: 'list[V1ServiceHealth]'):
