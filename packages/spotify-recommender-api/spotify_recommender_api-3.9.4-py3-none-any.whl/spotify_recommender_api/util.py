...
def get_total_song_count(playlist_id: str, headers: dict) -> int:
    ...
    """
    playlist_res = request_handler.get_request(url=f'https://api.spotify.com/v1/playlists/{playlist_id}', headers=headers)
...
def playlist_exists(name: str, base_playlist_name: str, headers: dict, _update_created_playlists: bool = False) -> 'str|bool':
    ...
    """
    total_playlist_count = request_handler.get_request(url='https://api.spotify.com/v1/me/playlists?limit=1', headers=headers).json()['total']
    playlists = []
...
def query_audio_features(song: pd.Series, headers: dict) -> 'list[float]':
    ...
    audio_features = request_handler.get_request(
...
def get_base_playlist_name(playlist_id: str, headers: dict) -> str:
    ...
    playlist = request_handler.get_request(
