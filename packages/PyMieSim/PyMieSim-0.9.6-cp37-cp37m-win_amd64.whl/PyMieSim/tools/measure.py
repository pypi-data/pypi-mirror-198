...
a1 = Xparameter(name='a1', format="<20s", unit="", long_label='Electric dipole coefficient')
a2 = Xparameter(name='a2', format="<20s", unit="", long_label='Electric quadrupole coefficient')
a3 = Xparameter(name='a3', format="<20s", unit="", long_label='Electric octopole coeffcient')
b1 = Xparameter(name='b1', format="<20s", unit="", long_label='Magnertic dipole coefficient')
b2 = Xparameter(name='b2', format="<20s", unit="", long_label='Magnetic quadrupole coefficient')
b3 = Xparameter(name='b3', format="<20s", unit="", long_label='Magnetic octopole coefficient')

a11 = Xparameter(name='a11', format="<20s", unit="", long_label='Electric dipole coefficient')
a21 = Xparameter(name='a21', format="<20s", unit="", long_label='Electric quadrupole coefficient')
a12 = Xparameter(name='a12', format="<20s", unit="", long_label='Electric octopole coeffcient')
a22 = Xparameter(name='a22', format="<20s", unit="", long_label='Electric dipole coefficient')
a13 = Xparameter(name='a13', format="<20s", unit="", long_label='Electric quadrupole coefficient')
a23 = Xparameter(name='a23', format="<20s", unit="", long_label='Electric octopole coeffcient')

b11 = Xparameter(name='b11', format="<20s", unit="", long_label='Electric dipole coefficient')
b21 = Xparameter(name='b21', format="<20s", unit="", long_label='Electric quadrupole coefficient')
b12 = Xparameter(name='b12', format="<20s", unit="", long_label='Electric octopole coeffcient')
b22 = Xparameter(name='b22', format="<20s", unit="", long_label='Electric dipole coefficient')
b13 = Xparameter(name='b13', format="<20s", unit="", long_label='Electric quadrupole coefficient')
b23 = Xparameter(name='b23', format="<20s", unit="", long_label='Electric octopole coeffcient')
