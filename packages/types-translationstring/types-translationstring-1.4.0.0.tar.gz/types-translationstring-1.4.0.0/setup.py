...
description = "Typing stubs for translationstring"
long_description = '''
## Typing stubs for translationstring

This is a PEP 561 type stub package for the `translationstring` package. It
...
setup(name=name,
      ...
      install_requires=[],
      packages=['translationstring-stubs'],
      package_data={'translationstring-stubs': ['__init__.pyi', 'METADATA.toml']},
