...
from fx_iqoption.http.login import Login
from fx_iqoption.http.loginv2 import Loginv2
from fx_iqoption.http.logout import Logout
from fx_iqoption.http.getprofile import Getprofile
from fx_iqoption.http.auth import Auth
from fx_iqoption.http.token import Token
from fx_iqoption.http.appinit import Appinit
from fx_iqoption.http.billing import Billing
from fx_iqoption.http.buyback import Buyback
from fx_iqoption.http.changebalance import Changebalance
from fx_iqoption.http.events import Events
from fx_iqoption.ws.client import WebsocketClient
from fx_iqoption.ws.chanels.get_balances import *

from fx_iqoption.ws.chanels.ssid import Ssid
from fx_iqoption.ws.chanels.subscribe import *
from fx_iqoption.ws.chanels.unsubscribe import *
from fx_iqoption.ws.chanels.setactives import SetActives
from fx_iqoption.ws.chanels.candles import GetCandles
from fx_iqoption.ws.chanels.buyv2 import Buyv2
from fx_iqoption.ws.chanels.buyv3 import *
from fx_iqoption.ws.chanels.user import *
from fx_iqoption.ws.chanels.api_game_betinfo import Game_betinfo
from fx_iqoption.ws.chanels.instruments import Get_instruments
from fx_iqoption.ws.chanels.get_financial_information import GetFinancialInformation
from fx_iqoption.ws.chanels.strike_list import Strike_list
from fx_iqoption.ws.chanels.leaderboard import Leader_Board

from fx_iqoption.ws.chanels.traders_mood import Traders_mood_subscribe
from fx_iqoption.ws.chanels.traders_mood import Traders_mood_unsubscribe
from fx_iqoption.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from fx_iqoption.ws.chanels.get_order import Get_order
from fx_iqoption.ws.chanels.get_deferred_orders import GetDeferredOrders
from fx_iqoption.ws.chanels.get_positions import *
 
from fx_iqoption.ws.chanels.get_available_leverages import Get_available_leverages
from fx_iqoption.ws.chanels.cancel_order import Cancel_order
from fx_iqoption.ws.chanels.close_position import Close_position
from fx_iqoption.ws.chanels.get_overnight_fee import Get_overnight_fee
from fx_iqoption.ws.chanels.heartbeat import Heartbeat

 
from fx_iqoption.ws.chanels.digital_option import *
from fx_iqoption.ws.chanels.api_game_getoptions import *
from fx_iqoption.ws.chanels.sell_option import Sell_Option
from fx_iqoption.ws.chanels.change_tpsl import Change_Tpsl
from fx_iqoption.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from fx_iqoption.ws.objects.timesync import TimeSync
from fx_iqoption.ws.objects.profile import Profile
from fx_iqoption.ws.objects.candles import Candles
from fx_iqoption.ws.objects.listinfodata import ListInfoData
from fx_iqoption.ws.objects.betinfo import Game_betinfo_data
import fx_iqoption.global_value as global_value
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <fx_iqoption.http.resource.Resource>`.
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <fx_iqoption.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <fx_iqoption.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <fx_iqoption.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <fx_iqoption.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <fx_iqoption.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <fx_iqoption.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <fx_iqoption.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <fx_iqoption.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
    @property
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <fx_iqoption.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <fx_iqoption.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <fx_iqoption.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <fx_iqoption.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <fx_iqoption.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
