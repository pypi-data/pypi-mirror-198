...
def _init(
    ...
    if not api_key:
        logger_obj.info("API key not provided. Will run dataset client in offline mode.")
...
@_dataset_client_alias
def sync_dataset_data(*args, **kwargs):
    return _DATASET.sync_dataset_data(*args, **kwargs)
