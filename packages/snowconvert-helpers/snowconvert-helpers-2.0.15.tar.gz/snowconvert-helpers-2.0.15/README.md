...
* v2.0.15 (March 17, 2023)
  > * _Removing max_error default value of 1 to avoid exit on error. 
  > * _Adding max_errorlevel to exit when the resulting errorlevel is greater or equal to the value set.
