...
setuptools.setup(
    name="PyHelpTools", # Put your username here!
    version="0.1.1", # The version of your package!
    author="Dashtiss", # Your name here!
    author_email="dashtiss@gmail.com", # Your e-mail here!
    description="PyHelpTools are tools to help develepors", # A short description here!
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Dashtiss/PyHelpTools", # Link your package website here! (most commonly a GitHub repo)
