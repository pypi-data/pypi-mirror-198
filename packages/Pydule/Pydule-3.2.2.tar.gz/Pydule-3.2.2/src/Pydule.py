try:
	...
	root.title('\U0000274C Something Went Wrong \U0000274C')
	l=Label(text=ex).pack()
	root.mainloop()
...
def functions():
	l=['translate()','ytmp4()','ytmp3()','cqrcode()','dqrcode()','restr()','relist()','retuple()','clist()','ctuple()','cdict()','cset()','pickcolor()','search()','playsong()','restart_system()','shutdown_system()','datetoday()','timenow()','say()','openfile()','weathernow()','setvoice()','voicerate()']
