...
class ACLosses(object):
    ...
    def __post_init__(self):
        if not (
            (self.transformer_load is None and self.transformer_no_load is None) or
            self.hv_transformer is None
        ):
...
GenerationModel = t.Union[PVGenerationModel, DCExternalGenerationModel, ACExternalGenerationModel]
