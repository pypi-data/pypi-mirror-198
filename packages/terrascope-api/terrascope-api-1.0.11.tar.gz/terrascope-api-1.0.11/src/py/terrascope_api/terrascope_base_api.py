...
class TerrascopeBaseApi(ABC):
    def __init__(self, oi_papi_url, port=443, secure=True, api_token=None):
        ...
        self._channel = self._get_channel(self._get_ssl_channel_credentials(secure))
    ...
    def _get_ssl_channel_credentials(self, secure):
        ...
        if secure:
            return grpc.ssl_channel_credentials(root_certificates=None, private_key=None, certificate_chain=None)
