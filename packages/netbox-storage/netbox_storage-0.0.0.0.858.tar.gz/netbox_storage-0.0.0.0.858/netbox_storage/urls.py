...
from netbox_storage.views.logical_volume import LogicalVolumeDeleteView, LogicalVolumeEditView, LogicalVolumeView, \
    LogicalVolumeListView, LogicalVolumeBulkImportView, LogicalVolumeBulkEditView, LogicalVolumeBulkDeleteView
from netbox_storage.views.physical_volume import PhysicalVolumeDeleteView, PhysicalVolumeEditView, PhysicalVolumeView, \
    PhysicalVolumeListView, PhysicalVolumeBulkImportView, PhysicalVolumeBulkEditView, PhysicalVolumeBulkDeleteView
from netbox_storage.views.template import LVMAddTemplateView, AddTemplateDriveView, \
    AddTemplatePartitionView, SyncTemplateToVMView
from netbox_storage.views.volume_group import VolumeGroupDeleteView, VolumeGroupEditView, VolumeGroupView, \
    VolumeGroupListView, VolumeGroupBulkImportView, VolumeGroupBulkEditView, VolumeGroupBulkDeleteView
...
urlpatterns = [
    ...
    path('sync-template-to-vm/', SyncTemplateToVMView.as_view(), name='sync-template-to-vm')
]
