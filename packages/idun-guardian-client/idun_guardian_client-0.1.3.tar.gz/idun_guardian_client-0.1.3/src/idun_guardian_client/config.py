...
class Settings(BaseSettings):
    ...
    # Websocket Connection API Gateway # TODO: Point to develop environment
    WS_IDENTIFIER: str = "wss://phqgnvv5lc.execute-api.eu-central-1.amazonaws.com/v1"
    # REST API Gateway # TODO: Point to develop environment
    REST_API_LOGIN: str = "https://eezgkn88ka.execute-api.eu-central-1.amazonaws.com/"
    REST_API_URL_GET: str = "https://eezgkn88ka.execute-api.eu-central-1.amazonaws.com/"
