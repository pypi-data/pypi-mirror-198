...
class DiagramView(generic.ObjectView):
    ...
    def get_extra_context(self, request, instance):
        ...
        return {
            "topology_data": json.dumps(module(interface_qs, instance.details)),
            "topology_details": json.dumps(instance.details),
        }
    ...
    * DiscoveryLogView clicking on the Discovery button on a specific Discoverable.
    ...
    def get(self, request, **kwargs):
        ...
        data = {
            ...
            "parsed_output": instance.parsed_output,
            "raw_output": instance.raw_output,
            "template": instance.template,
            "success": instance.success,
            "parsed": instance.parsed,
            "ingested": instance.ingested,
            "discoverable__mode": instance.discoverable.mode,
        }
