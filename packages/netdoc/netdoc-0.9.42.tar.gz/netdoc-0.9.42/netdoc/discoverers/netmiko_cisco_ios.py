...
def discovery(nrni):
    ...
    def multiple_tasks(task):
        ...
        utils.append_nornir_task(
            task,
            [
                # "show logging", # Not yet ingested
                "show etherchannel summary",
                "show interfaces switchport",
                # "show spanning-tree", # Not yet ingested
                # "show interfaces trunk", # Missing NTC template
                # "show standby", # Not yet ingested
                # "show vrrp all", # Not yet ingested
                # "show glbp", # Missing NTC template
                # "show ip ospf neighbor", # Not yet ingested
                # "show ip eigrp neighbors", # Not yet ingested
