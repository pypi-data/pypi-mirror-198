    ...
    def multiple_tasks(task):
        ...
        utils.append_nornir_task(
            ...
            [
                ...
                "display lldp neighbor-information verbose",  # Depending on version, "verbose" may be unsupportted
                "display lldp neighbor-information list",  # Depending on version, "verbose" may be unsupportted
                "display vlan brief",  # Depending on version, "brief" may be unsupportted
                "display vlan all",  # Depending on version, "brief" may be unsupportted
