...
#   timestamp: 2023-03-15T13:05:24+00:00
...
class BlueGreen(BaseModel):
    ...
    type: constr(regex=r"^blue_green$")
...
class CanaryStep(BaseModel):
    ...
    pause_indefinitely: bool = Field(
        False,
        description="+docs=Pause the traffic split at this stage. The release will be paused till the time it is manually resumed\n+label=Pause indefinitely",
    )
...
class Job(BaseModel):
    ...
    file_mounts: Optional[List[FileMount]] = Field(
        None,
        description="+usage=Files to be mounted to job pod(s)\n+ignore\n+sort=10010",
    )
...
class Service(BaseModel):
    ...
    file_mounts: Optional[List[FileMount]] = Field(
        None,
        description="+usage=Files to be mounted to service pod(s)\n+ignore\n+sort=10010",
    )
    labels: Optional[Dict[str, str]] = Field(
        None, description="+label=Labels\n+usage=Add labels to service metadata"
    )
