...
class HivePlot:
    ...
    def add_axes(self, axes: List[Axis]):
        """
    ...
    def add_nodes(self, nodes: List[Node], check_uniqueness: bool = True):
        """
    ...
    def _allocate_nodes_to_axis(self, unique_ids: List[Hashable], axis_id: Hashable):
        """
    ...
    def place_nodes_on_axis(self, axis_id: Hashable, unique_ids: Union[Optional[List[Hashable]], np.ndarray] = None,
    ...
    def reset_edges(self, axis_id_1: Optional[Hashable] = None, axis_id_2: Optional[Hashable] = None,
                    tag: Optional[Hashable] = None, a1_to_a2: bool = True, a2_to_a1: bool = True):
        """
    ...
    def _find_unique_tag(self, from_axis_id: Hashable, to_axis_id: Hashable,
                         bidirectional: bool = False) -> Hashable:
        """
    ...
    def __store_edge_ids(self, edge_ids: np.ndarray, from_axis_id: Hashable, to_axis_id: Hashable,
                         tag: Optional[Hashable] = None, bidirectional: bool = False) -> Hashable:
        """
    ...
    def add_edge_ids(self, edges: np.ndarray, axis_id_1: Hashable, axis_id_2: Hashable, tag: Optional[Hashable] = None,
    ...
    def add_edge_curves_between_axes(self, axis_id_1: Hashable, axis_id_2: Hashable, tag: Optional[Hashable] = None,
    ...
    def add_edge_kwargs(self, axis_id_1: Hashable, axis_id_2: Hashable, tag: Optional[Hashable] = None,
    ...
    def connect_axes(self, edges: np.ndarray, axis_id_1: Hashable, axis_id_2: Hashable, tag: Optional[Hashable] = None,
                     a1_to_a2: bool = True, a2_to_a1: bool = True,
...
def hive_plot_n_axes(node_list: List[Node], edges: Union[np.ndarray, List[np.ndarray]],
                     axes_assignments: List[List[Union[Hashable, None]]],
                     sorting_variables: List[Hashable], axes_names: Optional[List[Hashable]] = None,
                     repeat_axes: Optional[List[bool]] = None,
                     vmins: Optional[List[float]] = None, vmaxes: Optional[List[float]] = None,
                     angle_between_repeat_axes: float = 40, orient_angle: float = 0,
                     all_edge_kwargs: Optional[Dict] = None, edge_list_kwargs: Optional[List[Dict]] = None,
                     cw_edge_kwargs: Optional[Dict] = None, ccw_edge_kwargs: Optional[Dict] = None,
                     repeat_edge_kwargs: Optional[Dict] = None) -> HivePlot:
    """
