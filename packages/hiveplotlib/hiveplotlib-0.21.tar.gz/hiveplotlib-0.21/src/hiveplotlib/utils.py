...
def cartesian2polar(x: Union[np.ndarray, float],
                    y: Union[np.ndarray, float]) -> Tuple[Union[np.ndarray, float], Union[np.ndarray, float]]:
    """
...
def polar2cartesian(rho: Union[np.ndarray, float],
                    phi: Union[np.ndarray, float]) -> Tuple[Union[np.ndarray, float], Union[np.ndarray, float]]:
    """
...
def bezier(start: float, end: float, control: float, num_steps: int = 100) -> np.ndarray:
    """
...
def bezier_all(start_arr: Union[List[float], np.ndarray],
