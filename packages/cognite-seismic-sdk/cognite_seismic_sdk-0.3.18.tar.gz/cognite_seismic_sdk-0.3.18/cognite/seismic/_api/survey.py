...
if not os.getenv("READ_THE_DOCS"):
    ...
    from cognite.seismic.protos.v1.seismic_service_datatypes_pb2 import SurveyCoverageSource as SCSProto
...
class SurveyAPI(API):
    ...
    def _search_internal(
        ...
        request = SearchSurveysRequest(
            ...
            coverage_source=SCSProto.ValueType(coverage_source.value),
