...
class Pipeline:
    ...
    **kwargs: keyword arguments
    ...
    def translation_result(self, text:list, source_language:str, pipeline) -> list:
        """It returns the translation results of a text.
        parameters:
        ----------------
        text: list[str]
        source_language: str
        ...
        results: list of dict
        """
        from aimped.nlp.translation import split_text, translate
        translated_text = translate(text=text,source_language=source_language,pipeline = pipeline)
