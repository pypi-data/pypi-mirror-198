...
class Discrete(abc_.ConditionalDistribution, abc_.HasGenerator):
    ...
    where the occurrance of each class label is balanced.

    Args:
        samples: Discrete index used for sampling
    """

    def _to_numpy_int(self, samples):
    ...
    def __init__(self, samples, device="cpu", seed=None):
    ...
    def sample_uniform(self, num_samples: int):
    ...
    def sample_empirical(self, num_samples: int):
