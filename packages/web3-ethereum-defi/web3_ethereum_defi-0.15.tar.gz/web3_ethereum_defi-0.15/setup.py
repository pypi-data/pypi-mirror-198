...
package_data = \
{'': ['*'],
 'eth_defi': ['abi/*', 'abi/aave_v3/*', 'abi/enzyme/*', 'abi/uniswap_v3/*']}
...
setup_kwargs = {
    ...
    'version': '0.15',
    'description': 'Integrate DeFi trading and and analytics for Uniswap, Aave, PancakeSwap, Trader Joe, QuickSwap and many others.',
