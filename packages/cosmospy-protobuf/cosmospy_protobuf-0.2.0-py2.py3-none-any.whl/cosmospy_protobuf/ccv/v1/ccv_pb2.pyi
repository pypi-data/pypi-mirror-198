...
class ConsumerPacketData(_message.Message):
    __slots__ = ['slashPacketData', 'type', 'vscMaturedPacketData']
...
class SlashPacketData(_message.Message):
    __slots__ = ['infraction', 'validator', 'valset_update_id']
...
class ValidatorSetChangePacketData(_message.Message):
    __slots__ = ['slash_acks', 'validator_updates', 'valset_update_id']
