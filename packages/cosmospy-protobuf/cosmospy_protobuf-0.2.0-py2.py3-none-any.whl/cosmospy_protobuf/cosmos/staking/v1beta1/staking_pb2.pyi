...
class RedelegationEntry(_message.Message):
    __slots__ = ['completion_time', 'creation_height', 'initial_balance', 'shares_dst', 'unbonding_id', 'unbonding_on_hold_ref_count']
...
class UnbondingDelegationEntry(_message.Message):
    __slots__ = ['balance', 'completion_time', 'creation_height', 'initial_balance', 'unbonding_id', 'unbonding_on_hold_ref_count']
    BALANCE_FIELD_NUMBER: _ClassVar[int]
    COMPLETION_TIME_FIELD_NUMBER: _ClassVar[int]
    CREATION_HEIGHT_FIELD_NUMBER: _ClassVar[int]
    INITIAL_BALANCE_FIELD_NUMBER: _ClassVar[int]
...
class Validator(_message.Message):
    __slots__ = ['commission', 'consensus_pubkey', 'delegator_shares', 'description', 'jailed', 'min_self_delegation', 'operator_address', 'status', 'tokens', 'unbonding_height', 'unbonding_ids', 'unbonding_on_hold_ref_count', 'unbonding_time']
