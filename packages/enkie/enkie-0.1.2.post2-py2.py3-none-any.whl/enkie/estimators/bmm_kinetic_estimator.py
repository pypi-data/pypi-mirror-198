...
from ..storage import DEFAULT_KCAT_MODEL, DEFAULT_KM_MODEL, get_cached_filepath
...
class BmmKineticEstimator(KineticsEstimatorInterface):
    ...
    def _load_models(self):
        ...
        km_path = str(get_cached_filepath(DEFAULT_KM_MODEL))
        kcat_path = str(get_cached_filepath(DEFAULT_KCAT_MODEL))
