...
def trim_pad_2d_array(array_to_check,
  ...
  """
  # :TODO: 2022-09-26 SDK-790 Remove this function in a future version.
  warnings.warn(
    "trim_pad_2d_array is deprecated and will be removed in a future version.",
    DeprecationWarning)
...
def trim_pad_1d_array(array_to_check, elements_to_keep=-1, fill_value=True):
  ...
  # :TODO: 2022-09-26 SDK-790 Remove this function in a future version.
  warnings.warn(
    "trim_pad_1d_array is deprecated and will be removed in a future version.",
    DeprecationWarning)
  if not isinstance(array_to_check, np.ndarray):
    array_to_check = np.array(array_to_check)
...
def convert_array_to_rgba(colour_array, expected_size, default_colour=None):
  ...
  # :TODO: 2022-09-26 SDK-790 Remove this function in a future version.
  warnings.warn(
    "convert_array_to_rgba is deprecated and will be removed in a future "
    "version.",
    DeprecationWarning)
