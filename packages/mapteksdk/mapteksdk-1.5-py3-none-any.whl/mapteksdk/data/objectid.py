...
class ObjectID(typing.Generic[T]):
  ...
  def _revision_number(self) -> int:
    ...
    """
    return DataEngine().GetObjectIdRevisionNumber(self.handle)
  ...
  def is_a(self, object_type):
    ...
    if isinstance(object_type, typing.Iterable):
      try:
        return any(
  ...
  def _is_exactly_a(self, object_type):
    ...
    raise TypeError(
      ...
      f"static_type property, not '{static_type}'")
