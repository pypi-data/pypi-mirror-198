...
from .errors import InvalidColourMapError
...
class NumericColourMap(DataObject):
  ...
  def __init__(
    ...
    self.__upper_cutoff: np.ndarray | None = None
    self.__lower_cutoff: np.ndarray | None = None
    ...
    self.interpolated: np.ndarray | None = True
    self.upper_cutoff: np.ndarray | None = None
    self.lower_cutoff: np.ndarray | None = None
    if not is_new:
  ...
  @property
  def id(self) -> ObjectID[NumericColourMap]:
    return super().id
  ...
  @colours.setter
  def colours(self, colours: np.ndarray):
    if colours is None:
  ...
  @property
  def upper_cutoff(self) -> np.ndarray:
  ...
  @upper_cutoff.setter
  def upper_cutoff(self, upper_cutoff: np.ndarray):
  ...
  @property
  def lower_cutoff(self) -> np.ndarray:
  ...
  @lower_cutoff.setter
  def lower_cutoff(self, lower_cutoff: np.ndarray):
...
class StringColourMap(DataObject):
  ...
  def _raise_if_case_insensitive_duplicates(self, legend: typing.Iterable[str]):
  ...
  @property
  def id(self) -> ObjectID[StringColourMap]:
    return super().id
  ...
  @legend.setter
  def legend(self, legend: np.ndarray):
    if legend is None:
  ...
  @cutoff.setter
  def cutoff(self, cutoff: np.ndarray):
    if cutoff is None:
      self.__cutoff = None
      return
  ...
  def case_sensitive(self) -> bool:
    ...
    if self.__case_sensitive is None:
      self.__case_sensitive = Modelling().StringColourMapGetCaseSensitive(
        self._lock.lock)
  ...
  def save(self):
    ...
    Modelling().StringColourMapSetCaseSensitive(
