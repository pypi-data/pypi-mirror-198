...
class EdgeProperties:
  ...
  def _initialise_edge_properties(self, has_immutable_edges: bool):
    ...
    self.__edges = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        save_function=Modelling().EdgeToPointIndexBeginRW,
        cached_primitive_count_function=None,
        set_primitive_count_function=Modelling().SetEdgeCount,
    ...
    self.__edge_colours = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        load_function=Modelling().EdgeColourBeginR,
        save_function=Modelling().EdgeColourBeginRW,
    ...
    self.__edge_selection = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        save_function=Modelling().EdgeSelectionBeginRW,
        raise_on_error_code=Modelling().RaiseOnErrorCode
      )
    )
  ...
  def edge_count(self) -> int:
    ...
    if not self.__edges.are_values_cached:
      return Modelling().ReadEdgeCount(self._lock.lock)
  ...
  def save_edge_attribute(self, attribute_name: str, data: npt.ArrayLike):
  ...
  def delete_edge_attribute(self, attribute_name: str):
