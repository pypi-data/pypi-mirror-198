...
class Surface(PointProperties, PointDeletionProperties, EdgeProperties,
              FacetProperties, Topology, TwoSidedColouringMixin):
  ...
  def __init__(
      self,
      object_id: ObjectID[Surface]=None,
  ...
  def associate_raster(
    ...
    self._raise_if_read_only("associate a raster")
    # pylint: disable=protected-access;
    if raster.closed:
