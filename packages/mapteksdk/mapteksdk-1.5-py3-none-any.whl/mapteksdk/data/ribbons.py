...
if typing.TYPE_CHECKING:
  ...
  from ..common.typing import ColourArray, Colour, FloatArray, Vector3DArray
...
class _RibbonMixin:
  ...
  def _define_ribbon_properties(self):
    ...
    self.__point_angles = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        default=0.0,
        column_count=1,
        load_function=Modelling().PointAnglesBeginR,
        save_function=Modelling().PointAnglesBeginRW,
    ...
    self.__point_width = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        default=10.0,
        column_count=1,
        load_function=Modelling().PointWidthsBeginR,
        save_function=Modelling().PointWidthsBeginRW,
        primitive_count_function=Modelling().ReadPointCount,
        cached_primitive_count_function=lambda: self.point_count,
        raise_on_error_code=Modelling().RaiseOnErrorCode
      )
    ...
    self.__point_normals = DataProperty(
      ...
      configuration=DataPropertyConfiguration(
        ...
        default=np.nan,
        column_count=3,
        load_function=Modelling().PointNormalsBeginR,
        save_function=None,
        primitive_count_function=Modelling().ReadPointCount,
        cached_primitive_count_function=lambda: self.point_count,
        raise_on_error_code=Modelling().RaiseOnErrorCode,
  ...
  @point_angles.setter
  def point_angles(self, new_angles: npt.ArrayLike):
  ...
  @point_widths.setter
  def point_widths(self, new_width: npt.ArrayLike):
  ...
  @front_colour.setter
  def front_colour(self, new_colour: Colour):
...
class RibbonChain(Polyline, _RibbonMixin, TwoSidedColouringMixin):
  ...
  def __init__(self, object_id=None, lock_type=LockType.READWRITE):
    ...
    if not object_id:
      object_id = ObjectID(Modelling().NewRibbonChain())
  ...
  def static_type(cls):
    ...
    network.
    """
    return Modelling().RibbonChainType()

  @property
  def id(self) -> ObjectID[RibbonChain]:
    return super().id
  ...
  def point_colours(self, point_colours: npt.ArrayLike):
    ...
    Polyline.point_colours.fset(self, point_colours)
...
class RibbonLoop(Polygon, _RibbonMixin, TwoSidedColouringMixin):
  ...
  def __init__(self, object_id=None, lock_type=LockType.READWRITE):
    ...
    if not object_id:
      object_id = ObjectID(Modelling().NewRibbonLoop())
    super().__init__(object_id, lock_type)
    self._define_ribbon_properties()
  ...
  def static_type(cls):
    ...
    network.
    """
    return Modelling().RibbonLoopType()

  @property
  def id(self) -> ObjectID[RibbonLoop]:
    return super().id
  ...
  def point_colours(self, point_colours: npt.ArrayLike):
    ...
    # super().point_colours = point_colours
    # is invalid syntax. See https://github.com/python/cpython/issues/59170.
    Polygon.point_colours.fset(self, point_colours)
