...
class BaseTable:
  ...
  @property
  def custom_fields(self) -> list[BaseField]:
  ...
  @property
  def _parent(self) -> Drillhole | DrillholeDatabase | None:
  ...
  @_parent.setter
  def _parent(self, value: Drillhole | DrillholeDatabase):
  ...
  def fields_by_type(self, field_type: DrillholeFieldType
    ...
    if self._fields_by_type is None:
      raise ObjectClosedError()
    return self._fields_by_type[field_type]

  def field_by_name(self, name: str) -> BaseField:
  ...
  def _field_by_type(
      self, field_type: DrillholeFieldType) -> BaseField:
    """Get a field by type.
...
class BaseTableInformation(BaseTable):
  ...
  @property
  def fields(self) -> list[FieldInformation]:
    return super().fields

  @property
  def custom_fields(self) -> list[FieldInformation]:
    return super().custom_fields
  ...
  def fields_by_type(self, field_type: DrillholeFieldType
    ...
    return super().fields_by_type(field_type)

  def field_by_name(self, name: str) -> FieldInformation:
    return super().field_by_name(name)

  def _field_by_type(
      self, field_type: DrillholeFieldType) -> FieldInformation:
    return super()._field_by_type(field_type)
  ...
  def add_field(
      ...
      *,
      ...
      unit: DistanceUnit | AngleUnit | NO_UNIT | None=None,
      index: int | None=None):
  ...
  def _notify_field_type_changed(
      self, field: BaseField, old_type: DrillholeFieldType):
  ...
  def _notify_field_deleted(self, field: BaseField):
...
class BaseDrillholeTable(BaseTable):
  ...
  @property
  def fields(self) -> list[DrillholeDatabaseField]:
    return super().fields
  @property
  def custom_fields(self) -> list[DrillholeDatabaseField]:
    return super().custom_fields
  ...
  # See https://github.com/PyCQA/pylint/issues/5822 for progress.
  def fields_by_type(self, field_type: DrillholeFieldType
      ) -> list[DrillholeDatabaseField]:
    return super().fields_by_type(field_type)

  def field_by_name(self, name: str) -> DrillholeDatabaseField:
    return super().field_by_name(name)

  def _field_by_type(self, field_type: DrillholeFieldType
  ...
  def row_count(self) -> int:
    ...
    if self.__row_count is None:
      #pylint: disable=protected-access
      self.__row_count = DrillholeModel().GetTableRowCount(
  ...
  @contextmanager
  def dataframe(self, *,
      fields: list[DrillholeDatabaseField] | None=None,
  ...
  def _get_pandas(self,
      fields: list[DrillholeDatabaseField],
...
class _TableWithDepthFieldsMixin:
  """Mixin which provides to_depth, from_depth and thickness fields."""
  @property
  def from_depth(self) -> BaseField:
...
class _TableWithAzimuthDipMixin:
  """Mixin which provides azimuth and depth fields"""

  @property
  def azimuth(self) -> BaseField:
...
class _CollarTableMixin(_TableWithAzimuthDipMixin):
  ...
  def elevation(self) -> BaseField:
    ...
    Changes to the elevation field will be propogated to the collar point
    of the drillhole when save() is called.
  ...
  @property
  def total_depth(self) -> BaseField:
...
class _SurveyTableMixin(_TableWithAzimuthDipMixin):
  """Mixin which adds properties for accessing common fields in survey tables.
  """

  @property
  def depth(self) -> BaseField:
...
class _GeologyTableMixin(_TableWithDepthFieldsMixin):
  """Mixin which adds properties for accessing common fields in geology tables.
  """

  @property
  def rock_type(self) -> BaseField:
    """The rock type field.
...
class CollarTable(BaseDrillholeTable, _CollarTableMixin):
  ...
  @property
  def azimuth(self) -> DrillholeDatabaseField:
    return super().azimuth

  @property
  def dip(self) -> DrillholeDatabaseField:
    return super().dip

  @property
  def easting(self) -> DrillholeDatabaseField:
    return super().easting

  @property
  def northing(self) -> DrillholeDatabaseField:
    return super().northing

  @property
  def elevation(self) -> DrillholeDatabaseField:
    return super().elevation

  @property
  def total_depth(self) -> DrillholeDatabaseField:
    return super().total_depth

  @property
  def collar_point(self) -> np.ndarray:
  ...
  @collar_point.setter
  def collar_point(self, value: list[float]):
...
class SurveyTable(BaseDrillholeTable, _SurveyTableMixin):
  """Table containing survey information for a drillhole.

  Changes to the depth and azimuth fields will be propogated to the points
  ...
  @property
  def depth(self) -> DrillholeDatabaseField:
    return super().depth


class GeologyTable(BaseDrillholeTable, _GeologyTableMixin):
  ...
  @property
  def from_depth(self) -> DrillholeDatabaseField:
    return super().from_depth

  @property
  def to_depth(self) -> DrillholeDatabaseField:
    return super().to_depth

  @property
  def thickness(self) -> DrillholeDatabaseField:
    return super().thickness

  @property
  def rock_type(self) -> DrillholeDatabaseField:
    return super().rock_type

  @property
  def horizon(self) -> DrillholeDatabaseField:
    return super().horizon


class AssayTable(BaseDrillholeTable, _TableWithDepthFieldsMixin):
...
class DownholeTable(BaseDrillholeTable, _TableWithDepthFieldsMixin):
...
class QualityTable(BaseDrillholeTable, _TableWithDepthFieldsMixin):
...
class CollarTableInformation(BaseTableInformation, _CollarTableMixin):
  ...
  * DrillholeFieldType.NONE
  ...
  @property
  def azimuth(self) -> FieldInformation:
    return super().azimuth

  @property
  def dip(self) -> FieldInformation:
    return super().dip

  @property
  def easting(self) -> FieldInformation:
    return super().easting

  @property
  def northing(self) -> FieldInformation:
    return super().northing

  @property
  def elevation(self) -> FieldInformation:
    return super().elevation

  @property
  def total_depth(self) -> FieldInformation:
    return super().total_depth
...
class SurveyTableInformation(BaseTableInformation, _SurveyTableMixin):
  ...
  * DrillholeFieldType.NONE
  ...
  @property
  def depth(self) -> FieldInformation:
    return super().depth
...
class GeologyTableInformation(BaseTableInformation, _GeologyTableMixin):
  ...
  * DrillholeFieldType.NONE
  ...
  @property
  def from_depth(self) -> FieldInformation:
    return super().from_depth

  @property
  def to_depth(self) -> FieldInformation:
    return super().to_depth

  @property
  def thickness(self) -> FieldInformation:
    return super().thickness

  @property
  def rock_type(self) -> FieldInformation:
    return super().rock_type

  @property
  def horizon(self) -> FieldInformation:
    return super().horizon
...
class AssayTableInformation(BaseTableInformation, _TableWithDepthFieldsMixin):
...
class DownholeTableInformation(
    BaseTableInformation, _TableWithDepthFieldsMixin):
...
class QualityTableInformation(BaseTableInformation, _TableWithDepthFieldsMixin):
