...
class Modelling(WrapperBase):
  ...
  def __init__(self):
    super().__init__("mdf_modelling", "mapteksdk.capi.modelling")
    if DataEngine().dll:
      try:
  ...
  def capi_functions(self):
    return [
      ...
      {"ModellingPreDataEngineInit" : (ctypes.c_void_p, None),
       ...
       "ModellingUpdateNumericColourMapInterpolated" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_uint8), ]),
       "ModellingUpdateNumericColourMapSolid" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_uint8), ]),
       ...
       "ModellingUpdateStringColourMap" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.c_uint32, ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_uint8), ]),
       ...
       "ModellingGetEffectiveBlockColour" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint8), ]),
       ...
       "ModellingReadBlockTransform" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ]),
       "ModellingGetAnnotationPosition" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_double), ]),
       ...
       "ModellingGetMarkerRotation" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_double), ]),
       ...
       "ModellingReadBlockDimensions" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_uint32), ]),
       "ModellingReadExtent" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_double), ]),
       "ModellingReadBlockSize" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.POINTER(ctypes.c_double), ]),
      ...
      {"ModellingCApiVersion" : (ctypes.c_uint32, None),
       ...
       "ModellingSetMarkerHeight" : (ctypes.c_void_p, [ctypes.POINTER(T_ReadHandle), ctypes.c_double, ]),
  ...
  def HasTopologyFrontColour(self, lock):
  ...
  def HasTopologyBackColour(self, lock):
