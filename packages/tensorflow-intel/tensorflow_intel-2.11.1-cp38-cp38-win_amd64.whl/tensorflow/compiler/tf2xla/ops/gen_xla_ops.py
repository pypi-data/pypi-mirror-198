...
def xla_call_module(args, module, Sout, Tout, dim_args_spec, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaCallModule", name, args, "module", module, "Sout", Sout,
    ...
    try:
      _result = _dispatcher_for_xla_call_module(
          (args, module, Sout, Tout, dim_args_spec, name,), None)
      if _result is not NotImplemented:
        return _result
      return xla_call_module_eager_fallback(
          args, module=module, Sout=Sout, Tout=Tout,
          dim_args_spec=dim_args_spec, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
            xla_call_module, (), dict(args=args, module=module, Sout=Sout,
                                      Tout=Tout, dim_args_spec=dim_args_spec,
                                      name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
  ...
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaCallModule", args=args, module=module, Sout=Sout, Tout=Tout,
  ...
  _result = _outputs[:]
  if _execute.must_record_gradient():
    _attrs = ("module", _op.get_attr("module"), "Sout", _op.get_attr("Sout"),
              "Tout", _op.get_attr("Tout"), "Tin", _op.get_attr("Tin"),
...
def xla_call_module_eager_fallback(args, module, Sout, Tout, dim_args_spec, name, ctx):
  ...
  _attrs = ("module", module, "Sout", Sout, "Tout", Tout, "Tin", _attr_Tin,
