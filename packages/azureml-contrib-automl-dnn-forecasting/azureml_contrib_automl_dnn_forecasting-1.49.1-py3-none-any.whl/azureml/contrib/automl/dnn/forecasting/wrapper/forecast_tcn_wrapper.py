...
import sys
import logging
from typing import Union, cast, Dict, List, Optional, Tuple
import numpy as np
import pandas as pd
import torch
...
class ForecastTCNWrapper(DNNForecastWrapper):
    ...
    def train(self, n_epochs: int, X: DataInputType = None, y: DataInputType = None,
        ...
        if self.forecaster is None:
            ...
            self._build_model_forecaster(run_update_callback, dset_config, ds, ds.embedding_col_infos)
    ...
    def _distributed_train(self,
        ...
        if self.forecaster is None:
            ...
            self._build_model_forecaster(run_update_callback, dset_config, dataset_config, True)
        # set the lookback as the receptive field of the model for the dataset
    ...
    def _build_model_forecaster(self, run_update_callback: RunUpdateCallback,
        ...
        if is_distributed:
            ...
            train_valid_metrics = get_supported_metrics_for_distributed_forecasting(
                ...
                ds.dataset.numericalized_grain_cols,
                ds.y_min,
                ds.y_max
            )
