...
This fork is to add support compatitablity of macOS arm64 by create a fat binary of `libtkdnd2.9.3.dylib` of both arch of arm64 and x64 via `lipo -create` command
