...
from PySide6.QtWidgets import (
    QHBoxLayout, QFrame, QWidget, QLabel, QPushButton,
...
class Toolbar(QFrame):
    ...
    def __init__(self) -> None:
        ...
        self.label_dirpath = Label(f"{self.base_path}", orientation=Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
