...
class MinioHandler:
    ...
    def get_blobs(
            self, bucket_name: str, blob_list: List[str] = None,
            blob_name: str = None, image_extraction: bool = True
            ...
            if blob_list:
                ...
                for blob in tqdm(
                    ...
                    try:
                        ...
                        blobby: np.ndarray | bytes = payload_transform(
