...
class EnterpriseZone(
    ...
    def __init__(
        ...
        *,
        ...
        remote_vpc: typing.Union["RemoteVpc", typing.Dict[str, typing.Any]],
    ) -> None:
        '''
        :param scope: -
        :param id: -
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(remote_vpc, dict):
            remote_vpc = RemoteVpc(**remote_vpc)
        if __debug__:
