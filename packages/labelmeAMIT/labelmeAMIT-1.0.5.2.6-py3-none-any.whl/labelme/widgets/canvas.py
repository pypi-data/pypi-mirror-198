...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, ev):
        ...
        if self.drawing():
            ...
            elif self.createMode == "modifyline":
                self.line.points = [self.current[0], pos]
                self.line.shape_type = "modifyline"
            self.repaint()
            ...
            for s in self.shapes:
                if s.shape_type == "modifyline":
                    ...
                    if r > 0:
                        ...
                        for pt in s.points:
                            try:
                                d = math.sqrt(math.pow((p0.x() - pt.x()),2) + math.pow((p0.y() - pt.y()),2))
                            except TypeError:
                                ...
                                #     if dp.x() == 0:
                                #         if dp.y() > 0:
                                #             pt = pt +  QtCore.QPoint(0, int(dr))
                                #         else:
                                #             pt = pt -  QtCore.QPoint(0, int(dr))
                                #     else:
                                #         degress = math.tan(dp.y()/dp.x())
                                #         pt = pt +  QtCore.QPoint(int(math.sin(degress)*dr), int(math.cos(degress)*dr))
    ...
    # def boundedModifyShapes(self, shape, shapes, pos):
    #     if self.outOfPixmap(pos):
    #         return False  # No need to move
    #     o1 = pos + self.offsets[0]
    #     if self.outOfPixmap(o1):
