        ...
        for col in range(0, self.n_targets_):
            try:
                ...
                if ('arima' == self.algorithm.lower() or
                    ...
                    exc = None # Exception from last update call
                    while (not model_initialized) and itr < 5:
                        ...
                        try:
                            ...
                            exc = e
                    # Only throw exception if the model cannot be trained at all, individual exceptions should be ignored
                    #This is specific to ARIMA as there were exceptions from Java code
                    if not self.model[col].is_initialized():
                        logger.warning("Failed to train/update Model.", exc)
