...
e.g., in case of fill interpolator it is filled with default_value.""",
                ...
                "imputer_fill_type": {
                    "description": "Categories of 'Fill' imputer.",
                    "enum": ["value", "median", "mean"],
                    "default": "value",
                },
                "imputer_fill_value": {
                    "description": """A single numeric value to be filled for all missings. 
ONLY works when 'imputer_fill_type' is specified as 'value', will be ignored if 'mean' or 'median' is specified for 'imputer_fill_type'.""",
                    "anyOf": [
                        {"type": "number"},
                        {
                            "type": "integer"
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale-autoai.readthedocs.io/en/latest/modules/lale_autoai.autoai_ts_libs.fill.html",
