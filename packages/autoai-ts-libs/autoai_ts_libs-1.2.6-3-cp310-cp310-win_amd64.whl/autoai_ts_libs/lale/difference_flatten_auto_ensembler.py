    ...
    "allOf": [
        {
            ...
            "properties": {
                ...
                "execution_time_per_pipeline": {
                    "description": "Maximum execution time per pipeline allowed.",
                    "type": "integer",
                    "default": 1,
                },
                "dag_granularity": {
                    "description": "Granularity for execution.",
                    "enum": [
                        "default",
                        "tiny",
                        "flat",
                ...
                "execution_platform": {
                    "description": "Platform for execution from srom pipeline.",
                    "enum": [
                ...
                "multistep_prediction_win": {
                    "description": "Multistep prediction window.",
                    "type": "integer",
                    "default": 1,
                },
                "ensemble_type": {
                ...
                "multivariate_column_encoding": {
                    "description": "Enable multivariate column encoding.",
                    "type": "boolean",
                    "default": False,
                },
                "store_lookback_history": {
                ...
                "look_ahead_fcolumns": {
                    "description": "Columns to be used for future exogenous feature transformations.",
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale-autoai.readthedocs.io/en/latest/modules/lale_autoai.autoai_ts_libs.difference_flatten_auto_ensembler.html",
