...
class MultiTimeSeriesWriter:
    ...
    def encode_key(self, key_encoder):
        """
        set function to encode a value to a string when writing
        ...
        Returns
        -------
        :class:`~autoai_ts_libs.deps.tspy.io.MultiTimeSeriesWriter.MultiTimeSeriesWriter`
            this multi-time-series-writer
        """
        self._j_time_series_writer.encodeKey(self._tsc.java_bridge.java_implementations.UnaryMapFunction(self._tsc, key_encoder))
        return self

    def option(self, key, value):
        """
        set an option for this multi-time-series-writer
    ...
    def options(self, **kwargs):
        """
        set multiple options for this multi-time-series-writer
    ...
    def save(self, multi_time_series_write_format):
        """
        save to a user-defined multi-time-series-write-format

        Parameters
        ----------
        multi_time_series_write_format : :class:`~autoai_ts_libs.deps.tspy.io.MultiTimeSeriesWriteFormat.MultiTimeSeriesWriteFormat`
            the multi-time-series write format
        """
        self._j_time_series_writer.save(self._tsc.java_bridge.java_implementations.JavaMultiTimeSeriesWriteFormat(multi_time_series_write_format))
