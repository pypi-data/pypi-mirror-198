...
if __name__ == '__main__':
    ...
    if option == 1:
        # No proxy
        profile = LGS_util.profile.ChromeProfile('glanmum12@gmail.com','q2R1EcNi4','grahamma057449@hotmail.com')
        ...
        profile = LGS_util.profile.ChromeProfile('krinxng@gmail.com','9docVqRsOqaIVB8LdMi3kHuDi','careyshe441470@hotmail.com',
                                                 'private',
                                                 None,
