...
# package_name relative_dir_path config_file_name
package_path_file_tuples=(
    # Note: a project integrating `argrelay` must provide its own set of
    #       customized `argrelay` config files instead (from its own package).

    # For example (see `deploy_config_files.bash` from `argrelay` repo):
    # project_package argrelay.conf.d argrelay.server.yaml
    # project_package argrelay.conf.d argrelay.client.json
)
########################################################################################################################
