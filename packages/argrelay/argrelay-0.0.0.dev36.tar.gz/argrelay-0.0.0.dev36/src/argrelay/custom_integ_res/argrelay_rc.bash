...
test -f "${argrelay_conf_base_dir}/.argrelay.conf.d/argrelay.server.yaml" || return 1
test -f "${argrelay_conf_base_dir}/.argrelay.conf.d/argrelay.client.json" || return 1
