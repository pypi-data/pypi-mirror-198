...
"""
This is a sister script to the following:

              object_detection_and_localization.py

While the above script used nn.MSELoss for regression, the current script is
based on using variants of the IoU Loss for the same.  These variants are 
explained on Slides 37 through 42 of my Week 7 presentation on object 
detection and localization.

This script also uses the PurdueShapes5 dataset for training and testing.
"""
