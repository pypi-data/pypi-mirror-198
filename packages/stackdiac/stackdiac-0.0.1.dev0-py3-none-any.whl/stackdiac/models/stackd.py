...
class Stackd(BaseModel):
    ...
    def __init__(self, **data: Any) -> None:
        ...
        self.conf.binaries.terraform.stackd = self
        self.conf.binaries.terragrunt.stackd = self
    ...
    def plan(self, target, **kwargs):
        ...
        cmd = f"{self.conf.binaries.terragrunt.abspath} plan"
        logger.debug(f"{self} plan {target} {cmd} {env}")
