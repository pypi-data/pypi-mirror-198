...
from alvin_integration.producers.dbt.patch.functions import (
    after_run,
    before_run,
    execute,
)
from alvin_integration.producers.dbt.patch.functions_144 import execute as execute_144
from alvin_integration.producers.dbt.patch.functions_145 import get_response
from alvin_integration.producers.dbt.patch.functions_legacy import (
    before_run as before_run_legacy,
)
from alvin_integration.producers.dbt.patch.functions_legacy import (
    ...
    def get_patching_list(self):
        return [
            ...
            AlvinPatch(
                package_name="dbt-core",
                function=before_run,
                supported_versions=["1.2.0", "1.2.1", "1.2.2", "1.4.4"],
                destination_path="dbt.task.run.RunTask",
            ),
            AlvinPatch(
                package_name="dbt-core",
            ...
            AlvinPatch(
                ...
                supported_versions=["1.4.4", "1.4.5"],
                destination_path="dbt.adapters.spark.connections.SparkConnectionManager",
            ),
        ]
