...
@instruction
def chat_by_gpt(who, api_key,model_engine="text-davinci-002", max_tokens=1024, n=1, stop=None, temperature=0.5, top_p=1,
    ...
    while True:
        try:
            ...
            if (friend_name == who) & (receive_msg != temp_msg):
                ...
                print(receive_msg)
                temp_msg = receive_msg
                reply_msg = poai.chatgpt.chat(api_key=api_key, prompt=receive_msg)
