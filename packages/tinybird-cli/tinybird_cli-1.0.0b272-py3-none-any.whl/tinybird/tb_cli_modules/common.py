...
from tinybird.tb_cli_modules.exceptions import CLIAuthException, CLIException
  ...
  variable to '1' or 'true'.""")
    ...
    def __call__(self, *args, **kwargs) -> None:
        ...
        try:
            ...
            error_msg = FeedbackManager.error_exception(error=exc)
            error_event = 'auth_error'
        except SystemExit:
            pass
...
async def folder_pull(client, folder, auto, match, tag, force, verbose=True):  # noqa: C901
    ...
    try:
        ...
        raise CLIException(FeedbackManager.error_pull(error=str(e)))
