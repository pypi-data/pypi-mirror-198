...
class MainWord():
    ...
    def docx2pdf(self, path, output_path, docxSuffix=".docx", pdfSuffix='.pdf'):
        ...
        for i, docx_file in enumerate(waiting_covert_docx_files):
            ...
            self.createpdf(word_app, str(abs_single_docx_path), str(pdfPath))

    def createpdf(self, word_app, wordPath, pdfPath):
