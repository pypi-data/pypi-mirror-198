...
class DocumentSorting(sgqlc.types.Enum):
    __schema__ = api_schema
    __choices__ = ('countChildDocs', 'countConcepts', 'countDisambiguatedEntities', 'countEntities', 'countEvents', 'countLinks', 'countNamedEntities', 'countObjects', 'countPropertyCandidates', 'countResearchMaps', 'countTasks', 'id', 'publicationDate', 'registrationDate', 'relevancy', 'score', 'secretLevel', 'text', 'title', 'trustLevel', 'updateDate')
...
class PostSorting(sgqlc.types.Input):
    __schema__ = api_schema
    __field_names__ = ('nercs', 'facts', 'props', 'approved_props', 'meaning_props', 'query_mul', 'nerc_search', 'research_map', 'concept')
    nercs = sgqlc.types.Field(Int, graphql_name='nercs')
    facts = sgqlc.types.Field(Int, graphql_name='facts')
    props = sgqlc.types.Field(Int, graphql_name='props')
    approved_props = sgqlc.types.Field(Int, graphql_name='approvedProps')
    meaning_props = sgqlc.types.Field(Int, graphql_name='meaningProps')
    query_mul = sgqlc.types.Field(Int, graphql_name='queryMul')
    nerc_search = sgqlc.types.Field(Int, graphql_name='nercSearch')
    research_map = sgqlc.types.Field('PostSortingMetric', graphql_name='researchMap')
    concept = sgqlc.types.Field('PostSortingMetric', graphql_name='concept')


class PostSortingMetric(sgqlc.types.Input):
    __schema__ = api_schema
    __field_names__ = ('id', 'nerc_mul', 'fact_mul', 'props_mul', 'approved_props_mul', 'meaning_props_mul', 'nerc_search_mul')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    nerc_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='nercMul')
    fact_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='factMul')
    props_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='propsMul')
    approved_props_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='approvedPropsMul')
    meaning_props_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='meaningPropsMul')
    nerc_search_mul = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='nercSearchMul')
...
class Query(sgqlc.types.Type):
    ...
    pagination_story = sgqlc.types.Field(sgqlc.types.non_null('StoryPagination'), graphql_name='paginationStory', args=sgqlc.types.ArgDict((
        ...
        ('post_sorting', sgqlc.types.Arg(PostSorting, graphql_name='postSorting', default=None)),
))
    )
