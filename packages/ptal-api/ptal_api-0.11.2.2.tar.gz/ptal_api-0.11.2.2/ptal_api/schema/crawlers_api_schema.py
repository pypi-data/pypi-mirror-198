...
class PaginationCrawlState(sgqlc.types.Type):
    __schema__ = crawlers_api_schema
...
class Query(sgqlc.types.Type):
    ...
    pagination_crawl_state = sgqlc.types.Field(sgqlc.types.non_null(PaginationCrawlState), graphql_name='paginationCrawlState', args=sgqlc.types.ArgDict((
        ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=20)),
        ('offset', sgqlc.types.Arg(Int, graphql_name='offset', default=0)),
