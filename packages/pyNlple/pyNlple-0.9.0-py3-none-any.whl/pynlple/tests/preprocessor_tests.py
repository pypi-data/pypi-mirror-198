...
class TokenizerTest(unittest.TestCase):
    ...
    def test_should_replace_atref_single(self):
        replacement = '<tag>'
        input_string = 'this text @will be tested'
        tokenizer = AtReferenceReplacer(replace_tag_with=replacement)
        expected = 'this text ' + replacement + ' be tested'
        result = tokenizer.preprocess(input_string)
        self.assertEqual(expected, result)

    def test_should_replace_atref_multiple(self):
        replacement = '<tag>'
        input_string = 'this text @will @will @will be tested'
        tokenizer = AtReferenceReplacer(replace_tag_with=replacement)
        expected = 'this text ' + replacement + '' + replacement + '' +replacement + '' +  ' be tested'
        result = tokenizer.preprocess(input_string)
        self.assertEqual(expected, result)
