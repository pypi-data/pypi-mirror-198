...
:LastEditTime: 2023-03-22 16:47:04
...
class RedisHelper:
    @classmethod
    def redis_init(self, host="", port=0, db=0, username=None, password=None, config_dict=None, decode_responses=False, ssl=False, ssl_cert_reqs=None, ssl_ca_certs=None):
        """
