    ...
    for f_msh in fn_msh:
        ...
        if S.map_to_surf and mid2roi is not False:
            try:
                ...
                roi = pynibs.load_roi_surface_obj_from_hdf5(fname=os.path.join(subject.subject_folder,
                                                                               'mesh',
                                                                               str(mesh_idx),
                                                                               subject.mesh[mesh_idx]["fn_mesh_hdf5"]))
...
def msh2hdf5(fn_msh=None, skip_roi=False, skip_layer=True, include_data=False,
    ...
    subject : Subject object, optional
        Subject object
    mesh_idx : int or list of int, optional
