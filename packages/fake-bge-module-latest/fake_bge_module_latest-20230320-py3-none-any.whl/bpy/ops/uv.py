...
def align_rotation(method: typing.Union[str, int] = 'AUTO',
...
def cylinder_project(direction: typing.Union[str, int] = 'VIEW_ON_EQUATOR',
                     ...
                     pole: typing.Union[str, int] = 'PINCH',
                     seam: bool = False,
                     radius: float = 1.0,
                     correct_aspect: bool = True,
                     clip_to_bounds: bool = False,
    ...
    :type pole: typing.Union[str, int]
...
def pack_islands(udim_source: typing.Union[str, int] = 'CLOSEST_UDIM',
                 rotate: bool = True,
                 margin_method: typing.Union[str, int] = 'SCALED',
                 margin: float = 0.001):
    ...
    :type margin_method: typing.Union[str, int]
...
def select_similar(type: typing.Union[str, int] = 'PIN',
