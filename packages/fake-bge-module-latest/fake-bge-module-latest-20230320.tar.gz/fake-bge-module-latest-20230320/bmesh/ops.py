...
def beautify_fill(bm: 'bmesh.types.BMesh',
                  ...
                  method: typing.Union[str, int] = 'AREA') -> dict:
...
def bevel(bm: 'bmesh.types.BMesh',
          ...
          vmesh_method: typing.Union[str, int] = 'ADJ') -> dict:
...
def connect_verts(bm: 'bmesh.types.BMesh',
                  ...
                  check_degenerate: bool = False) -> dict:
    ''' Connect Verts. Split faces by adding edges that connect **verts**.
...
def create_vert(
        bm: 'bmesh.types.BMesh',
        co: typing.List['mathutils.Vector'] = 'mathutils.Vector()') -> dict:
...
def grid_fill(bm: 'bmesh.types.BMesh',
              ...
              mat_nr: int = 0,
              use_smooth: bool = False,
              use_interp_simple: bool = False) -> dict:
...
def inset_individual(bm: 'bmesh.types.BMesh',
                     ...
                     use_relative_offset: bool = False) -> dict:
...
def join_triangles(bm: 'bmesh.types.BMesh',
                   ...
                   angle_shape_threshold: float = 0) -> dict:
...
def offset_edgeloops(bm: 'bmesh.types.BMesh',
                     edges: typing.List['bmesh.types.BMEdge'] = [],
                     use_cap_endpoint: bool = False) -> dict:
...
def pointmerge(
        bm: 'bmesh.types.BMesh',
        verts: typing.List['bmesh.types.BMVert'] = [],
        merge_co: typing.List['mathutils.Vector'] = 'mathutils.Vector()'):
...
def scale(bm: 'bmesh.types.BMesh',
          vec: typing.List['mathutils.Vector'] = 'mathutils.Vector()',
          space: 'mathutils.Matrix' = 'mathutils.Matrix.Identity(4)',
          verts: typing.List['bmesh.types.BMVert'] = [],
          use_shapekey: bool = False):
...
def subdivide_edgering(bm: 'bmesh.types.BMesh',
                       ...
                       profile_shape_factor: float = 0) -> dict:
...
def subdivide_edges(bm: 'bmesh.types.BMesh',
                    ...
                    use_smooth_even: bool = False) -> dict:
...
def triangle_fill(
        ...
        edges: typing.List['bmesh.types.BMEdge'] = [],
        normal: typing.List['mathutils.Vector'] = 'mathutils.Vector()'
) -> dict:
...
def triangulate(bm: 'bmesh.types.BMesh',
                ...
                ngon_method: typing.Union[str, int] = 'BEAUTY') -> dict:
    ''' Triangulate.
