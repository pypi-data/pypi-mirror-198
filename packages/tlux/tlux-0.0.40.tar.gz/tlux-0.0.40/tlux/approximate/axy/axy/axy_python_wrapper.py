...
_ordered_dependencies = ['libopenblas.dylib', 'liblapack.dylib', 'libomp.dylib', 'random.f90', 'matrix_operations.f90', 'sort_and_select.f90', 'axy.f90', 'axy_c_wrapper.f90']
_symbol_files = ['libopenblas.dylib', 'liblapack.dylib', 'libomp.dylib']# 
# --------------------------------------------------------------------
#               AUTO-COMPILING
#
