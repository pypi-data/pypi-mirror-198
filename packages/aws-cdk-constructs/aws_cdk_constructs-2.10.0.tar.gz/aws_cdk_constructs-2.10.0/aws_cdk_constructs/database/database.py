...
class Database(Construct):
    ...
    @staticmethod
    def get_engine(database_engine: str, database_engine_version: str) -> Union[_rds.DatabaseClusterEngine, _rds.DatabaseInstanceEngine]:
    ...
    def render_widgets(self) -> None:
        ...
        if self._cluster:
            self.dashboard.add_widgets(
                _cloudwatch.TextWidget(markdown=f"# {self._id} {path}", width=24),
