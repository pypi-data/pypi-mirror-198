...
@custom_tool(
    name = "Calculator",
    description = "A calculator. Usefull for when you have a math problem to solve. Input should be the python codes to be executed. The codes should be COMPLETE with necessary modules included. The answer should be printed to the console using print(). "
)
