...
class BaseStatement(BaseModel):
    ...
    __properties = ["account_id", "due_date", "end_date", "id", "issue_date", "start_date", "account_summary", "authorized_signer", "closing_balance", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "transactions", "transactions_omitted"]
