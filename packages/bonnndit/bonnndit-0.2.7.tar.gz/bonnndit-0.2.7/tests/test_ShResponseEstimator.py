...
from bonnndit import ShResponseEstimator, ShResponse
from bonnndit.utils.io import fsl_vectors_to_worldspace, fsl_gtab_to_worldspace
...
wm_mask = bonnndit.models.shoredeconv.fa_guided_mask(wm_mask, dti_fa, dti_mask,
                                                    fa_lower_thresh=0.7)
