...
"""Tests for `bonnndit.shore.mtShoreModel` class."""
...
from bonnndit import ShoreMultiTissueResponseEstimator, ShoreMultiTissueResponse
from bonnndit.utils.io import fsl_gtab_to_worldspace, fsl_vectors_to_worldspace
from bonnndit.deconv.shoredeconv import fa_guided_mask
...
def test_ShoreModel_signal_csf():
    ...
    The result calculated with bonnndit are compared to results from the old code
    """
