...
from transformers import BertTokenizer, BertModel, T5Tokenizer, T5Model, AutoTokenizer, AutoModelForCausalLM, GPT2Tokenizer, GPT2Model
...
def create_few_shot_model(params):
    """
...
def run_experiment_fewshot(params=None, offline=False, validate=True, splits=None):
    ...
    promptModel, WrapperClass, tokenizer, promptTemplate = create_few_shot_model(params)
