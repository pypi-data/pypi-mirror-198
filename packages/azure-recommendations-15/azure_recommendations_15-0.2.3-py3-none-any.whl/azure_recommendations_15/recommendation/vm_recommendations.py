...
from azure_recommendations_15.recommendation.utils import get_rg_name

import logging

from azure_recommendations_15.recommendation import utils
...
class vm_recommendations:
    ...
    def disable_premium_ssd(self, vm_list: dict) -> list:
        ...
        def get_cost_data(loc: str, product_name: str, sku_name: str):
