...
@overload
def res(text: str, *patterns: str, return_first: Literal[True] = ...) -> Optional[Union[str, Tuple[Optional[str], ...]]]: ...

@overload
def res(text: str, *patterns: str, return_first: Literal[False] = ...) -> List[Optional[Union[str, Tuple[Optional[str], ...]]]]: ...
