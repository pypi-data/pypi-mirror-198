...
@overload
def runtime(func: Callable, *args: Any, _ret_report: Literal[False] = ..., **kwargs: Any) -> Any: ...

@overload
def runtime(func: Callable, *args: Any, _ret_report: Literal[True] = ..., **kwargs: Any) -> Union[Any, Tuple[Any, str]]: ...
...
@overload
def start_thread(func: Callable, *args: Any, _daemon: bool = ..., **kwargs: Any) -> Thread: ...
