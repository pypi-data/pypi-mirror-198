...
from .rbasic import check_param, is_number_str
...
def str_to_time(
    string: Union[str, Any],
    to_type: Literal["date"] = ...,
    format_str: Optional[str] = ...,
    throw_error: bool = ...
) -> Union[datetime.date, Any]: ...

@overload
def str_to_time(
    string: Union[str, Any],
    to_type: Literal["time"] = ...,
    format_str: Optional[str] = ...,
    throw_error: bool = ...
) -> Union[datetime.time, Any]: ...

@overload
def str_to_time(
    string: Union[str, Any],
    to_type: Literal["timedelta"] = ...,
    format_str: Optional[str] = ...,
    throw_error: bool = ...
) -> Union[datetime.timedelta, Any]: ...

@overload
def str_to_time(
    string: Union[str, Any],
    to_type: Literal["timestamp"] = ...,
    format_str: Optional[str] = ...,
    throw_error: bool = ...
) -> Union[int, Any]: ...
...
def str_to_time(
    ...
    format_str: Optional[str] = ...,
    throw_error: bool = ...
) -> Union[datetime.datetime, datetime.date, datetime.time, datetime.timedelta, Any]: ...
...
def is_sql_time(
    ...
    return_datatime: Literal[False] = ...
) -> bool: ...

@overload
def is_sql_time(
    content: Union[str, int],
    return_datatime: Literal[True] = ...
) -> datetime.datetime: ...
