...
Argument handling for the 'pipelines' subcommand option '--execute-pipeline'
"""
...
def run(
    ...
    try:
        ...
        message = f"An exception occurred while executing pipeline {name} in project {project}."
        log.error(message)
        log.error(err)
        return False
