...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, email, email_verified, api_key, preferred_username, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, email, email_verified, api_key, preferred_username, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI
