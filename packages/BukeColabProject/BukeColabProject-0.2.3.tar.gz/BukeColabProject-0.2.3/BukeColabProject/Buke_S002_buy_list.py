...
from BukePypiProjectVersion2.indicator import sma, ibs, pivot_standard, stochastic_fast_d, stochastic_fast_k
from BukePypiProjectVersion2.function import rank
from BukePypiProjectVersion2.parameter import Market, MovingAverage
from BukePypiProjectVersion2.tools import get_ask_price
...
def add_indicator(day_price: DataFrame, index_day_price: DataFrame) -> DataFrame:
    ...
    for key, group in grouped:
        ...
        liquidity_condition1 = group['거래대금_이평선_5_순위'] > 0.8
...
def Buke_S002_buy_list(dir, day):
