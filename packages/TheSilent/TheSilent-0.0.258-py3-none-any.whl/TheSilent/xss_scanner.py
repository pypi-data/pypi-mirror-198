...
def xss_scanner(url, secure = True, tor = False, crawl = "0", my_file = " ", parse = " ", delay = 1):
    mal_scripts = ["<p>The Silent</p>", "\\<p>The Silent</p>\\", "<div>The Silent</div>", "\\<div>The Silent</div>\\", "<iframe>The Silent</iframe>", "\\<iframe>The Silent</iframe>\\", "<script>alert('The Silent')</script>", "\\<script>alert('The Silent')</script>\\", "<script>prompt('The Silent')</script>", "\\<script>prompt('The Silent')</script>\\"]
    ...
    for links in my_result:
        ...
        print(cyan + "checking: " + str(links) + " (cookies)")  
