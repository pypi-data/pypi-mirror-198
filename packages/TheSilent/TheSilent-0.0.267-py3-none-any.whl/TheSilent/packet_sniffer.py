        ...
        try:
            ...
            if protocol == " ":
                if source == ip or destination == ip:
                    ...
                    if proto == "UDP":
                        print(cyan + "checksum (ip): " + checksum + " | checksum (protocol): " + str(checksum_protocol_udp))

                    if proto == "TCP":
                        print(cyan + "checksum (ip): " + checksum + " | checksum (protocol): " + str(checksum_protocol_tcp))
