...
def xss_scanner(url, secure = True, tor = False, crawl = "0", my_file = " ", parse = " ", delay = 1):
    mal_scripts = ["<div>The Silent</div>", "<iframe>The Silent</iframe>", "<p>The Silent</p>", "<script>alert('The Silent')</script>", "<script>prompt('The Silent')</script>", "<strong>The Silent</strong>"]
                ...
                for i in form_input:
                    for mal_script in mal_payloads:
                        ...
                        if name[0] in activity:
                            ...
                            if action[0] != "":
                                if links.endswith("/") and action[0] != links + "/" or action[0] != links:
