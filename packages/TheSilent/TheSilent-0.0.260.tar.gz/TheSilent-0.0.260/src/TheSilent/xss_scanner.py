...
def xss_scanner(url, secure = True, tor = False, crawl = "0", my_file = " ", parse = " ", delay = 1):
    mal_scripts = ["The Silent", "<div>The Silent</div>", "<iframe>The Silent</iframe>", "<p>The Silent</p>", "<script>alert('The Silent')</script>", "<script>prompt('The Silent')</script>", "<strong>The Silent</strong>"]
