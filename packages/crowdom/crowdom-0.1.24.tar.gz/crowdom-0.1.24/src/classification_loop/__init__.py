...
class ClassificationLoop:
    ...
    params: Params
    lang: str
    interrupter: Optional[utils.LaunchInterrupter]
    ...
    def __init__(
        ...
        params: Params,
        lang: str,
        interrupter: Optional[utils.LaunchInterrupter] = None,
    ...
    def loop(self, pool_id: str):
        ...
        while True:
            ...
            utils.wait_pool_for_close(self.client, pool_id, self.interrupter)
...
class MOSLoop(ClassificationLoop):
    def __init__(
        ...
        super().__init__(client, task_mapping, params, lang, interrupter, with_control_tasks, model)
