...
if system() == 'Darwin':
    ...
    extra_link_args.append('libs\\win\\libsaxon-eec-12.1.lib')
else:
...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-eec-12.1']
                        ),
                ]
setup(
    name='saxoncee',
    version='12.1.0',
    description='Official Saxonica python package for the SaxonC-EE 12.1 processor: for XSLT 3.0, XQuery 3.1, XPath 3.1 and XML Schema processing.',
