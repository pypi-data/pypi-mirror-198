...
from copper_rabbit.settings.globe import base as _base,Response as globe_response
...
class Result:
    ...
    def maintenance(self)->Response:
        ...
        self.response.headers.add("Retry-After",_sc.retry_after_duration)
        self.response.data = self.json
        return self.response
