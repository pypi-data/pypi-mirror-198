...
class Coordinates(object):
    ...
    def __eq__(self, other) -> bool:
        ...
        if isinstance(other, Coordinates):
            return (math.isclose(self.point.x, other.point.x) and
                    math.isclose(self.point.y, other.point.y) and
                    math.isclose(self.point.z, other.point.z))
...
def lla_to_xyz(longitude_deg, latitude_deg, height_m, a=WGS84_A, e=WGS84_E) -> XYZ:
    """
...
class Dop(object):
    ...
    def __init__(self, el_az_list: typing.List[ElAz]) -> None:
