...
class StringType(Type):
    ...
    def get_source_str(self) -> str:
        return "string {self.default_location().value}"
...
class PackedBytes(Type):
    ...
    def get_source_str(self) -> str:
        return "bytes {self.default_location().value}"
...
class EnumType(UserDefinedType):
    ...
    def get_source_str(self) -> str:
        return self.type_string  # no clue if this is right
...
class StructType(UserDefinedType):
    ...
    def get_source_str(self) -> str:
        return f"{self.canonical_name} {self.default_location().value}"  # again, flailing here
