...
def init_storage():
    directories = [
        os.path.join(CONFIG["data_path"], "backup"),
        os.path.join(CONFIG["data_path"], "tmp"),
        os.path.join(CONFIG["data_path"], "tmp", "edit"),
        os.path.join(CONFIG["data_path"], "tmp", "delete"),
        os.path.join(CONFIG["data_path"], "tmp", "export"),
    ]
