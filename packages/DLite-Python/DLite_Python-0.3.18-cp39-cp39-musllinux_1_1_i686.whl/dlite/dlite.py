...
class Property(object):
    ...
    def __init__(self, name, type, dims=None, unit=None, description=None):
        r"""
...
class Instance(object):
    ...
    def tojson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False):
        r"""
        tojson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False) -> char *
        Returns a JSON representation of self.
        """
        return _dlite.Instance_tojson(self, indent, single, urikey, with_uuid, with_meta, with_arrays, no_parent)
