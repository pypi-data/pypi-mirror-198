#!/usr/bin/env python3
"""
This file provides image matching.
"""
...
from dogtail.rawinput import click  # pylint: disable=import-error
...
def image_match(context, needle, threshold=0.8) -> None:
    """
...
class Matcher:
    ...
    def assert_match(self, needle, threshold=0.8, capture=True) -> None:
        """
    ...
    def match(self, needle, threshold=0.8, capture=True) -> bool:
        """
