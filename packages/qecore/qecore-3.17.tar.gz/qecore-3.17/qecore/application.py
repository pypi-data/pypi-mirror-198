...
class Application:
    ...
    def get_desktop_file_data(self) -> None:
        ...
        log.debug(f"{self.component} get_desktop_file_data(self)")
        ...
        if self.desktop_file_exists:
            if self.desktop_file_path:
                log.debug(
                    " ".join(
                        (
                            "get_desktop_file_data: loading user provided .desktop file:",
                ...
                log.debug(
                    f"get_desktop_file_data: .desktop file found: '{desktop_file}'"
                )
    ...
    def start_via_menu(self, kill=None) -> None:
        ...
        log.debug(f"{self.component} start_via_menu(self)")
    ...
    def close_via_shortcut(self) -> None:
        ...
        log.debug(f"{self.component} close_via_shortcut(self)")
    ...
    def already_running(self) -> None:
        ...
        log.debug(f"{self.component} already_running(self)")
    ...
    def get_root(self) -> gi_repository_Atspi_Accessible:
        ...
        log.debug(f"{self.component} get_root(self) search by '{self.a11y_app_name}'")

        # Importing here for issue with accessibility if the connection is not ready yet.
    ...
    def is_running(self) -> bool:
        ...
        log.debug(f"{self.component} is_running(self)")
    ...
    def get_pid_list(self) -> str:
        ...
        .. note::
            ...
            Do **NOT** call this by yourself.
            This method is called by :func:`get_all_kill_candidates` when stopping the application.
        """

        log.debug(f"{self.component} get_pid_list(self)")
    ...
    def get_all_kill_candidates(self) -> list:
        ...
        .. note::
            ...
            Do **NOT** call this by yourself.
            This method is called by :func:`kill_application` when stopping the application.
        ...
        log.debug(f"{self.component} get_all_kill_candidates(self)")
        ...
        for process in application_pid_list:
            if not (
                ...
                or (process == "/usr/bin/gnome-shell")
            ):
    ...
    def kill_application(self) -> None:
        ...
        log.debug(f"{self.component} kill(self)")
