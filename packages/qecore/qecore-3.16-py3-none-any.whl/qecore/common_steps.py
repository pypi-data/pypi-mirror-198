#!/usr/bin/env python3
"""
Common steps part with definition of precoded decorator steps for behave usage.
"""
...
def node_not_attribute(context, retry=True, expect_positive=False, **kwargs) -> None:
    """
...
def absolutie_motion(context, position_x, position_y) -> None:  # pylint: disable=unused-argument
    """
