...
from practicuscore.api_base import ConnConf, NodeFileConnConf, SqLiteConnConf, S3ConnConf, MYSQLConnConf, \
    PostgreSQLConnConf, RedshiftConnConf, SnowflakeConnConf, MSSQLConnConf, OracleConnConf, HiveHadoopConnConf, \
    AthenaConnConf, ElasticSearchConnConf, AWSElasticSearchConnConf, CustomDBConnConf
