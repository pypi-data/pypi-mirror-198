...
class ConfigManager:
    ...
    def format_toml(self, toml_data: Dict = None):
        ...
        for group, keys in toml_data.items():
            ...
            for key, value in keys.items():
                ...
                if encrypted:
                    formatted_toml.append("\tencrypted = true")
    ...
    def get(self, group: str, item: str, *, default_return=KeyError) -> Any:
        ...
        return self.config[group][item]["value"]
    ...
    def add_new_config(  # pylint:disable=too-many-arguments
        self,
        group_name: str,
        key_name: str,
        ...
        self._configs[group_name][key_name] = {
            "value": value,
            "encrypted": encrypted,
        }
