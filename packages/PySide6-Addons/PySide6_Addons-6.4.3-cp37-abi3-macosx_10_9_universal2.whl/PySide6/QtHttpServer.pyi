...
class QAbstractHttpServer(PySide6.QtCore.QObject):
    ...
    def handleRequest(self, request: PySide6.QtHttpServer.QHttpServerRequest, socket: PySide6.QtNetwork.QTcpSocket) -> bool: ...
    def listen(self, address: Union[PySide6.QtNetwork.QHostAddress, PySide6.QtNetwork.QHostAddress.SpecialAddress] = ..., port: int = ...) -> int: ...
    @staticmethod
    def makeResponder(request: PySide6.QtHttpServer.QHttpServerRequest, socket: PySide6.QtNetwork.QTcpSocket) -> PySide6.QtHttpServer.QHttpServerResponder: ...
    def missingHandler(self, request: PySide6.QtHttpServer.QHttpServerRequest, socket: PySide6.QtNetwork.QTcpSocket) -> None: ...
...
class QHttpServerResponder(Shiboken.Object):
    ...
    def socket(self) -> PySide6.QtNetwork.QTcpSocket: ...
    @overload
...
class QHttpServerRouterRule(Shiboken.Object):
    def exec(self, request: PySide6.QtHttpServer.QHttpServerRequest, socket: PySide6.QtNetwork.QTcpSocket) -> bool: ...
