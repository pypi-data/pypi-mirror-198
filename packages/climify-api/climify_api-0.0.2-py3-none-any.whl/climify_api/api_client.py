...
from climify_api.REST import RESTClient
from climify_api.auth import AuthService, IAuthService
from climify_api.configuration import Configuration
from climify_api.exceptions import ApiTypeError, ApiValueError
from climify_api.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __call_api(
        ...
        # request url
        if host is None:
            url = f"{self.configuration.host}/{self.api_version}/{resource_path}"
        else:
            # use server/host defined in path or operation instead
            url = f"{host}/{self.api_version}/{resource_path}"
    ...
    def update_params_for_auth(self, headers: typing.Optional[HTTPHeaderDict]):
        """Adds authorization token header using the IAuthService instance provided in the constructor.

        :param headers: Header parameters dict to be updated.
        """
        headers.add(
            'authorization', f'Bearer {self._auth_service.get_access_token()}'
        )
