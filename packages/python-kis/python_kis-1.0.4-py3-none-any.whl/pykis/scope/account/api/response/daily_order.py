...
INQR_DVSN_3_CODES_TYPE = Literal['전체', '현금', '융자', '대출', '대주', '00', '01', '02', '03', '04']
...
class KisStockDailyOrder(KisDynamic):
    ...
    '''대출일자'''
    ord_dvsn_cd: Literal['00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16']
    '''주문구분코드'''
    cncl_cfrm_qty: int
    '''취소확인수량'''
    rmn_qty: int
    ...
    excg_dvsn_cd: Literal['01', '02', '03', '04', '05', '06', '07', '21', '51', '52', '53', '54', '55', '56', '57', '58', '59', '61', '64', '65', '81']
    ...
    def order(self) -> KisStockOrderBase:
        '''주문'''
        return KisStockOrderBase(self.ord_gno_brno, self.odno)
