...
def scale_numerical_column(data, numerical_column: str):
    """
...
def bin_values_of_numerical_column(data, numerical_col: str, number_bins: int):
    """
...
def min_max_scaling_to_numerical_column(data, numerical_column: str):
    """
    scale the values of a numeric column so that they have a minimum value of 0
    and a maximum value of 1
    :param data: variable
