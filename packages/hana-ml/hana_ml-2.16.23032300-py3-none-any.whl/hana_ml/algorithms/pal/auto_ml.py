...
class _AutoMLBase(PALBase):
    ...
    def __init__(self,
        ...
        self.succesive_halving = self._arg('successive_halving', successive_halving, bool)
    ...
    def fit(self,
        ...
        param_rows = [('SCORINGS', None, None, self.scorings),
                      ...
                      ('SUCCESSIVE_HALVING', 0 if ptype=='timeseries' else self.succesive_halving, None, None),
...
class AutomaticClassification(_AutoMLBase):
    ...
    model_ : DataFrame or list of DataFrame
...
class AutomaticTimeSeries(_AutoMLBase):
    ...
    def predict(self, data,#pylint:disable=arguments-differ, arguments-renamed
        ...
        predict_result = super(AutomaticTimeSeries, self).predict(data, key, exog, model)
