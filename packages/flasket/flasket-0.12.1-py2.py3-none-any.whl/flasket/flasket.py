...
from flask_gordon.ext.argparse.defaults import SERVER_LISTEN, SERVER_PORT
from flask_gordon.ext.argparse.defaults import make_config as make_settings
...
class Flasket(
    ...
    def __init__(self, name):
        ...
        self.logger.info("Initializing Flasket application...")
    ...
    def _init_middleware(self, middleware: str = None) -> None:
        if middleware is None or middleware == "flask":
            return
