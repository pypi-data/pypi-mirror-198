...
def recursive_build_pipeline_from_cfg(  cfg, 
    ...
    for trans_cfg in cfg["pipeline"]:
        ...
        if trans_name == "parallelTransformer":         
            ...
            for i, node_name, latest_node, sub_trans_cfg in zip(parallel_dict_index, pre_node_names, latest_nodes, trans_cfg["transformers"]):
                ...
                if "type" in sub_trans_cfg:
                    ...
                    transformer, node_name_set, _node_pairs, node_name, _latest_node, index, parallel_index, nodename2transformer = recursive_build_pipeline_from_cfg( sub_trans_cfg, 
                                                                                                                                                            node_name_set, 
                                                                                                                                                            [], 
                                                                                                                                                            node_name,
                                                                                                                                                            latest_node, 
            ...
            _pipeline, node_name_set, _node_pairs, node_name, latest_node, index, parallel_index, nodename2transformer= recursive_build_pipeline_from_cfg( trans_cfg, 
                                                                                                                                                node_name_set, 
                                                                                                                                                [], 
                                                                                                                                                node_name,
                                                                                                                                                latest_node,
    ...
    return make_pipeline(*steps), node_name_set, node_pairs, node_name, latest_node, index, parallel_index, nodename2transformer
...
class DataPipeline:
    ...
    def __init__(self, cfg):
        ...
        # self.kafka_media = kafka_media
        from .kafka_media import kafkaMedia
        self.kafka_media = kafkaMedia(bootstrap_servers=self._pipeline_settings.bootstrap_servers, topic="pipeline")
        self.kafka_media.__enter__()
        # print(self.kafka_media.producer, "#############################")
