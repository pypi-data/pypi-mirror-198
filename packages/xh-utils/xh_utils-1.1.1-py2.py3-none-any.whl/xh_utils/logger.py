...
class Logger(object):
    ...
    logger = logging.Logger(name=author_name)
    ...
    def init_logger(cls, log_pathdir="", log_filename="", is_split_logfile=False, author_name="xh", level_name="DEBUG"):
        ...
        if "" != log_pathdir:
            ...
            file_handler = _ConcurrentTimedRotatingFileHandler(log_pathdir, log_filename) if is_split_logfile else logging.FileHandler(
                os.path.join(log_pathdir, log_filename), encoding="utf8")
