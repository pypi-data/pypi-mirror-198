...
from djangorm.utils.autoreload import autoreload_started, file_changed
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from djangorm.utils.translation import trans_real as trans
            from djangorm.utils.translation.reloader import (
            ...
            from djangorm.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from djangorm.conf.locale import LANG_INFO
