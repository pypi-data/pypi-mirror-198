...
from djangorm.db.migrations.graph import MigrationGraph
from djangorm.db.migrations.recorder import MigrationRecorder
...
class MigrationLoader:
    ...
    inherit from djangorm.db.migrations.Migration. See
    djangorm.db.migrations.migration for what that looks like.
