...
from djangorm.db import IntegrityError, connections, transaction
from djangorm.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("djangorm.db.models.SET", (value,), {})
