...
from djangorm.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "djangorm.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in djangorm.core.management.color.
