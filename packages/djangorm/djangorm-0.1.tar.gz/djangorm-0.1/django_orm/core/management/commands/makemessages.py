...
from djangorm.core.files.temp import NamedTemporaryFile
from djangorm.core.management.base import BaseCommand, CommandError
from djangorm.core.management.utils import (
    find_command,
    handle_extensions,
    is_ignored_path,
    popen_wrapper,
...
from djangorm.utils.jslex import prepare_js_for_gettext
from djangorm.utils.regex_helper import _lazy_re_compile
from djangorm.utils.text import get_text_list
from djangorm.utils.translation import templatize
...
class Command(BaseCommand):
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        django_dir = os.path.normpath(os.path.join(os.path.dirname(djangorm.__file__)))
        if self.domain == "djangojs":
