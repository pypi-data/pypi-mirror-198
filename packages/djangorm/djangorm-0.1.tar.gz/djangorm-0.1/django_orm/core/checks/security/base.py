...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by djangorm. Please generate a long and random value, "
    f"otherwise many of Django's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'djangorm.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'djangorm.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "djangorm.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "djangorm.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
