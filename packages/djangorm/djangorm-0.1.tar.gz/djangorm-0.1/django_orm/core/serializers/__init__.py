...
from djangorm.core.serializers.base import SerializerDoesNotExist

# Built-in serializers
BUILTIN_SERIALIZERS = {
    "xml": "djangorm.core.serializers.xml_serializer",
    "python": "djangorm.core.serializers.python",
    "json": "djangorm.core.serializers.json",
    "yaml": "djangorm.core.serializers.pyyaml",
    "jsonl": "djangorm.core.serializers.jsonl",
}
