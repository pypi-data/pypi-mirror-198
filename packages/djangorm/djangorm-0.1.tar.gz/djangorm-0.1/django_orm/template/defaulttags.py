...
from djangorm.utils.html import conditional_escape, escape, format_html
from djangorm.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from djangorm.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from djangorm.urls import NoReverseMatch, reverse
