...
from .api_helpers import _build_slot_sequence_name_dict, _build_slot_sequence_name_array
...
class LucoApi:
    ...
    def __get_slot_sequence_id(self, name, is_active=True):
        ...
        name = _build_slot_sequence_name_array(name)
                
        payload = urllib.parse.urlencode({'isActive': is_active,
                                          'SlotSequenceDefinition': name}, doseq=True)
