...
class Seams(object):
    ...
    def __init__(self, 
        ...
        # Remove any trailing slashe, if any
        self.URL = URL.rstrip('/')
    ...
    def connect(self,
        ...
        :param tenant_id:
            An AD tenant ID given by RJLG staff to access the Seams SDK  **REQUIRED**
        :returns:
            None
        '''
        ...
        if ad_auth is None:
            ad_auth = os.getenv("AD_AUTH_MODE")
    ...
    def __seams_api_request(self, 
        ...
        if timeout is True:
            raise TimeoutError("Error: Seams API Timeout")
