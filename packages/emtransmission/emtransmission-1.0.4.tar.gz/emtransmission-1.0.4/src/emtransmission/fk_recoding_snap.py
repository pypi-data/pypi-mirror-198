...
class Fk_viewer(object):
    ...
    def __init__(self,env):
        ...
        self.exe_text = scrolledtext.ScrolledText(master=self.back_g,width=57,height=4) 
        ...
        self.trans_text = scrolledtext.ScrolledText(master=self.back_g,width=57,height=4) 
