...
if platform == "win32":
    from devoud.browser.utils.os.win32_utils import WindowsMoveResize as MoveResize
elif platform == "darwin":
    from devoud.browser.utils.os.mac_utils import MacMoveResize as MoveResize
else:
    from devoud.browser.utils.os.linux_utils import LinuxMoveResize as MoveResize
