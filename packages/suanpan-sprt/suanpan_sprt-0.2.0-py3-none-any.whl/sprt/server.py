    ...
    async def handle_post(data: FunctionParams) -> FunctionResponse:
        ...
        with open(log_path / node_id, 'a', encoding='utf8') as f:
            with redirect_stdout(f), redirect_stderr(f):
                try:
                    print('aaaaaaaaaaaaaaaaaaaaaaaaaa', logging.root)
                    print('aaaaaaaaaaaaaaaaaaaaaaaaaa', logging.root.handlers)
                    print('aaa', sys.stdout, sys.stderr, logging.root.handlers[0].stream)
