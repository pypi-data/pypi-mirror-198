...
"""
from ...conf.rwd.Website import opera_browser_conf
...
class LocalBrowsers():
    ...
    def chrome_local():
        ...
        local_driver = webdriver.Chrome(service=ChromeService(ChromeDriverManager().install()))
    ...
    def opera_local():
        ...
        try:
            ...
            if 'no Opera binary' in str(exception):
                print(
                    "SOLUTION: It looks like you are trying to use Opera Browser. Please update Opera Browser location under conf/opera_browser_conf.\n")
