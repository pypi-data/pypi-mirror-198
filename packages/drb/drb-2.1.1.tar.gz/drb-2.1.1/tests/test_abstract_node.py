...
class TestDrbNode(unittest.TestCase):
    ...
    def test_impl(self):
        ...
        self.assertTrue(self.node.has_impl(io.BufferedReader))
        self.assertEqual([io.BufferedIOBase], self.node.impl_capabilities())
        self.assertEqual(b'', self.node.get_impl(io.BytesIO))
