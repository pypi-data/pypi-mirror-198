        ...
        if recommendations == True:
            ...
            for i in range(len(recommendations_table)):
                ...
                recommendations_table.no_recommend_flag_usage.iloc[i] == 0) == True:
                    ...
                    result = str('You have a recommendation for the following device: ' + recommendations_table.friendly_name.iloc[i] + '\n\nPlease use the device on the ' + date_and_time_show[0:10] + ' at ' + date_and_time_show[11:] + " o'clock because it saves you " + str(price_savings_percentage) + ' % of costs compared to the mean of the day.').replace("\n"," ")
                    ...
                    output_explanation_usage.append(explaination_usage)
                    ...
                    result = 'There is no recommendation for the device ' + recommendations_table.friendly_name.iloc[i] + ' .'
                    output.append(result)

            output_explanation_activity = explaination_activity

            if self.diagnostics == False:
                print('For detailed information switch on the diagnostics parameter.')
                return (output, output_explanation_usage, output_explanation_activity)
