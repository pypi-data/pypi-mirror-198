...
pus.sort_rand(50, 1, 100, 'i', 0.1) # Auto generate an array of size 50 with elements ranging from 1 to 100 and sort it using insertion sort with a speed of 0.1s
```
