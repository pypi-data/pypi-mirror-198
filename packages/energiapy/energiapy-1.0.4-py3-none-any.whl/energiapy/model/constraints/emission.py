...
def constraint_carbon_emission_location(instance: ConcreteModel, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_carbon_emission_location = Constraint(instance.locations, *scales, rule = carbon_emission_location_rule, doc = 'carbon_emission_location_process')
...
def constraint_carbon_emission(instance: ConcreteModel, carbon_bound:float,  network_scale_level:int=0, carbon_reduction_percentage:float = 0.0) -> Constraint:
    ...
    instance.constraint_carbon_emission = Constraint(instance.locations, *scales, rule = carbon_emission_rule, doc = 'carbon_emission_process')
...
def constraint_global_warming_potential_process(instance: ConcreteModel, process_gwp_dict: dict, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_process = Constraint(instance.locations, instance.processes, *scales, rule = global_warming_potential_process_rule, doc= 'global warming potential for the each process' )
...
def constraint_global_warming_potential_material(instance: ConcreteModel, material_gwp_dict: dict, process_material_dict: dict, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_material = Constraint(instance.locations, instance.processes_materials, *scales, rule = global_warming_potential_material_rule, doc= 'global warming potential for the each material' )
...
def constraint_global_warming_potential_resource(instance: ConcreteModel, resource_gwp_dict: dict, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_resource = Constraint(instance.locations, instance.resources_purch, *scales, rule = global_warming_potential_resource_rule, doc= 'global warming potential for the each resource' )
...
def constraint_global_warming_potential_location(instance: ConcreteModel, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_location = Constraint(instance.locations, *scales, rule = global_warming_potential_location_rule, doc= 'global warming potential for the each location' )
...
def constraint_global_warming_potential_network(instance: ConcreteModel, network_scale_level:int=0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_network = Constraint(*scales, rule = global_warming_potential_network_rule, doc= 'global warming potential for the whole network' )
...
def constraint_global_warming_potential_network_reduction(instance: ConcreteModel, network_scale_level:int=0, gwp_reduction_pct:float= 0, gwp:float = 0) -> Constraint:
    ...
    instance.constraint_global_warming_potential_network_reduction = Constraint(*scales, rule = global_warming_potential_network_reduction_rule, doc= 'global warming potential for the whole network' )
