...
def constraint_production_mode(instance: ConcreteModel, mode_dict:dict, scheduling_scale_level: int = 0) -> Constraint:
    ...
    instance.constraint_production_mode = Constraint(instance.locations, instance.processes, *scales, rule=production_mode_rule, doc='production mode sum constraint')
...
def constraint_production_mode_binary(instance: ConcreteModel, mode_dict:dict, scheduling_scale_level: int = 0, network_scale_level: int = 0) -> Constraint:
    ...
    instance.constraint_production_mode_binary = Constraint(instance.locations, instance.processes, *scales, rule=production_mode_binary_rule, doc='production mode binary sum constraint')
