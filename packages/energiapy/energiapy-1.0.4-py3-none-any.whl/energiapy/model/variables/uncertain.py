...
def generate_uncertainty_vars(instance:ConcreteModel, scale_level:int= 0):
    ...
    instance.resource_demand_uncertainty = Var(instance.locations, instance.resources_uncertain_demand, instance.scales_uncertainty, within = NonNegativeReals, doc = 'resource demand uncertainty')
    instance.resource_price_uncertainty = Var(instance.locations, instance.resources_uncertain_price, instance.scales_uncertainty, within = NonNegativeReals, doc = 'resource price uncertainty')
    instance.process_capacity_uncertainty = Var(instance.locations, instance.processes_uncertain_capacity, instance.scales_uncertainty, within = NonNegativeReals, doc = 'process capacity uncertainty')
