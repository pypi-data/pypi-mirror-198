...
class SandboxReadiness(object):
    ...
    def message(self, message):
        """Sets the message of this SandboxReadiness.

        Message is a human readable explanation of why the sandbox is healthy or not.  # noqa: E501

        :param message: The message of this SandboxReadiness.  # noqa: E501
        :type: str
        """
    ...
    def ready(self):
        ...
        :return: The ready of this SandboxReadiness.  # noqa: E501
        :rtype: bool
        """
        return self._ready
    ...
    def ready(self, ready):
        """Sets the ready of this SandboxReadiness.

        Ready indicates whether the sandbox is ready, meaning that it can be used for testing.  # noqa: E501

        :param ready: The ready of this SandboxReadiness.  # noqa: E501
        :type: bool
        """
    ...
    def reason(self):
        ...
        :return: The reason of this SandboxReadiness.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this SandboxReadiness.

        Reason is a machine readable explanation of why the sandbox is healthy or not.  # noqa: E501

        :param reason: The reason of this SandboxReadiness.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SandboxReadiness, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SandboxReadiness):
            return False
