...
"""
pokedream.features.voice
~~~~~~~~~~~~~~~~~~~~~~~

The pokedream core voice-related commands.
...
class VoiceFeature(Feature):
    ...
    @Feature.Command(parent="psk", name="voice", aliases=["vc"],
                     invoke_without_command=True, ignore_extra=False)
    async def psk_voice(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="psk_voice", name="join", aliases=["connect"])
    async def psk_vc_join(
        self,
        ctx: ContextA,
        *,
    ...
    @Feature.Command(parent="psk_voice", name="disconnect", aliases=["dc"])
    async def psk_vc_disconnect(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="psk_voice", name="stop")
    async def psk_vc_stop(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="psk_voice", name="pause")
    async def psk_vc_pause(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="psk_voice", name="resume")
    async def psk_vc_resume(self, ctx: ContextA):
        """
    ...
    @Feature.Command(parent="psk_voice", name="volume")
    async def psk_vc_volume(self, ctx: ContextA, *, percentage: float):
        """
    ...
    @Feature.Command(parent="psk_voice", name="play", aliases=["play_local"])
    async def psk_vc_play(self, ctx: ContextA, *, uri: str):
        """
