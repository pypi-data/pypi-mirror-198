...
async def arguments_values(
    *args: t.Any, **kwargs: t.Any
    ...
    """
    data_pe_args = [await evaluate_with_protected_entity(arg) for arg in args]
    data_args = [data for data, _ in data_pe_args]

    data_pe_kwargs = {
        name: await evaluate_with_protected_entity(arg)
...
async def evaluate_with_protected_entity(
