...
setup(
    ...
    python_requires='>=3.8',
    install_requires=['wheel', 'pandas', 'openpyxl', 'cryptography', 'xlsxwriter', 'xlrd', 'selenium', 'easygui', 'pyperclip', 'mysql-connector-python==8.0.28',
                      ...
                      'Unidecode', 'WMI', 'tabulate', 'docx', 'PyMuPDF', 'PyPDF2', 'pdfminer', 'ipykernel']
)