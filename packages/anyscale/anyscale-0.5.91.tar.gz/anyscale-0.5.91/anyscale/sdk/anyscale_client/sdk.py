...
from anyscale.api_utils.job_logs_util import _get_logs_from_running_production_job, _get_job_logs_from_storage_bucket, _get_logs_from_running_job
from anyscale.api_utils.job_util import _is_job_on_v2_cloud, _is_production_job_on_v2_cloud
from anyscale.api_utils.exceptions.log_retrieval_errors import ExpectedLogRetrievalError, LogRetrievalTimeoutError, UnsupportedLogRetrievalMethodError
...
class AnyscaleSDK(DefaultApi):  # type: ignore
    ...
    def fetch_job_logs(self, job_id: str) -> str:
        ...
        get_job_logs_fns: List[Callable[..., str]] = [
            ...
            lambda: asyncio.run(_get_job_logs_from_storage_bucket(self, job_run_id=job_id)),
        ]
        logs = ""
