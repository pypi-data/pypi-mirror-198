...
internal_extras_requires = {"backend": ["terminado==0.10.1", "tornado"]}
...
for _, package_requirements in other_extras_requires.items():
    all_extras_requires_dependencies.extend(package_requirements)

all_extras_requires = {"all": ["ray>=1.4.0"] + all_extras_requires_dependencies}
