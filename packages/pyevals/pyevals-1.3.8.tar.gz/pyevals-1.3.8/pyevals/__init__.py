    ...
    def evaluate(self):
        ...
        try:
            if(self.model.lower()=='classification'):
                ...
                algorithms = ["LinearRegression","PolynomialRegression","RidgeRegression","LassoRegression","SupportVectorRegressor","GradientBoostingRegression"]
                ...
                functions = [LinearReg,PolynomialRegression,RidgeRegression,LassoRegression,SupportVectorRegressor,GradientBoostingRegression]


                R2Score = [functions[algorithm][0] for algorithm in range(6)]
                AdjustedR2 = [functions[algorithm][1] for algorithm in range(6)]
                MeanAbsoluteError = [functions[algorithm][2] for algorithm in range(6)]
                MeanSquaredError = [functions[algorithm][3] for algorithm in range(6)]
                RootMeanSquaredError = [functions[algorithm][4] for algorithm in range(6)]
