...
def _find_all_qt_modules():
    ...
    in_build = Path("/Users/qt/work/pyside/pyside-setup/build/qfp-py3.9-qt6.4.3-64bit-pypy.7.3.9-release/build/pyside6") in location.parents
