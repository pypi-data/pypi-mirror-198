...
WEIGHTS_DIR = os.path.join(ROOT_DIR, "weights/facelib")
...
#     model_path = os.path.join(WEIGHTS_DIR, list(f_id.keys())[0])
#     if not os.path.exists(model_path):
#         download_pretrained_models(file_ids=f_id, save_path_root=WEIGHTS_DIR)
