...
class EnrollAPI(APIView):
    ...
    def add(self, *args, user_info, request_params, **kwargs, ):
        ...
        subitem__count = params.pop("subitem__count", 1)  # 报名分项 项目清单数量
        ...
        for item_params in params.get("subitems", []):
            ...
            item_params.setdefault("count", subitem__count)
    ...
    @request_params_wrapper
    def detail(self, *args, user_info=None, request_params, **kwargs, ):
        # 参数验证
    ...
    def undertake_list(self, *args, request_params=None, user_info=None, **kwargs):
        ...
        thread_params = format_params_handle(
            param_dict=request_params,
            filter_filed_list=[
                "user_id", "title", "subtitle", "access_level", "author", "has_enroll", "has_fee", "has_comment",
