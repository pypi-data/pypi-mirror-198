...
class EnrollServices:
    ...
    def enroll_undertake_list(params, need_pagination=True):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "enroll_id", "thread_id_list", "user_id", "enroll_pay_status", "enroll_status_code", "enroll_status_code_list", "price", "count", "amount", "finance_invoicing_code"
            ],
            split_list=["enroll_status_code_list"],
            alias_dict={"enroll_status_code_list": "enroll_status_code__in", "thread_id_list": "enroll__thread_id__in"}
        )
