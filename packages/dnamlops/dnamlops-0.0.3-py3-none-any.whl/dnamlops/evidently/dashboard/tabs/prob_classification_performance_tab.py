...
from mlopsdna.evidently.dashboard.widgets.prob_class_conf_matrix_widget import ProbClassConfMatrixWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_confusion_based_feature_distr_table_widget import (
    ProbClassConfusionBasedFeatureDistrTable,
)
from mlopsdna.evidently.dashboard.widgets.prob_class_metrics_matrix_widget import ProbClassMetricsMatrixWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_pr_curve_widget import ProbClassPRCurveWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_pr_table_widget import ProbClassPRTableWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_pred_distr_widget import ProbClassPredDistrWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_prediction_cloud_widget import ProbClassPredictionCloudWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_quality_metrics_bar_widget import ProbClassQualityMetricBarWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_roc_curve_widget import ProbClassRocCurveWidget
from mlopsdna.evidently.dashboard.widgets.prob_class_support_widget import ProbClassSupportWidget
