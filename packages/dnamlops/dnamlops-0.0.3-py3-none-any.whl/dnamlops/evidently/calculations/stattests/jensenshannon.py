...
Import:
    ...
    >>> from mlopsdna.evidently.calculations.stattests import jensenshannon_stat_test
...
from mlopsdna.evidently.calculations.stattests.utils import get_binned_data
