...
from mlopsdna.nannyml.plots import Figure
...
class Result(Protocol):
    ...
    def filter(self, period: str = 'all',
        metrics: Optional[Union[str, List[str]]] = None, *args, **kwargs) -> Result:
        ...
...
def class_labels(model_outputs: ModelOutputsType) -> List[str]:
    if isinstance(model_outputs, Dict):
        ...
        raise InvalidArgumentsException(f"received object of type {type(model_outputs)}. Multiclass ModelOutputsType should be a 'Dict[str, str]'")
