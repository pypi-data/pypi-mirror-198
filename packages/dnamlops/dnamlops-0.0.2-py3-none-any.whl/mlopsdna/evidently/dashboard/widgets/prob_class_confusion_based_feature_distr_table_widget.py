...
from mlopsdna.evidently.analyzers.prob_classification_performance_analyzer import ProbClassificationPerformanceAnalyzer
from mlopsdna.evidently.dashboard.widgets.utils import CutQuantileTransformer
from mlopsdna.evidently.dashboard.widgets.widget import Widget
...
from mlopsdna.evidently.options import QualityMetricsOptions
...
class ProbClassConfusionBasedFeatureDistrTable(Widget):
    ...
    def calculate(
        ...
        if current_data is not None:
            ...
            current_prediction_labels = [utility_columns.prediction[x] for x in current_prediction_ids]
            ...
            for feature_name in results.columns.get_all_features_list(cat_before_num=False):
                ...
                for label in labels:
                    ...
                    fig.add_trace(
                        go.Scatter(
                            x=reference_data[reference_data[utility_columns.target] == label][feature_name],
