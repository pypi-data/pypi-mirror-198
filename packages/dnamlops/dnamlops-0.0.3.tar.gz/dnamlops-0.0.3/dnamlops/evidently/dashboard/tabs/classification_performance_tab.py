...
from mlopsdna.evidently.dashboard.widgets.class_conf_matrix_widget import ClassConfMatrixWidget
from mlopsdna.evidently.dashboard.widgets.class_confusion_based_feature_distr_table_widget import (
    ClassConfusionBasedFeatureDistrTable,
)
from mlopsdna.evidently.dashboard.widgets.class_metrics_matrix_widget import ClassMetricsMatrixWidget
from mlopsdna.evidently.dashboard.widgets.class_quality_metrics_bar_widget import ClassQualityMetricsBarWidget
from mlopsdna.evidently.dashboard.widgets.class_support_widget import ClassSupportWidget
