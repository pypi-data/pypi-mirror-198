...
from mlopsdna.evidently.dashboard.widgets.reg_abs_perc_error_in_time_widget import RegAbsPercErrorTimeWidget
from mlopsdna.evidently.dashboard.widgets.reg_colored_pred_vs_actual_widget import RegColoredPredActualWidget
from mlopsdna.evidently.dashboard.widgets.reg_error_distr_widget import RegErrorDistrWidget
from mlopsdna.evidently.dashboard.widgets.reg_error_in_time_widget import RegErrorTimeWidget
from mlopsdna.evidently.dashboard.widgets.reg_error_normality_widget import RegErrorNormalityWidget
from mlopsdna.evidently.dashboard.widgets.reg_pred_and_actual_in_time_widget import RegPredActualTimeWidget
from mlopsdna.evidently.dashboard.widgets.reg_pred_vs_actual_widget import RegPredActualWidget
from mlopsdna.evidently.dashboard.widgets.reg_quality_metrics_bar_widget import RegQualityMetricsBarWidget
from mlopsdna.evidently.dashboard.widgets.reg_underperform_metrics_widget import RegUnderperformMetricsWidget
from mlopsdna.evidently.dashboard.widgets.reg_underperform_segments_table_widget import UnderperformSegmTableWidget
from mlopsdna.evidently.dashboard.widgets.target_name_widget import TargetNameWidget
