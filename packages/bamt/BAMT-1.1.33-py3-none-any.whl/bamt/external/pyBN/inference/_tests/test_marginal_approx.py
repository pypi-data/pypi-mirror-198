...
from bamt.external.pyBN.inference.marginal_approx import marginal_fs_a, marginal_lws_a, marginal_gs_a
from bamt.external.pyBN.readwrite.read import read_bn
