...
if TYPE_CHECKING:
    from snap_pslg.type_hints import BBox, IntSegment



def get_segment_bbox(segment: IntSegment) -> BBox:
    """Create a slightly undersized bounding box for a segment.

    :param segment: A two-tuple of integer two-tuples.
...
def get_pixel_bbox(point: IntSegment) -> BBox:
    """Create a 1x1 square around a point.

    :param point: An integer two-tuple.
