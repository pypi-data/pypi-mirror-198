...
class WenXinBot:
    ...
    def initSelenium(self, headless=True, debug = False) -> bool:
        ...
        if sys.platform == "linux":
            server_proxy = Server(r'src/wenxin/browsermob-proxy-2.1.4/bin/browsermob-proxy.bat')
        else: server_proxy = Server(r'src\wenxin\browsermob-proxy-2.1.4\bin\browsermob-proxy.bat')
        server_proxy.start()
