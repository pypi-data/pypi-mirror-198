...
class objearth():
    ...
    @staticmethod
    def plotshow(DataArray,cmap=True,area=True,zenmode=False,figsize=(8,8),xlabel="x axis size",ylabel="y axis size",title=''):
        '''
        Plot image 
        :param DataArray : Numpy array/Xarray data array
        :param area      : area that you want [y-up,y-dwon,x-left,x-right]
        :param figsize   : size of image
        :param camp      : colormap
        :param zonmode   : plotshow only image no any detail
