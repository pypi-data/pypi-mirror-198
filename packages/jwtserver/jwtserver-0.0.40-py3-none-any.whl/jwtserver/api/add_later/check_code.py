...
from jwtserver.old_dependencies.init_redis import redis_conn
from jwtserver.recaptcha.google import RecaptchaGoogleV3


# TODO: rewrite and add routes in API V1
...
async def check_code(
    ...
    recaptcha: RecaptchaGoogleV3 = Depends(RecaptchaGoogleV3),
):
