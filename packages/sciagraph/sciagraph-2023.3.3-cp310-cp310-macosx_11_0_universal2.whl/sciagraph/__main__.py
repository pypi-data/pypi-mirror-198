...
PARSER.add_argument(
    ...
    help=(
        ...
        + " are implementation details you can ignore."
    ),
)
PARSER.add_argument(
    "--demo",
...
def main(argv=None):
    ...
    if LINUX and glibc_version() < (2, 28):
        raise SystemExit(
            ...
            "Note that Ubuntu 18.04 end of life is April 2023; "
            "you should upgrade if you're using it."
        )
