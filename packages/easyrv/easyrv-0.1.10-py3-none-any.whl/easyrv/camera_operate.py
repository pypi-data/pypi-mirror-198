...
class HkVideoCapture:
    def __init__(self, n_connection_num, def_device_list):
        self.image = None
    ...
    def get_image(self, color_set=cv2.COLOR_BAYER_BG2RGB, exposure_time=20000, frame_rate=60, reverse_x=False, reverse_y=False):
        # --------------- 设置曝光时间 和 缓冲区信息 -----------------------------------
        ...
        self.image = cv2.cvtColor(self.image, color_set)
        return self.image
