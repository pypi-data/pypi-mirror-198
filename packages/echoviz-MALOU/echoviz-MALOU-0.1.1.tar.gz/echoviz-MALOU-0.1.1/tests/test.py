...
def testy_testa():
    # Files to plot
    proot = Path("~/Documents/outputs/3d-closed-mv_seg/3DMV-segmentation/")
    pfile = Path("predictions/20150825110314_FED.h5")
    pinput = Path("~/Documents/data/bjørnar-hdf-isotropic/20150825110314_FED.h5").expanduser()
    pbpred = proot.joinpath("apricot-dawn-678_3gh5fm3t", pfile).expanduser()
    pmpred = proot.joinpath("robust-frog-680_i7xqn14n", pfile).expanduser()
