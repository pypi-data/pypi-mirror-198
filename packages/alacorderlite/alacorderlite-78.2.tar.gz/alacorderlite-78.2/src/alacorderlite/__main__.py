...
@click.version_option("78.2", package_name="alacorder")
@click.pass_context
def cli(ctx):
    """
    ALACORDER beta 78.2
...
ALACORDER beta 78.2""",font="Courier 14", pad=(5,5))],[sg.Text("""Alacorder retrieves and processes case detail PDFs\ninto data tables suitable for research purposes.""",font="Default 22", pad=(10,10))],
