...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if Region.objects.filter(populado=True).exists():
            self.stdout.write(
        ...
        try:
            ...
            response = requests.get(f"{BASE_URL}regiones")
