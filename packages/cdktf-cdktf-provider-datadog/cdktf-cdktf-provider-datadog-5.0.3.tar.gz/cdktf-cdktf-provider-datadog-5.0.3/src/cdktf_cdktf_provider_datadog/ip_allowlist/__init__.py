...
class IpAllowlist(
    ...
    def __init__(
        ...
        *,
        ...
        :param enabled: Whether the IP Allowlist is enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/datadog/r/ip_allowlist#enabled IpAllowlist#enabled}
        :param entry: entry block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/datadog/r/ip_allowlist#entry IpAllowlist#entry}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/datadog/r/ip_allowlist#id IpAllowlist#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class IpAllowlistEntry:
    def __init__(
        ...
        *,
        ...
        '''
        :param cidr_block: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/datadog/r/ip_allowlist#cidr_block IpAllowlist#cidr_block}.
        :param note: Note accompanying IP address. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/datadog/r/ip_allowlist#note IpAllowlist#note}
        '''
        if __debug__:
