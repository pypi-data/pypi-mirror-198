...
class ClusterLogConf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterLogConf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterLogConf:
        """Create an instance of ClusterLogConf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClusterLogConf.parse_obj(obj)

        _obj = ClusterLogConf.parse_obj(
            {
