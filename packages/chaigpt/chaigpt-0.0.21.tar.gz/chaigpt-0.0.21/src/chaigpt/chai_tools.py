...
def alternating_caps(word: str, is_first_char_lower: bool = True) -> str:
    """
...
def similar_capitalization(word_to_modify, word_to_emulate):
    ...
    was_last_char_lower = was_first_char_lower = is_lower(word_to_emulate[0])
    ...
    if has_alternating_caps:
        return alternating_caps(
            word_to_modify, is_first_char_lower=was_first_char_lower,
        )
