...
class JupyterRunHandler(JupyterHandler):
    """JupyterRunHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_run/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_run", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_run", "echo")
    handlers = [
        (route_pattern, JupyterRunHandler),
