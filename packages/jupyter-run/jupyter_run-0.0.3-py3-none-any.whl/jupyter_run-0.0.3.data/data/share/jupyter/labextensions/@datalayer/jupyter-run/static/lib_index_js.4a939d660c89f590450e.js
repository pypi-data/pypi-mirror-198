"use strict";
(self["webpackChunk_datalayer_jupyter_run"] = self["webpackChunk_datalayer_jupyter_run"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_run', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterRun": () => (/* binding */ IJupyterRun),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "jupyterRun": () => (/* binding */ jupyterRun)
/* harmony export */ });
...
const IJupyterRun = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_4__.Token('@datalayer/jupyter-run:plugin');
const jupyterRun = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-run-widget';
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_run server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_9__.connect)('ws://localhost:8888/jupyter_run/echo', true);
        return jupyterRun;
    }
};
...
//# sourceMappingURL=lib_index_js.4a939d660c89f590450e.js.map