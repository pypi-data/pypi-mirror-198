...
if __name__ == '__main__':
    driver = AndroidDriver(device_id='172.16.1.216:61593', pkg_name='com.qizhidao.clientapp')
    driver.install_app(
        'http://maven.qizhidao.net:8081/repository/packages-host/qzd/qizhidao_app_android/dev-work/jenkins_614/app_qzd_v4.3.3_80304000_2023-03-17_arm64-v8a_pre_release.apk')
    driver.start_app()
