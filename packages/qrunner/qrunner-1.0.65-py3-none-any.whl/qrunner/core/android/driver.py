...
from qrunner.utils.exceptions import ScreenFailException, PkgIsNull, ConnectInfoIsNull
...
class AndroidDriver(object):
    ...
    def __init__(self, device_id=None, pkg_name=None, remote_addr=None):
        ...
        if device_id:
            ...
            logger.info(f'init android driver: {remote_addr}')
            self.d = u2.connect_adb_wifi(remote_addr)
        else:
