...
def gen_cov_report(ip_str, is_regression=False, test_suite="", regression_name="", regression_timestamp=""):
    ...
    if is_regression:
        if test_suite == "":
            cov_path    = cfg.regr_results_dir + f"/{ip.name}__{regression_name}__{regression_timestamp}/cov"
            merge_path  = cfg.regr_results_dir + f"/{ip.name}__{regression_name}__{regression_timestamp}/cov/merge"
            report_path = cfg.regr_results_dir + f"/{ip.name}__{regression_name}__{regression_timestamp}/cov/report"
        else:
            cov_path    = cfg.regr_results_dir + f"/{ip.name}__{test_suite}_{regression_name}__{regression_timestamp}/cov"
            merge_path  = cfg.regr_results_dir + f"/{ip.name}__{test_suite}_{regression_name}__{regression_timestamp}/cov/merge"
            report_path = cfg.regr_results_dir + f"/{ip.name}__{test_suite}_{regression_name}__{regression_timestamp}/cov/report"
