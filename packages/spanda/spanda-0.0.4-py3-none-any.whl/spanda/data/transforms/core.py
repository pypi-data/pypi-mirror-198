# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/02_data.transforms.core.ipynb.

# %% auto 0
__all__ = ['interp']

# %% ../../../nbs/02_data.transforms.core.ipynb 3
from ..core import read_opus
import numpy as np
...
# %% ../../../nbs/02_data.transforms.core.ipynb 4
def interp(
