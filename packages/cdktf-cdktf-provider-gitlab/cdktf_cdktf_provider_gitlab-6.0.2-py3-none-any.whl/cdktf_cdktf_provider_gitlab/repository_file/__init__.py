...
class RepositoryFile(
    ...
    def __init__(
        ...
        *,
        ...
        :param file_path: The full path of the file. It must be relative to the root of the project without a leading slash ``/`` or ``./``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/repository_file#file_path RepositoryFile#file_path}
        ...
        :param overwrite_on_create: Enable overwriting existing files, defaults to ``false``. This attribute is only used during ``create`` and must be use carefully. We suggest to use ``imports`` whenever possible and limit the use of this attribute for when the project was imported on the same ``apply``. This attribute is not supported during a resource import. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/repository_file#overwrite_on_create RepositoryFile#overwrite_on_create}
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["RepositoryFileTimeouts", _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["RepositoryFileTimeouts", _cdktf_9a9027ec.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class RepositoryFileTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[RepositoryFileTimeouts, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[RepositoryFileTimeouts, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
