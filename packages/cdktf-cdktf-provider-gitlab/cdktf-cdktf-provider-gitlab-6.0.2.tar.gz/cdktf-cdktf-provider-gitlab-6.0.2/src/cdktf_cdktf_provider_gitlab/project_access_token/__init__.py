...
class ProjectAccessToken(
    ...
    def __init__(
        ...
        *,
        ...
        :param scopes: Valid values: ``api``, ``read_api``, ``read_repository``, ``write_repository``, ``read_registry``, ``write_registry``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project_access_token#scopes ProjectAccessToken#scopes}
