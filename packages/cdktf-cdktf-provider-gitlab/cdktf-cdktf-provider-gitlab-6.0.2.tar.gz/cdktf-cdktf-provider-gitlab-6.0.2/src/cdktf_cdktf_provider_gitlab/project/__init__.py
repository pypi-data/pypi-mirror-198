...
class Project(
    ...
    def __init__(
        ...
        *,
        ...
        :param avatar: A local path to the avatar image to upload. **Note**: not available for imported resources. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#avatar Project#avatar}
        :param avatar_hash: The hash of the avatar image. Use ``filesha256("path/to/avatar.png")`` whenever possible. **Note**: this is used to trigger an update of the avatar. If it's not given, but an avatar is given, the avatar will be updated each time. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#avatar_hash Project#avatar_hash}
        ...
        :param ci_separated_caches: Use separate caches for protected branches. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#ci_separated_caches Project#ci_separated_caches}
        ...
        :param environments_access_level: Set the environments access level. Valid values are ``disabled``, ``private``, ``enabled``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#environments_access_level Project#environments_access_level}
        ...
        :param feature_flags_access_level: Set the feature flags access level. Valid values are ``disabled``, ``private``, ``enabled``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#feature_flags_access_level Project#feature_flags_access_level}
        :param forked_from_project_id: The id of the project to fork. During create the project is forked and during an update the fork relation is changed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#forked_from_project_id Project#forked_from_project_id}
        ...
        :param import_url: Git URL to a repository to be imported. Together with ``mirror = true`` it will setup a Pull Mirror. This can also be used together with ``forked_from_project_id`` to setup a Pull Mirror for a fork. The fork takes precedence over the import. Make sure to provide the credentials in ``import_url_username`` and ``import_url_password``. GitLab never returns the credentials, thus the provider cannot detect configuration drift in the credentials. They can also not be imported using ``terraform import``. See the examples section for how to properly use it. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#import_url Project#import_url}
        :param import_url_password: The password for the ``import_url``. The value of this field is used to construct a valid ``import_url`` and is only related to the provider. This field cannot be imported using ``terraform import``. See the examples section for how to properly use it. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#import_url_password Project#import_url_password}
        :param import_url_username: The username for the ``import_url``. The value of this field is used to construct a valid ``import_url`` and is only related to the provider. This field cannot be imported using ``terraform import``. See the examples section for how to properly use it. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#import_url_username Project#import_url_username}
        :param infrastructure_access_level: Set the infrastructure access level. Valid values are ``disabled``, ``private``, ``enabled``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#infrastructure_access_level Project#infrastructure_access_level}
        ...
        :param monitor_access_level: Set the monitor access level. Valid values are ``disabled``, ``private``, ``enabled``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#monitor_access_level Project#monitor_access_level}
        :param mr_default_target_self: For forked projects, target merge requests to this project. If false, the target will be the upstream project. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#mr_default_target_self Project#mr_default_target_self}
        ...
        :param releases_access_level: Set the releases access level. Valid values are ``disabled``, ``private``, ``enabled``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#releases_access_level Project#releases_access_level}
        ...
        :param restrict_user_defined_variables: Allow only users with the Maintainer role to pass user-defined variables when triggering a pipeline. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#restrict_user_defined_variables Project#restrict_user_defined_variables}
    ...
    def put_container_expiration_policy(
        ...
        *,
        ...
        :param name_regex: The regular expression to match image names to delete. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#name_regex Project#name_regex}
        :param name_regex_delete: The regular expression to match image names to delete. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/gitlab/r/project#name_regex_delete Project#name_regex_delete}
    ...
    def operations_access_level(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2c1978a26856c3630416de995fd4e493dc6046aaf7488e49b4aa3dcdfe24036f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__2c1978a26856c3630416de995fd4e493dc6046aaf7488e49b4aa3dcdfe24036f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
