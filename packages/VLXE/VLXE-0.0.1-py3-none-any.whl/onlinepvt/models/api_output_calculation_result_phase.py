...
from ..models.phase_type import PhaseType
...
class ApiOutputCalculationResultPhase:
    ...
    phase_type: Union[Unset, PhaseType] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.phase_type, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        _phase_type = d.pop("phaseType", UNSET)
        phase_type: Union[Unset, PhaseType]
        if isinstance(_phase_type, Unset):
            phase_type = UNSET
        else:
            phase_type = PhaseType(_phase_type)
