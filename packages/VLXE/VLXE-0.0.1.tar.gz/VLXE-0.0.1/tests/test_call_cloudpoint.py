import pytest
from onlinepvt.models import CalculationComposition, CloudPointCalculationType, ProblemDetails, ApiCallResult 
...
async def test_call_cloudpoint():
    client = OnlinePvtClient(
      "https://localhost:5201", "760C278E-20F7-4E31-AD0E-D0CF564D1414", "##glD47#al!=(d+53ES3?qW") # "https://api.onlinepvt.com", "UserId", "AccessSecret")
