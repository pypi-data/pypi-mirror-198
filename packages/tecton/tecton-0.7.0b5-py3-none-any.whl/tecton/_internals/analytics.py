...
class StateUpdateEventMetrics:
    ...
    def from_error_message(cls, error_message: str, suppress_recreates: bool = False, json_out: bool = False):
        return cls(-1, -1, -1, -1, suppress_recreates, json_out, error_message)
...
class StateUpdateResponse:
    ...
    v1_response: Optional[QueryStateUpdateResponse]
    v2_response: Optional[QueryStateUpdateResponseV2]
    v1_and_v2_error_message: Optional[str] = None
    ...
    def from_error_message(cls, error_message: str, suppress_recreates: bool = False, json_out: bool = False):
        return cls(
            ...
            v1_response=None,
            v2_response=None,
            v1_and_v2_error_message=error_message,
        )
...
class AnalyticsLogger(object):
    ...
    @staticmethod
    def _create_sdk_base_request(trace_id, obj, method) -> IngestClientLogsRequest:
        """
