...
def _set_dense2d_variables(ak_layer, dense_block):
    ...
    Args:
        ...
        dense_block (list(:obj:`tf.keras.Layer`)): the block of keras layers.
    """
    dense = dense_block[0]
...
def convert_dense_block(model_ak, layers):
    ...
    _set_dense2d_variables(dense_ak, dense_block[index:])
