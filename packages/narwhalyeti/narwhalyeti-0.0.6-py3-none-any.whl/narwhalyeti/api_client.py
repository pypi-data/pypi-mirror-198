...
from narwhalyeti import rest
from narwhalyeti.configuration import Configuration
from narwhalyeti.exceptions import ApiTypeError, ApiValueError, ApiException
from narwhalyeti.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AttachmentApi()
        api_instance.upload_attachment  # this is an instance of the class Endpoint
        api_instance.upload_attachment()  # this invokes api_instance.upload_attachment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.upload_attachment.callable or self.callable in this class
