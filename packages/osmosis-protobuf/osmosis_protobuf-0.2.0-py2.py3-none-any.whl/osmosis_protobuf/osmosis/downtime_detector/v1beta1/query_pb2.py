...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _RECOVEREDSINCEDOWNTIMEOFLENGTHREQUEST.fields_by_name['recovery']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01\xf2\xde\x1f\x18yaml:"recovery_duration"'
