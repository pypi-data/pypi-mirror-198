...
class GenesisState(_message.Message):
    __slots__ = ['base_denoms', 'days_since_module_genesis', 'developer_address', 'developer_fees', 'latest_block_height', 'max_pool_points_per_block', 'max_pool_points_per_tx', 'params', 'point_count_for_block', 'pool_weights', 'token_pair_arb_routes']
