...
class ScalarDescriptor(_message.Message):
    __slots__ = ['description', 'field_type', 'legacy_amino_encoding', 'name']
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    FIELD_TYPE_FIELD_NUMBER: _ClassVar[int]
    LEGACY_AMINO_ENCODING_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    description: str
    field_type: _containers.RepeatedScalarFieldContainer[ScalarType]
    legacy_amino_encoding: str
    name: str

    def __init__(self, name: _Optional[str]=..., description: _Optional[str]=..., field_type: _Optional[_Iterable[_Union[ScalarType, str]]]=..., legacy_amino_encoding: _Optional[str]=...) -> None:
        ...
