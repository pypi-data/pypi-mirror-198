...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZFgithub.com/osmosis-labs/osmosis/v15/x/ibc-rate-limit/client/queryproto'
