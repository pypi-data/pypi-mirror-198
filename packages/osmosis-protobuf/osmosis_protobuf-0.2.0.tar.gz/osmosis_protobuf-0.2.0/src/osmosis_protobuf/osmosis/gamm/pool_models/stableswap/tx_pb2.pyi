...
class MsgCreateStableswapPool(_message.Message):
    __slots__ = ['future_pool_governor', 'initial_pool_liquidity', 'pool_params', 'scaling_factor_controller', 'scaling_factors', 'sender']
...
class MsgStableSwapAdjustScalingFactors(_message.Message):
    __slots__ = ['pool_id', 'scaling_factors', 'sender']
    POOL_ID_FIELD_NUMBER: _ClassVar[int]
    SCALING_FACTORS_FIELD_NUMBER: _ClassVar[int]
    SENDER_FIELD_NUMBER: _ClassVar[int]
    pool_id: int
