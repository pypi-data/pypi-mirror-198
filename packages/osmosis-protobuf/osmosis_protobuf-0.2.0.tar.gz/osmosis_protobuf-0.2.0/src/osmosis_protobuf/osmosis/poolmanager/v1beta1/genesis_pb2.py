...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARAMS._serialized_start = 263
    _PARAMS._serialized_end = 404
    _GENESISSTATE._serialized_start = 407
    _GENESISSTATE._serialized_end = 571