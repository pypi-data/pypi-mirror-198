...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name['developer_address']._serialized_options = b'\xd2\xb4-\x0ecosmos.Address\xf2\xde\x1f\x18yaml:"developer_address"'
    ...
    _GENESISSTATE._serialized_end = 1087