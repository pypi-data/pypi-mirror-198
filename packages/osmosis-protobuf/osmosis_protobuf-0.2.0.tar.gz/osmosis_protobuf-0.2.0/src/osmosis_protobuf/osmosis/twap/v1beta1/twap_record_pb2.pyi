...
class TwapRecord(_message.Message):
    __slots__ = ['asset0_denom', 'asset1_denom', 'geometric_twap_accumulator', 'height', 'last_error_time', 'p0_arithmetic_twap_accumulator', 'p0_last_spot_price', 'p1_arithmetic_twap_accumulator', 'p1_last_spot_price', 'pool_id', 'time']
