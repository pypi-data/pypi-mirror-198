...
class SeasonPersonBaseStatisticsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonPersonBaseStatisticsModelOrganization:
        """Create an instance of SeasonPersonBaseStatisticsModelOrganization from a JSON string"""
