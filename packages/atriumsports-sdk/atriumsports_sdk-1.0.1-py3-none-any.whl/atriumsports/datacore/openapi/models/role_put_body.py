...
class RolePutBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RolePutBody:
        """Create an instance of RolePutBody from a JSON string"""
