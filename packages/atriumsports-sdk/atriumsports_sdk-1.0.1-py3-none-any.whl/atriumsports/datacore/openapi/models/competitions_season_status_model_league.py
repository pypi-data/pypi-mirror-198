...
class CompetitionsSeasonStatusModelLeague(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("leagues"):
            raise ValueError("must validate the enum values ('leagues')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionsSeasonStatusModelLeague:
        """Create an instance of CompetitionsSeasonStatusModelLeague from a JSON string"""
