...
class FixturesByEntityModel(BaseModel):
    ...
    participants: Optional[List[FixtureParticipant]] = Field(None, description="Array of fixture participants")
    competitors: Optional[List[FixtureCompetitor]] = Field(None, description="Array of fixture competitors")
    ...
    def practice_drill_type_validate_enum(cls, v):
        ...
        if v not in ("DRILL", "GAME", "FITNESS", "OTHER"):
            raise ValueError("must validate the enum values ('DRILL', 'GAME', 'FITNESS', 'OTHER')")
        return v
    ...
    def status_validate_enum(cls, v):
        ...
        if v not in (
            ...
            raise ValueError(
                "must validate the enum values ('IF_NEEDED', 'SCHEDULED', 'BYE', 'PENDING', 'IN_PROGRESS', 'FINISHED', 'CONFIRMED', 'POSTPONED', 'CANCELLED', 'ABANDONED')"
            )
        return v
    ...
    def maximum_period_type_used_validate_enum(cls, v):
        ...
        if v not in ("REGULAR", "EXTRA_TIME", "OVERTIME", "SHOOTOUT"):
            raise ValueError("must validate the enum values ('REGULAR', 'EXTRA_TIME', 'OVERTIME', 'SHOOTOUT')")
        return v
    ...
    def to_dict(self):
        ...
        if self.practice_drill_type is None:
        ...
        if self.fixture_number is None:
        ...
        if self.series_fixture_number is None:
