...
class FixtureEntitiesModelConference(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("conferences"):
            raise ValueError("must validate the enum values ('conferences')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntitiesModelConference:
        """Create an instance of FixtureEntitiesModelConference from a JSON string"""
