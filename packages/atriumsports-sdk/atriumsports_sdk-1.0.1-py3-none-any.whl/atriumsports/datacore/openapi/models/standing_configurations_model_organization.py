...
class StandingConfigurationsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandingConfigurationsModelOrganization:
        """Create an instance of StandingConfigurationsModelOrganization from a JSON string"""
