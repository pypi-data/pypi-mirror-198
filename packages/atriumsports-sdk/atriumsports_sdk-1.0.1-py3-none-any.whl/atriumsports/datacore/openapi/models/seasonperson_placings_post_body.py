...
class SEASONPERSONPlacingsPostBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SEASONPERSONPlacingsPostBody:
        """Create an instance of SEASONPERSONPlacingsPostBody from a JSON string"""
