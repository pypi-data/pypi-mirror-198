...
class CompetitionsSeasonStatusModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionsSeasonStatusModelOrganization:
        """Create an instance of CompetitionsSeasonStatusModelOrganization from a JSON string"""
