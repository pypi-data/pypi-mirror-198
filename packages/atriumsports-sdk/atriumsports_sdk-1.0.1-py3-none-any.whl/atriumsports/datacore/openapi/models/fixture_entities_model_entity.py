...
class FixtureEntitiesModelEntity(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("entities"):
            raise ValueError("must validate the enum values ('entities')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntitiesModelEntity:
        """Create an instance of FixtureEntitiesModelEntity from a JSON string"""
