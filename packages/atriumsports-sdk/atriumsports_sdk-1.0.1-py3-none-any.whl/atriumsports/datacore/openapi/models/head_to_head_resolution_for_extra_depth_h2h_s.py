...
class HeadToHeadResolutionForExtraDepthH2hS(BaseModel):
    ...
    def sort_direction_validate_enum(cls, v):
        ...
        if v not in ("ASC", "DESC"):
            raise ValueError("must validate the enum values ('ASC', 'DESC')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HeadToHeadResolutionForExtraDepthH2hS:
        """Create an instance of HeadToHeadResolutionForExtraDepthH2hS from a JSON string"""
