...
class PoolPostBody(BaseModel):
    ...
    pool_code: constr(strict=True, max_length=30) = Field(
        ..., alias="poolCode", description="A unique code for the pool. (Unique for season)"
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoolPostBody:
        """Create an instance of PoolPostBody from a JSON string"""
