...
class FixturePersonsModelPerson(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("persons"):
            raise ValueError("must validate the enum values ('persons')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePersonsModelPerson:
        """Create an instance of FixturePersonsModelPerson from a JSON string"""
