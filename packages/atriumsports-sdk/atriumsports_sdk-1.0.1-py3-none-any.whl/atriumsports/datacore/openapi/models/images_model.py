...
class ImagesModel(BaseModel):
    ...
    def base_type_validate_enum(cls, v):
        ...
        if v not in (
            ...
            raise ValueError(
                "must validate the enum values ('PERSON', 'ENTITY', 'ENTITYGROUP', 'COMPETITION', 'SEASON', 'LEAGUE', 'ORGANIZATION', 'DIVISION', 'CONFERENCE')"
            )
        return v
    ...
    def file_type_validate_enum(cls, v):
        ...
        if v not in ("JPG", "PNG", "SVG"):
            raise ValueError("must validate the enum values ('JPG', 'PNG', 'SVG')")
        return v
    ...
    def image_type_validate_enum(cls, v):
        ...
        if v not in (
            ...
            raise ValueError(
                "must validate the enum values ('LOGO', 'LOGO_ALTERNATE', 'LOGO_BACKGROUND', 'PERSON_HEAD', 'PERSON_WAIST', 'PERSON_POSE', 'TEAM_PHOTO')"
            )
        return v
    ...
    def secondary_type_validate_enum(cls, v):
        ...
        if v not in ("ENTITY", "ENTITYGROUP", "COMPETITION", "SEASON", "LEAGUE", "DIVISION", "CONFERENCE"):
            raise ValueError(
                "must validate the enum values ('ENTITY', 'ENTITYGROUP', 'COMPETITION', 'SEASON', 'LEAGUE', 'DIVISION', 'CONFERENCE')"
            )
        return v
