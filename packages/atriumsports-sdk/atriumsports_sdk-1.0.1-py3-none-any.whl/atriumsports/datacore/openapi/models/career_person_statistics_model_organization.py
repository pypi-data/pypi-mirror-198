...
class CareerPersonStatisticsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CareerPersonStatisticsModelOrganization:
        """Create an instance of CareerPersonStatisticsModelOrganization from a JSON string"""
