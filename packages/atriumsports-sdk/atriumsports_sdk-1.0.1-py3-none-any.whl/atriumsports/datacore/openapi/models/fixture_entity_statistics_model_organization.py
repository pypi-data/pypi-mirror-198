...
class FixtureEntityStatisticsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntityStatisticsModelOrganization:
        """Create an instance of FixtureEntityStatisticsModelOrganization from a JSON string"""
