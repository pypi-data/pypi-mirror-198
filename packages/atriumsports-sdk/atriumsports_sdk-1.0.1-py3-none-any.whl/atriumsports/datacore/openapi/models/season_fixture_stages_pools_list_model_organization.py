...
class SeasonFixtureStagesPoolsListModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonFixtureStagesPoolsListModelOrganization:
        """Create an instance of SeasonFixtureStagesPoolsListModelOrganization from a JSON string"""
