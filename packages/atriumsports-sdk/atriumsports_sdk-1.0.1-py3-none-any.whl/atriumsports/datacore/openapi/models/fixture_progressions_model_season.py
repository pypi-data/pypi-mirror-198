...
class FixtureProgressionsModelSeason(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("seasons"):
            raise ValueError("must validate the enum values ('seasons')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureProgressionsModelSeason:
        """Create an instance of FixtureProgressionsModelSeason from a JSON string"""
