...
class CompetitionPersonStatisticsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionPersonStatisticsModelOrganization:
        """Create an instance of CompetitionPersonStatisticsModelOrganization from a JSON string"""
