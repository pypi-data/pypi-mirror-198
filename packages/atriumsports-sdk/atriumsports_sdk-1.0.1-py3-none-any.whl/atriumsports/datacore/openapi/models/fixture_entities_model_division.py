...
class FixtureEntitiesModelDivision(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("divisions"):
            raise ValueError("must validate the enum values ('divisions')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntitiesModelDivision:
        """Create an instance of FixtureEntitiesModelDivision from a JSON string"""
