...
class FixturePLAYBYPLAYApi(object):
    ...
    def fixture_pbp_all_delete(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_all_delete(fixture_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_all_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_all_delete_with_http_info(fixture_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_delete(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_delete(fixture_id, organization_id, period_id, sport, external, fields, force_delete, hide_null, include, section, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_delete_with_http_info(fixture_id, organization_id, period_id, sport, external, fields, force_delete, hide_null, include, section, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_insert_update(
        ...
        sport: Annotated[StrictStr, Field(..., description="Sport name")],
        fixture_pbp_post_body: FixturePbpPostBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_insert_update(fixture_id, organization_id, sport, fixture_pbp_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param fixture_pbp_post_body: (required)
        :type fixture_pbp_post_body: FixturePbpPostBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        try:
            ...
            logger.error("Exception when calling FixturePLAYBYPLAYApi->fixture_pbp_insert_update: %s\n" % e)
            raise

    @validate_arguments
    def fixture_pbp_insert_update_with_http_info(
        self,
        fixture_id: Annotated[StrictStr, Field(..., description="The unique identifier of the fixture")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_insert_update_with_http_info(fixture_id, organization_id, sport, fixture_pbp_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method fixture_pbp_insert_update" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/fixtures/{fixtureId}/playbyplay/import",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def fixture_pbp_list(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_list(fixture_id, organization_id, sport, external, fields, from_timestamp, hide_null, include, limit, offset, period_id, tbf, to_timestamp, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_list_with_http_info(fixture_id, organization_id, sport, external, fields, from_timestamp, hide_null, include, limit, offset, period_id, tbf, to_timestamp, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_list_live(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_list_live(fixture_id, organization_id, sport, external, fields, from_timestamp, hide_null, include, limit, offset, period_id, tbf, to_timestamp, async_req=True)
        >>> result = thread.get()
    ...
    def fixture_pbp_list_live_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_list_live_with_http_info(fixture_id, organization_id, sport, external, fields, from_timestamp, hide_null, include, limit, offset, period_id, tbf, to_timestamp, async_req=True)
        >>> result = thread.get()
