...
class CareerStatisticsApi(object):
    ...
    def cps_list(
        ...
        **kwargs
        ...
        >>> thread = api.cps_list(organization_id, sport, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling CareerStatisticsApi->cps_list: %s\n" % e)
            raise
    ...
    def cps_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.cps_list_with_http_info(organization_id, sport, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def cps_listperson(
        ...
        **kwargs
        ...
        >>> thread = api.cps_listperson(organization_id, person_id, sport, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        try:
            return self.cps_listperson_with_http_info(
                organization_id,
                person_id,
                sport,
                external,
            ...
            logger.error("Exception when calling CareerStatisticsApi->cps_listperson: %s\n" % e)
            raise

    @validate_arguments
    def cps_listperson_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.cps_listperson_with_http_info(organization_id, person_id, sport, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method cps_listperson" % _key)
            _params[_key] = _val
        del _params["kwargs"]
