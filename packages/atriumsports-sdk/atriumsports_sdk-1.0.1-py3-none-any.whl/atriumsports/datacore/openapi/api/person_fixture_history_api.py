...
class PersonFixtureHistoryApi(object):
    ...
    def gamelog_listperson(
        ...
        **kwargs
        ...
        >>> thread = api.gamelog_listperson(organization_id, person_id, season_id, sport, added, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, starter, tbf, updated, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def gamelog_listperson_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.gamelog_listperson_with_http_info(organization_id, person_id, season_id, sport, added, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, starter, tbf, updated, win_loss, async_req=True)
        >>> result = thread.get()
