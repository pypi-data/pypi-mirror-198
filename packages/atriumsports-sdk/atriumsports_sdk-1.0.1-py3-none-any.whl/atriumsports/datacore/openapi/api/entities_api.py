...
class EntitiesApi(object):
    ...
    def entity_delete(
        ...
        **kwargs
        ...
        >>> thread = api.entity_delete(entity_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.entity_delete_with_http_info(
                entity_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, **kwargs
            )  # noqa: E501
    ...
    def entity_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_delete_with_http_info(entity_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def entity_detail(
        ...
        **kwargs
        ...
        >>> thread = api.entity_detail(entity_id, organization_id, sport, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.entity_detail_with_http_info(
                entity_id, organization_id, sport, external, fields, hide_null, include, limit, offset, tbf, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    def entity_detail_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_detail_with_http_info(entity_id, organization_id, sport, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def entity_insert(
        ...
        **kwargs
        ...
        >>> thread = api.entity_insert(organization_id, sport, entity_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.entity_insert_with_http_info(
                organization_id, sport, entity_post_body, external, fields, hide_null, include, tbf, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    def entity_insert_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_insert_with_http_info(organization_id, sport, entity_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def entity_list(
        ...
        name_full_local_contains: Annotated[
            Optional[constr(strict=True, max_length=50, min_length=2)],
            Field(
                description="Fields that allow a 'Contains' query string parameter search for words separated by a space, matching characters left to right. Example: nameFullLatin=David Johnson nameFullLocalContains=Dav will match nameFullLocalContains=John will match nameFullLocalContains=son will not match"
            ),
        ] = None,
        offset: Annotated[
            Optional[StrictInt],
        ...
        **kwargs
        ...
        >>> thread = api.entity_list(organization_id, sport, added, external, fields, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, sort_by, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        :param name_full_local_contains: Fields that allow a 'Contains' query string parameter search for words separated by a space, matching characters left to right. Example: nameFullLatin=David Johnson nameFullLocalContains=Dav will match nameFullLocalContains=John will match nameFullLocalContains=son will not match
    ...
    def entity_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list_with_http_info(organization_id, sport, added, external, fields, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, sort_by, status, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_list_by_entity_group(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list_by_entity_group(entity_group_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_list_by_entity_group_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list_by_entity_group_with_http_info(entity_group_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_update(
        ...
        **kwargs
        ...
        >>> thread = api.entity_update(entity_id, organization_id, sport, entity_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.entity_update_with_http_info(
                entity_id, organization_id, sport, entity_put_body, external, fields, hide_null, include, tbf, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    def entity_update_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_update_with_http_info(entity_id, organization_id, sport, entity_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
