...
class SeasonRosterApi(object):
    ...
    def season_roster_delete(
        ...
        **kwargs
    ) -> SeasonRosterResponse:  # noqa: E501
        ...
        >>> thread = api.season_roster_delete(organization_id, person_id, season_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->season_roster_delete: %s\n" % e)
            raise

    @validate_arguments
    def season_roster_delete_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_delete_with_http_info(organization_id, person_id, season_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SeasonRosterResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method season_roster_delete" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            "200": "SeasonRosterResponse",
        }

        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/seasons/{seasonId}/persons/{personId}/roster",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def season_roster_detail(
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_detail(organization_id, person_id, season_id, sport, external, fields, hide_null, include, limit, offset, status, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->season_roster_detail: %s\n" % e)
            raise

    @validate_arguments
    def season_roster_detail_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_detail_with_http_info(organization_id, person_id, season_id, sport, external, fields, hide_null, include, limit, offset, status, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method season_roster_detail" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    @validate_arguments
    def season_roster_insert_update(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        season_id: Annotated[StrictStr, Field(..., description="The unique identifier of the season")],
        sport: Annotated[StrictStr, Field(..., description="Sport name")],
        season_roster_post_body: SeasonRosterPostBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_insert_update(organization_id, season_id, sport, season_roster_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param season_roster_post_body: (required)
        :type season_roster_post_body: SeasonRosterPostBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->season_roster_insert_update: %s\n" % e)
            raise

    @validate_arguments
    def season_roster_insert_update_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_insert_update_with_http_info(organization_id, season_id, sport, season_roster_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method season_roster_insert_update" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/seasons/{seasonId}/roster",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def season_roster_list(
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_list(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->season_roster_list: %s\n" % e)
            raise

    @validate_arguments
    def season_roster_list_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_list_with_http_info(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method season_roster_list" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    @validate_arguments
    def season_roster_list_by_entity(
        self,
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_list_by_entity(entity_id, organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->season_roster_list_by_entity: %s\n" % e)
            raise

    @validate_arguments
    def season_roster_list_by_entity_with_http_info(
        self,
        entity_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.season_roster_list_by_entity_with_http_info(entity_id, organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method season_roster_list_by_entity" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/seasons/{seasonId}/entities/{entityId}/roster",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    @validate_arguments
    def seasons_roster_list_by_entity(
        self,
        entity_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.seasons_roster_list_by_entity(entity_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, season_ids, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling SeasonRosterApi->seasons_roster_list_by_entity: %s\n" % e)
            raise

    @validate_arguments
    def seasons_roster_list_by_entity_with_http_info(
        self,
        entity_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.seasons_roster_list_by_entity_with_http_info(entity_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, season_ids, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method seasons_roster_list_by_entity" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/seasons/entities/{entityId}/roster",
            "GET",
            _path_params,
            _query_params,
            _header_params,
