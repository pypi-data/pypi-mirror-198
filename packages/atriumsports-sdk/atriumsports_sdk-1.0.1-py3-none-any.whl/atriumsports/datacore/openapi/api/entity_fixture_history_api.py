...
class EntityFixtureHistoryApi(object):
    ...
    def gamelog_listentity(
        ...
        **kwargs
    ) -> GameLogEntityResponse:  # noqa: E501
        ...
        >>> thread = api.gamelog_listentity(entity_id, organization_id, season_id, sport, added, external, fields, fixture_type, hide_null, home_away, include, limit, offset, tbf, updated, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def gamelog_listentity_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.gamelog_listentity_with_http_info(entity_id, organization_id, season_id, sport, added, external, fields, fixture_type, hide_null, home_away, include, limit, offset, tbf, updated, win_loss, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GameLogEntityResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method gamelog_listentity" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/statistics/for/entity/{entityId}/in/fixtures/seasons/{seasonId}/history",
            "GET",
            _path_params,
            _query_params,
            _header_params,
