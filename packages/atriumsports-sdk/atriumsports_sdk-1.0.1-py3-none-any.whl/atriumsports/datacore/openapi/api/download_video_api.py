...
class DownloadVideoApi(object):
    ...
    def video_file_delete(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_delete(organization_id, sport, video_id, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.video_file_delete_with_http_info(
                organization_id, sport, video_id, external, fields, force_delete, hide_null, include, tbf, **kwargs
            )  # noqa: E501
    ...
    def video_file_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_delete_with_http_info(organization_id, sport, video_id, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def video_file_detail(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_detail(organization_id, sport, video_id, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
        ...
        try:
            return self.video_file_detail_with_http_info(
                organization_id, sport, video_id, external, fields, hide_null, include, limit, offset, tbf, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    def video_file_detail_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_detail_with_http_info(organization_id, sport, video_id, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def video_file_insert(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_insert(fixture_id, organization_id, sport, video_file_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def video_file_insert_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_insert_with_http_info(fixture_id, organization_id, sport, video_file_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def video_file_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_list(fixture_id, organization_id, sport, added, content, external, feed_type, fields, format, hide_null, include, limit, locale, offset, origin, provider, source_number, status, storage_provider, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def video_file_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_file_list_with_http_info(fixture_id, organization_id, sport, added, content, external, feed_type, fields, format, hide_null, include, limit, locale, offset, origin, provider, source_number, status, storage_provider, tbf, updated, async_req=True)
        >>> result = thread.get()
