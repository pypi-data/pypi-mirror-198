...
class SeasonLeadersApi(object):
    ...
    def sl_list(
        ...
        **kwargs
        ...
        >>> thread = api.sl_list(organization_id, season_id, sport, statistic, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def sl_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sl_list_with_http_info(organization_id, season_id, sport, statistic, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, tbf, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def sl_list_summary(
        ...
        **kwargs
        ...
        >>> thread = api.sl_list_summary(organization_id, season_id, sport, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, statistics, tbf, win_loss, async_req=True)
        >>> result = thread.get()
    ...
    def sl_list_summary_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sl_list_summary_with_http_info(organization_id, season_id, sport, entity_id, external, fields, fixture_type, hide_null, home_away, include, is_player, is_team_official, limit, offset, person_id, starter, statistics, tbf, win_loss, async_req=True)
        >>> result = thread.get()
