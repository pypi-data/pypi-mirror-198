...
class StandingConfigurationsApi(object):
    ...
    def standing_configurations_delete(
        ...
        **kwargs
    ) -> StandingConfigurationsResponse:  # noqa: E501
        ...
        >>> thread = api.standing_configurations_delete(organization_id, sport, standing_configuration_id, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def standing_configurations_delete_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_delete_with_http_info(organization_id, sport, standing_configuration_id, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(StandingConfigurationsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method standing_configurations_delete" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params["standing_configuration_id"]:
            _path_params["standingConfigurationId"] = _params["standing_configuration_id"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/standings/configurations/{standingConfigurationId}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def standing_configurations_detail(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_detail(organization_id, sport, standing_configuration_id, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def standing_configurations_detail_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_detail_with_http_info(organization_id, sport, standing_configuration_id, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method standing_configurations_detail" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def standing_configurations_insert(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_insert(organization_id, sport, standing_configurations_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def standing_configurations_insert_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_insert_with_http_info(organization_id, sport, standing_configurations_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method standing_configurations_insert" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/standings/configurations",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def standing_configurations_list(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_list(organization_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def standing_configurations_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_list_with_http_info(organization_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method standing_configurations_list" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def standing_configurations_update(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_update(organization_id, sport, standing_configuration_id, standing_configurations_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def standing_configurations_update_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.standing_configurations_update_with_http_info(organization_id, sport, standing_configuration_id, standing_configurations_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method standing_configurations_update" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
