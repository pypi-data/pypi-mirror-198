...
class SeasonEntitiesApi(object):
    ...
    def season_entities_detail(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_detail(entity_id, organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_entities_detail_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_detail_with_http_info(entity_id, organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_entities_insert_update(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_insert_update(organization_id, season_id, sport, season_entities_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def season_entities_insert_update_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_insert_update_with_http_info(organization_id, season_id, sport, season_entities_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def season_entities_list(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_list(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_entities_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.season_entities_list_with_http_info(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_entity_delete(
        ...
        **kwargs
        ...
        >>> thread = api.season_entity_delete(organization_id, person_id, season_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        try:
            return self.season_entity_delete_with_http_info(
                organization_id,
                person_id,
                season_id,
                sport,
            ...
            logger.error("Exception when calling SeasonEntitiesApi->season_entity_delete: %s\n" % e)
            raise

    @validate_arguments
    def season_entity_delete_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.season_entity_delete_with_http_info(organization_id, person_id, season_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method season_entity_delete" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def season_entity_list(
        ...
        **kwargs
        ...
        >>> thread = api.season_entity_list(entity_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_entity_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.season_entity_list_with_http_info(entity_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
