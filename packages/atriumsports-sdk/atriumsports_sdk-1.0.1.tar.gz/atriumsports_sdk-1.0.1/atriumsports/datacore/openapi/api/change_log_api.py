...
class ChangeLogApi(object):
    ...
    def change_log_list(
        ...
        child_type: Annotated[
            Optional[constr(strict=True, max_length=30)], Field(description="The child table changed")
        ] = None,
        external: Annotated[
            Optional[StrictStr],
            Field(
        ...
        **kwargs
        ...
        >>> thread = api.change_log_list(organization_id, sport, added, change_type, child_type, external, fields, hide_null, include, limit, offset, primary_id, primary_type, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def change_log_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.change_log_list_with_http_info(organization_id, sport, added, change_type, child_type, external, fields, hide_null, include, limit, offset, primary_id, primary_type, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ChangeLogResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method change_log_list" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("primary_id") is not None:  # noqa: E501
            _query_params.append(("primaryId", _params["primary_id"]))
        if _params.get("primary_type") is not None:  # noqa: E501
            _query_params.append(("primaryType", _params["primary_type"]))
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/changeLog",
            "GET",
            _path_params,
            _query_params,
            _header_params,
