...
class VideoStreamsAvailableApi(object):
    ...
    def video_stream_outputs_fixture_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_fixture_list(fixture_id, organization_id, sport, added, content, external, feed_type, fields, hide_null, include, limit, locale, offset, provider, source_number, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def video_stream_outputs_fixture_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_fixture_list_with_http_info(fixture_id, organization_id, sport, added, content, external, feed_type, fields, hide_null, include, limit, locale, offset, provider, source_number, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def video_stream_outputs_org_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_org_list(organization_id, sport, added, competition_id, content, external, feed_type, fields, from_time_utc, hide_null, include, limit, locale, master_venue_id, offset, provider, season_id, source_number, tbf, to_time_utc, updated, venue_id, async_req=True)
        >>> result = thread.get()
    ...
    def video_stream_outputs_org_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_org_list_with_http_info(organization_id, sport, added, competition_id, content, external, feed_type, fields, from_time_utc, hide_null, include, limit, locale, master_venue_id, offset, provider, season_id, source_number, tbf, to_time_utc, updated, venue_id, async_req=True)
        >>> result = thread.get()
    ...
    def video_stream_outputs_orggroup_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_orggroup_list(organization_group_code, sport, added, competition_id, content, external, feed_type, fields, from_time_utc, hide_null, include, limit, locale, master_venue_id, offset, provider, season_id, source_number, tbf, to_time_utc, updated, venue_id, async_req=True)
        >>> result = thread.get()
    ...
    def video_stream_outputs_orggroup_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_outputs_orggroup_list_with_http_info(organization_group_code, sport, added, competition_id, content, external, feed_type, fields, from_time_utc, hide_null, include, limit, locale, master_venue_id, offset, provider, season_id, source_number, tbf, to_time_utc, updated, venue_id, async_req=True)
        >>> result = thread.get()
