...
class SeasonEntityBaseStatisticsApi(object):
    ...
    def sebs_delete_all(
        ...
        **kwargs
    ) -> SeasonEntityBaseStatisticsResponse:  # noqa: E501
        ...
        >>> thread = api.sebs_delete_all(organization_id, season_id, sport, competitor_type, entity_id, external, fields, fixture_type, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def sebs_delete_all_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_delete_all_with_http_info(organization_id, season_id, sport, competitor_type, entity_id, external, fields, fixture_type, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SeasonEntityBaseStatisticsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method sebs_delete_all" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/statistics/base/for/entity/in/seasons/{seasonId}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def sebs_insert_update(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_insert_update(organization_id, sport, season_entity_base_statistics_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    def sebs_insert_update_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_insert_update_with_http_info(organization_id, sport, season_entity_base_statistics_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method sebs_insert_update" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/statistics/base/for/entity/in/seasons",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def sebs_list(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_list(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
    ...
    def sebs_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_list_with_http_info(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method sebs_list" % _key)
            _params[_key] = _val
        del _params["kwargs"]
