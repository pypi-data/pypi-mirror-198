...
class EntityGroupsApi(object):
    ...
    def entity_group_delete(
        ...
        **kwargs
    ) -> EntityGroupsResponse:  # noqa: E501
        ...
        >>> thread = api.entity_group_delete(entity_group_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def entity_group_delete_with_http_info(
        self,
        entity_group_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity group")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_delete_with_http_info(entity_group_id, organization_id, sport, external, fields, force_delete, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EntityGroupsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method entity_group_delete" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            "200": "EntityGroupsResponse",
        }

        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/entityGroups/{entityGroupId}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def entity_group_detail(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_detail(entity_group_id, organization_id, sport, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def entity_group_detail_with_http_info(
        self,
        entity_group_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity group")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_detail_with_http_info(entity_group_id, organization_id, sport, external, fields, hide_null, include, limit, offset, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method entity_group_detail" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def entity_group_insert(
        ...
        sport: Annotated[StrictStr, Field(..., description="Sport name")],
        entity_group_post_body: EntityGroupPostBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_insert(organization_id, sport, entity_group_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param entity_group_post_body: (required)
        :type entity_group_post_body: EntityGroupPostBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        try:
            return self.entity_group_insert_with_http_info(
                organization_id, sport, entity_group_post_body, external, fields, hide_null, include, tbf, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    @validate_arguments
    def entity_group_insert_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_insert_with_http_info(organization_id, sport, entity_group_post_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method entity_group_insert" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/entityGroups",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def entity_group_list(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_list(organization_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        try:
            ...
            logger.error("Exception when calling EntityGroupsApi->entity_group_list: %s\n" % e)
            raise

    @validate_arguments
    def entity_group_list_with_http_info(
        self,
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
            Field(..., description="The unique identifier of the organization"),
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_list_with_http_info(organization_id, sport, added, external, fields, hide_null, include, limit, offset, status, tbf, updated, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method entity_group_list" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def entity_group_update(
        ...
        sport: Annotated[StrictStr, Field(..., description="Sport name")],
        entity_group_put_body: EntityGroupPutBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_update(entity_group_id, organization_id, sport, entity_group_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param entity_group_put_body: (required)
        :type entity_group_put_body: EntityGroupPutBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        try:
            ...
            logger.error("Exception when calling EntityGroupsApi->entity_group_update: %s\n" % e)
            raise

    @validate_arguments
    def entity_group_update_with_http_info(
        self,
        entity_group_id: Annotated[StrictStr, Field(..., description="The unique identifier of the entity group")],
        organization_id: Annotated[
            constr(strict=True, max_length=5, min_length=5),
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_update_with_http_info(entity_group_id, organization_id, sport, entity_group_put_body, external, fields, hide_null, include, tbf, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method entity_group_update" % _key)
            _params[_key] = _val
        del _params["kwargs"]
