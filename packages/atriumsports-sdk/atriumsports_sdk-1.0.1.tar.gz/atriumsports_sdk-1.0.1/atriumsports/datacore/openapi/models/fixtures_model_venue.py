...
class FixturesModelVenue(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("venues"):
            raise ValueError("must validate the enum values ('venues')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturesModelVenue:
        """Create an instance of FixturesModelVenue from a JSON string"""
