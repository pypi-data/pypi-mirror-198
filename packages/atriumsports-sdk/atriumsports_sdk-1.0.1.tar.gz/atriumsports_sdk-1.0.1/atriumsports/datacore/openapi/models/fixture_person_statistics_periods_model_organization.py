...
class FixturePersonStatisticsPeriodsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePersonStatisticsPeriodsModelOrganization:
        """Create an instance of FixturePersonStatisticsPeriodsModelOrganization from a JSON string"""
