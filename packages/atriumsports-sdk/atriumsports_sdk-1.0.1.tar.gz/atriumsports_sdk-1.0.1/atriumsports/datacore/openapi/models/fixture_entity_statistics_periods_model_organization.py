...
class FixtureEntityStatisticsPeriodsModelOrganization(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("organizations"):
            raise ValueError("must validate the enum values ('organizations')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureEntityStatisticsPeriodsModelOrganization:
        """Create an instance of FixtureEntityStatisticsPeriodsModelOrganization from a JSON string"""
