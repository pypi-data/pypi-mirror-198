...
class CompetitionEntityStatisticsModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetitionEntityStatisticsModelOrganization:
        """Create an instance of CompetitionEntityStatisticsModelOrganization from a JSON string"""
