...
class SeasonStandingsStagesPoolsListModelOrganization(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonStandingsStagesPoolsListModelOrganization:
        """Create an instance of SeasonStandingsStagesPoolsListModelOrganization from a JSON string"""
