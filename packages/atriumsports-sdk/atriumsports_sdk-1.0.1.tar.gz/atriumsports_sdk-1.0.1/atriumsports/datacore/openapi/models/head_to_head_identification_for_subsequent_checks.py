...
class HeadToHeadIdentificationForSubsequentChecks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HeadToHeadIdentificationForSubsequentChecks:
        """Create an instance of HeadToHeadIdentificationForSubsequentChecks from a JSON string"""
