...
class SeasonVenuesListModelSite(BaseModel):
    ...
    def resource_type_validate_enum(cls, v):
        ...
        if v not in ("sites"):
            raise ValueError("must validate the enum values ('sites')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonVenuesListModelSite:
        """Create an instance of SeasonVenuesListModelSite from a JSON string"""
