...
class SeasonStagePostBody(BaseModel):
    ...
    stage_code: constr(strict=True, max_length=30) = Field(
        ..., alias="stageCode", description="A unique code for the stage. (Unique for season)"
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonStagePostBody:
        """Create an instance of SeasonStagePostBody from a JSON string"""
