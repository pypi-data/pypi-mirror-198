...
class Coco(BaseLabelme):
    ...
    def labelme_shapes2coco_ann(self, labelme_info):
        ...
        :return:
        """
        # print(os.path.join(labelme_info.get('input_dir'), labelme_info.get('image_dir'),
        #                    labelme_info.get('image_file')))
            ...
            if not structure_shape and structure_shape != 0:
                ...
                for shape in value:
                    ...
                    if shape['shape_type'] == 'point' or shape['shape_type'] == 'rectangle':  # 矩形框和关键点打组逻辑处理
                        # 转整形
                        # shape['points'][0][0] = int(shape['points'][0][0])
                        # shape['points'][0][1] = int(shape['points'][0][1])
                        ...
                        if shape.get('label') == 'left_top' or shape.get('label') == 'right_top' \
                            ...
                            rebuild_shape.update({'segmentation': disorder_segmentation})
