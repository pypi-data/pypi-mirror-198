    ...
    def __init__(self, api_client=None):
        ...
        def __get_es_ps_for_well1(
            ...
            **kwargs
            ...
            >>> thread = api.get_es_ps_for_well1(source_well_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_es_ps_for_well1 = Endpoint(
            settings={
                'response_type': ([Esp],),
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/api/production/well/{sourceWellId}/esp',
                'operation_id': 'get_es_ps_for_well1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_es_ps_for_well1
        )

        def __get_esp_by_source1(
            self,
            source_well_id,
            source_wellbore_id,
            source_tubing_id,
            ...
            **kwargs
            ...
            >>> thread = api.get_esp_by_source1(source_well_id, source_wellbore_id, source_tubing_id, source_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_esp_by_source1 = Endpoint(
            settings={
                'response_type': (Esp,),
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/api/production/well/{sourceWellId}/wellbore/{sourceWellboreId}/tubing/{sourceTubingId}/esp/{sourceId}',
                'operation_id': 'get_esp_by_source1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        def __get_esp_for_source_wellbore1(
            self,
            source_well_id,
            source_wellbore_id,
            **kwargs
            ...
            >>> thread = api.get_esp_for_source_wellbore1(source_well_id, source_wellbore_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_esp_for_source_wellbore1 = Endpoint(
            settings={
                'response_type': ([Esp],),
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/api/production/well/{sourceWellId}/wellbore/{sourceWellboreId}/esp',
                'operation_id': 'get_esp_for_source_wellbore1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_esp_for_source_wellbore1
        )
        ...
        def __upsert_esp1(
            ...
            **kwargs
            ...
            >>> thread = api.upsert_esp1(esp_input, async_req=True)
            >>> result = thread.get()
