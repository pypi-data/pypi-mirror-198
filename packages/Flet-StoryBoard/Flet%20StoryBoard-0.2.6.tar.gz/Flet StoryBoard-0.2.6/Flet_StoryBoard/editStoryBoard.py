...
class EditStoryBoard:
    ...
    def __init__ (self, file_path:str, external_functions:list=[]):
        ...
        if os.path.isfile(file_path) == True:
            ...
            new_file_path = CreateStoryBoard()
            new_file_path = new_file_path.PAGE_NAME
            file_path = new_file_path + ".fletsb"
            if os.path.isfile(f"{new_file_path}.fletsb") == False: return
