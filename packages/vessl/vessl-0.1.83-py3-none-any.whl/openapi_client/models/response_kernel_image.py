...
class ResponseKernelImage(object):
    ...
    def __init__(self, created_dt=None, description=None, execute_type=None, id=None, image_pull_policy=None, image_url=None, is_public=None, is_savvihub_managed=None, name=None, organization_credentials_id=None, packages=None, processor_type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
