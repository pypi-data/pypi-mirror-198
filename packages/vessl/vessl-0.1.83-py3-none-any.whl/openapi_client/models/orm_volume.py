...
class OrmVolume(object):
    ...
    def __init__(self, base_path=None, bucket_name=None, created_dt=None, edges=None, id=None, immutable_slug=None, is_read_only=None, on_premise_volume_config=None, role_owner_ref=None, role_type=None, updated_dt=None, volume_organization=None, volume_storage=None, local_vars_configuration=None):  # noqa: E501
