...
class ResponseVolume(object):
    ...
    def __init__(self, bucket_name=None, created_dt=None, id=None, is_read_only=None, on_premise_volume_config=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
