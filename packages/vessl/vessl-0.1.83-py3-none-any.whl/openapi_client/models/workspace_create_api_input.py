...
class WorkspaceCreateAPIInput(object):
    ...
    def __init__(self, cluster_id=None, cluster_node_ids=None, docker_credentials_id=None, image_url=None, init_script=None, max_hours=None, name=None, ports=None, resource_spec=None, resource_spec_id=None, volumes=None, local_vars_configuration=None):  # noqa: E501
