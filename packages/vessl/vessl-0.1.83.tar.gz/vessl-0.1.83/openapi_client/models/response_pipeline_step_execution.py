...
class ResponsePipelineStepExecution(object):
    ...
    def __init__(self, created_dt=None, description=None, id=None, if_result=None, input_result=None, judgment_result=None, logs=None, run_result=None, status=None, title=None, type=None, local_vars_configuration=None):  # noqa: E501
