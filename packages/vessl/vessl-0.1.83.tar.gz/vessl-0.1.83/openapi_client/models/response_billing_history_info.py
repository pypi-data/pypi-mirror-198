...
class ResponseBillingHistoryInfo(object):
    ...
    def __init__(self, amount=None, created_by=None, created_dt=None, discounted_amount=None, experiment=None, project=None, service=None, status=None, type=None, workspace=None, local_vars_configuration=None):  # noqa: E501
