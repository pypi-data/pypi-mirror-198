...
class OrmUserEdges(object):
    ...
    def __init__(self, access_tokens=None, cluster_quotas=None, credit_earn_histories=None, default_organization=None, experiments=None, models=None, pipelines=None, project_dashboards=None, reset_password_tokens=None, starred_dashboards=None, triggered_pipeline_executions=None, user_organization=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
