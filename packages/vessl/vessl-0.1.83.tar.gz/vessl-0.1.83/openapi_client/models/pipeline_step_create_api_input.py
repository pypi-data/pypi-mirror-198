...
class PipelineStepCreateAPIInput(object):
    ...
    def __init__(self, description=None, if_spec=None, manual_input_spec=None, run_spec=None, spec_revision=None, title=None, local_vars_configuration=None):  # noqa: E501
