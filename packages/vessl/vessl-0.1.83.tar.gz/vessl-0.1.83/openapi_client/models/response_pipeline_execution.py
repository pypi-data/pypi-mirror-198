...
class ResponsePipelineExecution(object):
    ...
    """
    openapi_types = {
        'context': 'dict(str, list[ResponsePipelineVariable])',
        'created_dt': 'datetime',
        'end_dt': 'datetime',
        'number': 'int',
        'status': 'str',
    ...
    def __init__(self, context=None, created_dt=None, end_dt=None, number=None, status=None, step_dependencies=None, step_executions=None, triggered_by=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def context(self):
        """Gets the context of this ResponsePipelineExecution.  # noqa: E501


        :return: The context of this ResponsePipelineExecution.  # noqa: E501
        :rtype: dict(str, list[ResponsePipelineVariable])
        """
        return self._context

    @context.setter
    def context(self, context):
        """Sets the context of this ResponsePipelineExecution.


        :param context: The context of this ResponsePipelineExecution.  # noqa: E501
        :type context: dict(str, list[ResponsePipelineVariable])
        """
    ...
    def triggered_by(self, triggered_by):
        ...
        """
        if self.local_vars_configuration.client_side_validation and triggered_by is None:  # noqa: E501
