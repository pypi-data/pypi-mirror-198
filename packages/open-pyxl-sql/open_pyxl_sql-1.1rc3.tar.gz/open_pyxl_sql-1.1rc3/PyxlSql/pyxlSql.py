...
# TODO: REQ 0004: remove start/trailing spaces for Command, Clause, field names, it is a common error, hard to find
...
# TODO: Req 0007: Use API token to upload on Pypi. see  https://pypi.org/help/#apitoken and https://pypi.org/manage/account/token/
# REQ 0008: Generate todo.rst through tox, using parse_requirements.py
...
#             SELECT INTO adds a FORMULA and a FORMAT clause if the 1st data line is filled with examples,
...
# FIXME: Test behavior with dst_sheet arg
